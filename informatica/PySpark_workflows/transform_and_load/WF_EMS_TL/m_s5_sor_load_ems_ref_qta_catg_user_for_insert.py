...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_SSA_EMS_REF_QTA_CATG_USER = df_SQ_SSA_EMS_REF_QTA_CATG_USER.filter(expr("OPR_IND = 'B' OR OPR_IND = 'A'"))
        ...
        df_SQ_SSA_EMS_REF_QTA_CATG_USER_STS = df_SQ_SSA_EMS_REF_QTA_CATG_USER_STS.filter(expr("OPR_IND = 'B' OR OPR_IND = 'EB' OR OPR_IND = 'DA'"))
        # Select only SQ output ports (matches Informatica behavior) — missing ports become lit(None)
        ...
        df_EXP_SOR_LOAD_DATE = df_SQ_SSA_EMS_REF_QTA_CATG_USER_STS
