...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SSA_EMS_ELP_CUST_ACCC_PYMT = lib.read_sql(spark, _conn, table="SSA_EMS_ELP_CUST_ACCC_PYMT")
        
        logger.info("Step: read_SSA_EMS_ELP_CUST_ACCC_PYMT_STS")
        # Reading Data From Source - read_SSA_EMS_ELP_CUST_ACCC_PYMT_STS
        # Resolve connection by alias (supports lookup/source connections dynamically)
        _conn = lib.get_db_config(config, "SSA")
        df_SSA_EMS_ELP_CUST_ACCC_PYMT_STS = lib.read_sql(spark, _conn, table="SSA_EMS_ELP_CUST_ACCC_PYMT")
        ...
        df_SQ_SSA_EMS_ELP_CUST_ACCC_PYMT = df_SQ_SSA_EMS_ELP_CUST_ACCC_PYMT.filter(expr("OPR_IND = 'E'"))
        ...
        df_SQ_SSA_EMS_ELP_CUST_ACCC_PYMT_STS = df_SQ_SSA_EMS_ELP_CUST_ACCC_PYMT_STS.filter(expr("OPR_IND = 'E' OR OPR_IND = 'EB'"))
        # Select only SQ output ports (matches Informatica behavior) — missing ports become lit(None)
        ...
        df_EXP_REC_TXN_TYPE_CODE_UPD = df_SQ_SSA_EMS_ELP_CUST_ACCC_PYMT
        ...
        df_EXP_REC_TXN_TYPE_CODE_UPDS = df_SQ_SSA_EMS_ELP_CUST_ACCC_PYMT_STS
