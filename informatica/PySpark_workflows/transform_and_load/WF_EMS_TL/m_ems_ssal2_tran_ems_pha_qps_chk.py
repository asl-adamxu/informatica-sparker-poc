...
FROM EMS_PHA_QPS_CHK"""
        ...
        df_SQ_EMS_PHA_QPS_CHK = lib.sq_output(
            input_df=df_SQ_EMS_PHA_QPS_CHK,
            port_cols={
                'QPS_CHK_ID': 'string',
 ...
 ORDER BY SOR_EMS_PHA_QPS_CHK_STS.QPS_CHK_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_EMS_PHA_QPS_CHK'"},
        ...
        lib.write_target(
            ...
            delete_keys=['qps_chk_key', 'bgn_date', 'end_date', 'qps_chk_pnt_num', 'qps_chk_prev_rply_pct', 'qps_chk_prev_no_rply_pct', 'qps_chk_stg_bgn_date', 'qps_chk_stg_end_date', 'qps_chk_ppr_vet_cnt', 'qps_chk_btch_rej_date', 'qps_chk_btch_rej_rply_dln_date', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
            has_update_flag=True,
            config=config,
        )
