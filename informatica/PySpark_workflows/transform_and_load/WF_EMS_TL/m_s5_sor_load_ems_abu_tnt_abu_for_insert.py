...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_SSA_EMS_ABU_TNT_ABU_STS = df_SQ_SSA_EMS_ABU_TNT_ABU_STS.filter(expr("OPR_IND = 'B' OR OPR_IND = 'EB' OR OPR_IND = 'DA'"))
        ...
        df_SQ_SSA_EMS_ABU_TNT_ABU = df_SQ_SSA_EMS_ABU_TNT_ABU.filter(expr("OPR_IND = 'B' OR OPR_IND = 'A'"))
        # Select only SQ output ports (matches Informatica behavior) — missing ports become lit(None)
        ...
        df_EXP_SOR_LOAD_DATE = df_SQ_SSA_EMS_ABU_TNT_ABU_STS
