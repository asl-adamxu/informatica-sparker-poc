...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SSA_EMS_HSM_HOMES_BLK = lib.read_sql(spark, _conn, table="SSA_EMS_HSM_HOMES_BLK")
        
        logger.info("Step: read_SSA_EMS_HSM_HOMES_BLK_STS")
        # Reading Data From Source - read_SSA_EMS_HSM_HOMES_BLK_STS
        # Resolve connection by alias (supports lookup/source connections dynamically)
        _conn = lib.get_db_config(config, "SSA")
        df_SSA_EMS_HSM_HOMES_BLK_STS = lib.read_sql(spark, _conn, table="SSA_EMS_HSM_HOMES_BLK_STS")
        ...
        df_SQ_SSA_EMS_HSM_HOMES_BLK = df_SQ_SSA_EMS_HSM_HOMES_BLK.filter(expr("OPR_IND = 'B' OR OPR_IND = 'A'"))
        ...
        df_SQ_SSA_EMS_HSM_HOMES_BLK_STS = df_SQ_SSA_EMS_HSM_HOMES_BLK_STS.filter(expr("OPR_IND = 'B' OR OPR_IND = 'EB' OR OPR_IND = 'DA'"))
        # Select only SQ output ports (matches Informatica behavior) — missing ports become lit(None)
        ...
        df_EXP_SOR_LOAD_DATE = df_SQ_SSA_EMS_HSM_HOMES_BLK_STS
