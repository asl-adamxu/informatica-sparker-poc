...
FROM EMS_CSR_APLY_RCV"""
        ...
        for _sc in _sql_cols:
            ...
            if _pi < len(_port_cols):
                ...
                _used_ports.add(_pi)
                _pi += 1
        df_SQ_EMS_CSR_APLY_RCV = df_SQ_EMS_CSR_APLY_RCV.select(*[col(f"`{old}`").alias(new) for old, new in _rename_map.items()])
        # Select only SQ output ports (matches Informatica behavior)
        # ports the SQL didn't return become lit(None) so downstream references never fail
        df_SQ_EMS_CSR_APLY_RCV = df_SQ_EMS_CSR_APLY_RCV.select([col(c) if c.lower() in [x.lower() for x in df_SQ_EMS_CSR_APLY_RCV.columns] else lit(None).alias(c) for c in _port_cols])
        
        ctx.register_df("df_SQ_EMS_CSR_APLY_RCV", df_SQ_EMS_CSR_APLY_RCV)
        
        logger.info("Step: apply_EXP_BK")
        # Expression: apply_EXP_BK
        df_EXP_BK = df_SQ_EMS_CSR_APLY_RCV
        ...
        _conn = lib.get_db_config(config, "SSA")
        df_DLKP_SOR_MSTR = lib.read_sql(spark, _conn, table="SOR_EMS_CSR_APLY_RCV")
        ...
        _lkp_input = _lkp_input.withColumn("IN_EMS_ENQ_KEY", col("ENQ_KEY"))
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_MSTR',
            join_predicates=[{'source_col': 'IN_EMS_ENQ_KEY', 'lookup_col': 'EMS_ENQ_KEY'}, {'source_col': 'IN_EMS_PRVS_APLY_KEY', 'lookup_col': 'EMS_PRVS_APLY_KEY'}],
            output_columns=['CSR_APLY_RCV_KEY', 'EMS_ENQ_KEY', 'EMS_PRVS_APLY_KEY'],
            lookup_output_fields=[
                {'name': 'CSR_APLY_RCV_KEY', 'ref_field': 'Sequence-Id', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'integer'},
                {'name': 'EMS_ENQ_KEY', 'ref_field': 'ENQ_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'string'},
            ...
            sequence_config={'output_col': 'CSR_APLY_RCV_KEY'},
...
where SOR_EMS_CSR_APLY_RCV_STS.CSR_APLY_RCV_KEY = ss.CSR_APLY_RCV_KEY and SOR_EMS_CSR_APLY_RCV_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_EMS_CSR_APLY_RCV_STS.CSR_APLY_RCV_KEY  """
        ...
        _lkp_input = _lkp_input.withColumn("IN_APLY_RCV_CRE_DATE", col("APLY_RCV_CRE_DATE"))
        _lkp_input = _lkp_input.withColumn("IN_APLY_RCV_CRE_MBR_CODE", col("APLY_RCV_CRE_MBR_CODE"))
        _lkp_input = _lkp_input.withColumn("IN_APLY_RCV_CRE_USER_ID", col("APLY_RCV_CRE_USER_ID"))
        _lkp_input = _lkp_input.withColumn("IN_APLY_RCV_UPD_DATE", col("APLY_RCV_UPD_DATE"))
        _lkp_input = _lkp_input.withColumn("IN_APLY_RCV_UPD_MBR_CODE", col("APLY_RCV_UPD_MBR_CODE"))
        _lkp_input = _lkp_input.withColumn("IN_APLY_RCV_UPD_USER_ID", col("APLY_RCV_UPD_USER_ID"))
        _lkp_input = _lkp_input.withColumn("IN_APLY_RCV_RTN_DATE", col("APLY_RCV_RTN_DATE"))
        _lkp_input = _lkp_input.withColumn("IN_APLY_RCV_RTN_MBR_CODE", col("APLY_RCV_RTN_MBR_CODE"))
        _lkp_input = _lkp_input.withColumn("IN_APLY_RCV_RTN_USER_ID", col("APLY_RCV_RTN_USER_ID"))
        _lkp_input = _lkp_input.withColumn("IN_LAST_REC_TXN_MBR_CODE", col("LAST_REC_TXN_MBR_CODE"))
        _lkp_input = _lkp_input.withColumn("IN_CSR_APLY_RCV_KEY", col("CSR_APLY_RCV_KEY"))
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            spark=spark,
            input_df=_lkp_input,
            lookup_df=df_DLKP_SOR_STS,
            name='DLKP_SOR_STS',
            join_predicates=[{'source_col': 'IN_CSR_APLY_RCV_KEY', 'lookup_col': 'CSR_APLY_RCV_KEY'}],
            output_columns=['CSR_APLY_RCV_KEY', 'BGN_DATE', 'END_DATE', 'APLY_RCV_DATE', 'APLY_SBMT_CHNL_CODE', 'APLY_ASGN_CATG_CODE', 'APLY_ID_TYPE_CODE', 'APLY_ID_NUM', 'APLY_ENG_NAME', 'APLY_CHI_NAME', 'APLY_RCV_CRE_DATE', 'APLY_RCV_CRE_MBR_CODE', 'APLY_RCV_CRE_USER_ID', 'APLY_RCV_UPD_DATE', 'APLY_RCV_UPD_MBR_CODE', 'APLY_RCV_UPD_USER_ID', 'APLY_RCV_RTN_DATE', 'APLY_RCV_RTN_MBR_CODE', 'APLY_RCV_RTN_USER_ID', 'LAST_REC_TXN_MBR_CODE'],
            lookup_output_fields=[
                {'name': 'CSR_APLY_RCV_KEY', 'ref_field': 'CSR_APLY_RCV_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
                ...
                {'name': 'APLY_RCV_CRE_DATE', 'ref_field': 'APLY_RCV_CRE_DATE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'date/time'},
                {'name': 'APLY_RCV_CRE_MBR_CODE', 'ref_field': 'APLY_RCV_CRE_MBR_CODE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'APLY_RCV_CRE_USER_ID', 'ref_field': 'APLY_RCV_CRE_USER_ID', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'APLY_RCV_UPD_DATE', 'ref_field': 'APLY_RCV_UPD_DATE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'date/time'},
                {'name': 'APLY_RCV_UPD_MBR_CODE', 'ref_field': 'APLY_RCV_UPD_MBR_CODE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'APLY_RCV_UPD_USER_ID', 'ref_field': 'APLY_RCV_UPD_USER_ID', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'APLY_RCV_RTN_DATE', 'ref_field': 'APLY_RCV_RTN_DATE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'date/time'},
                {'name': 'APLY_RCV_RTN_MBR_CODE', 'ref_field': 'APLY_RCV_RTN_MBR_CODE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'APLY_RCV_RTN_USER_ID', 'ref_field': 'APLY_RCV_RTN_USER_ID', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
        ...
        df_EXPTRANS_MSTR = df_EXPTRANS_MSTR.withColumn("v_SSAL2_TBL_NAME", expr("'SSA_EMS_CSR_APLY_RCV'"))
        ...
        _lkp_input = _lkp_input.withColumn("IN_SURROGATE_KEY", col("CSR_APLY_RCV_KEY"))
        ...
        df_lkp_merge_FILTRANS_MSTR = lib.dynamic_lookup(
            ...
            lookup_output_fields=[
                {'name': 'SURROGATE_KEY', 'ref_field': 'CSR_APLY_RCV_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
        ...
        _del_key_cols = ['csr_aply_rcv_key', 'bgn_date', 'end_date', 'aply_rcv_date', 'aply_sbmt_chnl_code', 'aply_asgn_catg_code', 'aply_id_type_code', 'aply_id_num', 'aply_eng_name', 'aply_chi_name', 'aply_rcv_cre_date', 'aply_rcv_cre_mbr_code', 'aply_rcv_cre_user_id', 'aply_rcv_upd_date', 'aply_rcv_upd_mbr_code', 'aply_rcv_upd_user_id', 'aply_rcv_rtn_date', 'aply_rcv_rtn_mbr_code', 'aply_rcv_rtn_user_id', 'last_rec_txn_mbr_code', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date']
        if not _df_del.rdd.isEmpty():
            ...
            if _del_rows:
                lib.batch_delete_composite(spark, conn_target, "SSA_EMS_CSR_APLY_RCV_STS", _del_key_cols, _del_rows, 1000)
        # UPDATE: batch update via JDBC
        if not _df_upd.rdd.isEmpty():
            _upd_key_cols = ['csr_aply_rcv_key', 'bgn_date', 'end_date', 'aply_rcv_date', 'aply_sbmt_chnl_code', 'aply_asgn_catg_code', 'aply_id_type_code', 'aply_id_num', 'aply_eng_name', 'aply_chi_name', 'aply_rcv_cre_date', 'aply_rcv_cre_mbr_code', 'aply_rcv_cre_user_id', 'aply_rcv_upd_date', 'aply_rcv_upd_mbr_code', 'aply_rcv_upd_user_id', 'aply_rcv_rtn_date', 'aply_rcv_rtn_mbr_code', 'aply_rcv_rtn_user_id', 'last_rec_txn_mbr_code', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date']
            ...
            if _upd_set_cols:
                ...
                lib.batch_update(spark, conn_target, "SSA_EMS_CSR_APLY_RCV_STS", _upd_set_cols, _upd_key_cols, _upd_rows, 1000)
        ...
        df_write = df_write.drop("_update_flag")
        # DELETE: composite key batch delete (all key columns together)
        _del_key_cols = ['csr_aply_rcv_key', 'ems_enq_key', 'ems_prvs_aply_key', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date']
        if not _df_del.rdd.isEmpty():
            _del_rows = [tuple(r[c] for c in _del_key_cols) for r in _df_del.select(*_del_key_cols).distinct().collect()]
            if _del_rows:
                lib.batch_delete_composite(spark, conn_target, "SSA_EMS_CSR_APLY_RCV", _del_key_cols, _del_rows, 1000)
        # UPDATE: batch update via JDBC
        if not _df_upd.rdd.isEmpty():
            _upd_key_cols = ['csr_aply_rcv_key', 'ems_enq_key', 'ems_prvs_aply_key', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date']
            _upd_set_cols = [c for c in _df_upd.columns if c.lower() not in [k.lower() for k in _upd_key_cols]]
            if _upd_set_cols:
                _upd_rows = [tuple(r[c] for c in _upd_set_cols + _upd_key_cols) for r in _df_upd.collect()]
                lib.batch_update(spark, conn_target, "SSA_EMS_CSR_APLY_RCV", _upd_set_cols, _upd_key_cols, _upd_rows, 1000)
        # INSERT — set df_write to _df_ins so it flows through normal write path
        df_write = _df_ins
