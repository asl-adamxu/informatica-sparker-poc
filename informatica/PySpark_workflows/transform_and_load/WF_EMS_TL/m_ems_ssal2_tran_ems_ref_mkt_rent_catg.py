...
FROM EMS_REF_MKT_RENT_CATG"""
        ...
        df_SQ_EMS_REF_MKT_RENT_CATG = lib.sq_output(
            input_df=df_SQ_EMS_REF_MKT_RENT_CATG,
            port_cols={
 ...
 ORDER BY SOR_EMS_REF_MKT_RENT_CATG_STS.MKT_RENT_CATG_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_EMS_REF_MKT_RENT_CATG'"},
        ...
        lib.write_target(
            ...
            delete_keys=['mkt_rent_catg_key', 'mkt_rent_catg_code', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
        ...
        lib.write_target(
            ...
            delete_keys=['mkt_rent_catg_key', 'bgn_date', 'end_date', 'mkt_rent_catg_desp', 'mkt_rent_snsh_mth', 'ref_code_bgn_date', 'ref_code_end_date', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
            has_update_flag=True,
            config=config,
        )
