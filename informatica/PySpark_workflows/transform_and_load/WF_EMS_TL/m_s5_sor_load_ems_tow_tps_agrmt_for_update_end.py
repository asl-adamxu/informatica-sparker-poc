...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_SSA_EMS_TOW_TPS_AGRMT_STS = df_SQ_SSA_EMS_TOW_TPS_AGRMT_STS.filter(expr("OPR_IND = 'E' OR OPR_IND = 'EB'"))
        ...
        df_SQ_SSA_EMS_TOW_TPS_AGRMT = df_SQ_SSA_EMS_TOW_TPS_AGRMT.filter(expr("OPR_IND = 'E'"))
        # Select only SQ output ports (matches Informatica behavior) — missing ports become lit(None)
        ...
        df_write = df_SQ_SSA_EMS_TOW_TPS_AGRMT_STS
