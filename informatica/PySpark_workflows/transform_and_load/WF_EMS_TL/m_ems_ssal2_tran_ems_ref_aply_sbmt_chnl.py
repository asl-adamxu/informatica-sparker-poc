...
FROM EMS_REF_APLY_SBMT_CHNL"""
        ...
        df_SQ_EMS_REF_APLY_SBMT_CHNL = lib.sq_output(
            input_df=df_SQ_EMS_REF_APLY_SBMT_CHNL,
            port_cols={
                'APLY_SBMT_CHNL_CODE': 'string',
                'APLY_SBMT_CHNL_DESP': 'string',
 ...
 ORDER BY SOR_EMS_REF_APLY_SBMT_CHNL_STS.APLY_SBMT_CHNL_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_EMS_REF_APLY_SBMT_CHNL'"},
        ...
        lib.write_target(
            ...
            delete_keys=['aply_sbmt_chnl_key', 'aply_sbmt_chnl_code', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
