...
FROM EMS_DOG_APLY_OWNR"""
        ...
        df_SQ_EMS_DOG_APLY_OWNR = lib.sq_output(
            input_df=df_SQ_EMS_DOG_APLY_OWNR,
            port_cols={
                'DOG_APLY_OWNR_KEY': 'decimal',
                'DOG_APLY_KEY': 'decimal',
                'DOG_OWNR_ID_TYPE_CODE': 'string',
                'DOG_OWNR_ID_NUM': 'string',
                'DOG_LIC_END_DATE': 'date/time',
                'DOG_MCRCP_NUM': 'string',
                'DOG_SPCE_TEXT': 'string',
                'DOG_STS_CODE': 'string',
 ...
 ORDER BY SOR_EMS_DOG_APLY_OWNR_STS.DOG_APLY_OWNR_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_EMS_DOG_APLY_OWNR'"},
        ...
        lib.write_target(
            ...
            delete_keys=['dog_aply_ownr_key', 'ems_dog_aply_ownr_key', 'agmt_ind', 'last_rec_txn_date', 'last_rec_txn_type_code', 'opr_ind', 'sor_date'],
        ...
        lib.write_target(
            ...
            delete_keys=['dog_aply_ownr_key', 'bgn_date', 'end_date', 'dog_aply_key', 'dog_ownr_id_type_code', 'dog_ownr_id_num', 'dog_lic_end_date', 'dog_mcrcp_num', 'dog_spce_text', 'dog_sts_code', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
            has_update_flag=True,
            config=config,
        )
