...
FROM EMS_REF_APLY_ASGN_CATG"""
        ...
        df_SQ_EMS_REF_APLY_ASGN_CATG = lib.sq_output(
            input_df=df_SQ_EMS_REF_APLY_ASGN_CATG,
            port_cols={
 ...
 ORDER BY SOR_EMS_REF_APLY_ASGN_CATG_STS.APLY_ASGN_CATG_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_EMS_REF_APLY_ASGN_CATG'"},
        ...
        lib.write_target(
            ...
            delete_keys=['aply_asgn_catg_key', 'aply_asgn_catg_code', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
