'''
* Script - M_EMS_SSAL2_TRAN_EMS_REF_APLY_ASGN_CATG.py
...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    """
    Execute the M_EMS_SSAL2_TRAN_EMS_REF_APLY_ASGN_CATG mapping transformations.
    ...
    logger.info("Start to run mapping M_EMS_SSAL2_TRAN_EMS_REF_APLY_ASGN_CATG")

    config = lib.load_config('env/config.yml')
    objects = config.get('objects', {})

    spark = ctx.spark if ctx else lib.get_spark_session("M_EMS_SSAL2_TRAN_EMS_REF_APLY_ASGN_CATG", config)
...
FROM EMS_REF_APLY_ASGN_CATG"""
        ...
        for _sc in _sql_cols:
            ...
            if _pi < len(_port_cols):
                ...
                _used_ports.add(_pi)
                _pi += 1
        df_SQ_EMS_REF_APLY_ASGN_CATG = df_SQ_EMS_REF_APLY_ASGN_CATG.select(*[col(f"`{old}`").alias(new) for old, new in _rename_map.items()])
        # Select only SQ output ports (matches Informatica behavior)
        # ports the SQL didn't return become lit(None) so downstream references never fail
        df_SQ_EMS_REF_APLY_ASGN_CATG = df_SQ_EMS_REF_APLY_ASGN_CATG.select([col(c) if c.lower() in [x.lower() for x in df_SQ_EMS_REF_APLY_ASGN_CATG.columns] else lit(None).alias(c) for c in _port_cols])
        
        ctx.register_df("df_SQ_EMS_REF_APLY_ASGN_CATG", df_SQ_EMS_REF_APLY_ASGN_CATG)
        
        logger.info("Step: apply_EXP_BK")
        # Expression: apply_EXP_BK
        df_EXP_BK = df_SQ_EMS_REF_APLY_ASGN_CATG
        ...
        _conn = lib.get_db_config(config, "SSA")
        df_DLKP_SOR_MSTR = lib.read_sql(spark, _conn, table="SOR_EMS_REF_APLY_ASGN_CATG")
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_MSTR',
            join_predicates=[{'source_col': 'IN_APLY_ASGN_CATG_CODE', 'lookup_col': 'APLY_ASGN_CATG_CODE'}],
            output_columns=['APLY_ASGN_CATG_KEY', 'APLY_ASGN_CATG_CODE'],
            lookup_output_fields=[
                {'name': 'APLY_ASGN_CATG_KEY', 'ref_field': 'Sequence-Id', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'integer'},
                {'name': 'APLY_ASGN_CATG_CODE', 'ref_field': 'APLY_ASGN_CATG_CODE', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'string'}
            ],
            new_lookup_row_col='NewLookupRow',
            sequence_config={'output_col': 'APLY_ASGN_CATG_KEY'},
...
where SOR_EMS_REF_APLY_ASGN_CATG_STS.APLY_ASGN_CATG_KEY = ss.APLY_ASGN_CATG_KEY and SOR_EMS_REF_APLY_ASGN_CATG_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_EMS_REF_APLY_ASGN_CATG_STS.APLY_ASGN_CATG_KEY  """
        ...
        _lkp_input = _lkp_input.withColumn("IN_APLY_ASGN_CATG_PRIOR_NUM", col("APLY_ASGN_CATG_PRIOR_NUM"))
        _lkp_input = _lkp_input.withColumn("IN_APLY_ASGN_CATG_DESP", col("APLY_ASGN_CATG_DESP"))
        ...
        _lkp_input = _lkp_input.withColumn("IN_APLY_ASGN_CATG_KEY", col("APLY_ASGN_CATG_KEY"))
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            spark=spark,
            input_df=_lkp_input,
            lookup_df=df_DLKP_SOR_STS,
            name='DLKP_SOR_STS',
            join_predicates=[{'source_col': 'IN_APLY_ASGN_CATG_KEY', 'lookup_col': 'APLY_ASGN_CATG_KEY'}],
            output_columns=['APLY_ASGN_CATG_KEY', 'BGN_DATE', 'END_DATE', 'APLY_ASGN_CATG_PRIOR_NUM', 'APLY_ASGN_CATG_DESP', 'DISP_SEQ_NUM', 'REF_CODE_BGN_DATE', 'REF_CODE_END_DATE', 'LAST_REC_TXN_MBR_CODE'],
            lookup_output_fields=[
                {'name': 'APLY_ASGN_CATG_KEY', 'ref_field': 'APLY_ASGN_CATG_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
                ...
                {'name': 'APLY_ASGN_CATG_PRIOR_NUM', 'ref_field': 'APLY_ASGN_CATG_PRIOR_NUM', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'},
                {'name': 'APLY_ASGN_CATG_DESP', 'ref_field': 'APLY_ASGN_CATG_DESP', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
        ...
        df_EXPTRANS_MSTR = df_EXPTRANS_MSTR.withColumn("v_SSAL2_TBL_NAME", expr("'SSA_EMS_REF_APLY_ASGN_CATG'"))
        ...
        # Resolve connection by alias (supports lookup/source connections dynamically)
        _conn = lib.get_db_config(config, "SSA")
        query = f"""SELECT APLY_ASGN_CATG_KEY as SURROGATE_KEY, NULL as DUMMY  FROM SSA_EMS_REF_APLY_ASGN_CATG"""
        query = query.replace("$$v_snsh_date", v_snsh_date)
        query = query.replace("$$v_init_flag", v_init_flag)
        ...
        _lkp_input = _lkp_input.withColumn("IN_SURROGATE_KEY", col("APLY_ASGN_CATG_KEY"))
        ...
        df_lkp_merge_FILTRANS_MSTR = lib.dynamic_lookup(
            ...
            lookup_output_fields=[
                {'name': 'SURROGATE_KEY', 'ref_field': 'APLY_ASGN_CATG_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
        ...
        # Resolve connection by alias (supports lookup/source connections dynamically)
        _conn = lib.get_db_config(config, "SSA")
        query = f"""SELECT APLY_ASGN_CATG_KEY as SURROGATE_KEY, NULL as DUMMY  FROM SSA_EMS_REF_APLY_ASGN_CATG_STS"""
        query = query.replace("$$v_snsh_date", v_snsh_date)
        query = query.replace("$$v_init_flag", v_init_flag)
        ...
        logger.info("Step: write_SSA_EMS_REF_APLY_ASGN_CATG")
        # Write to Target: write_SSA_EMS_REF_APLY_ASGN_CATG
        df_write = df_UPD_SSAL2_MSTR
        # Map source columns to target columns using connector field map (handles name
        # mismatches) — done BEFORE the _update_flag split so UPDATE/DELETE use target
        # column names in batch_update/batch_delete.
        _field_map = {"AGMT_IND": "OUT_AGMT_IND", "APLY_ASGN_CATG_CODE": "APLY_ASGN_CATG_CODE", "APLY_ASGN_CATG_KEY": "APLY_ASGN_CATG_KEY", "LAST_REC_TXN_DATE": "OUT_V_LAST_REC_TXN_DATE", "LAST_REC_TXN_TYPE_CODE": "OUT_V_LAST_REC_TXN_TYPE_CODE", "OPR_IND": "OUT_V_OPR_IND"}
        ...
        _del_key_cols = ['aply_asgn_catg_key', 'aply_asgn_catg_code', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date']
        if not _df_del.rdd.isEmpty():
            ...
            if _del_rows:
                lib.batch_delete_composite(spark, conn_target, "SSA_EMS_REF_APLY_ASGN_CATG", _del_key_cols, _del_rows, 1000)
        # UPDATE: batch update via JDBC
        if not _df_upd.rdd.isEmpty():
            _upd_key_cols = ['aply_asgn_catg_key', 'aply_asgn_catg_code', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date']
            ...
            if _upd_set_cols:
                ...
                lib.batch_update(spark, conn_target, "SSA_EMS_REF_APLY_ASGN_CATG", _upd_set_cols, _upd_key_cols, _upd_rows, 1000)
        ...
        _target_cols = ['APLY_ASGN_CATG_KEY', 'APLY_ASGN_CATG_CODE', 'AGMT_IND', 'LAST_REC_TXN_TYPE_CODE', 'LAST_REC_TXN_DATE', 'OPR_IND', 'SOR_DATE']
        df_write = df_write.select(*[col for col in _target_cols if col.lower() in [x.lower() for x in df_write.columns]])
        # Write to database table (Oracle, etc.) using write_table (supports smart repartition, batch size, empty-df skip)
        lib.write_table(df_write, conn_target, "SSA_EMS_REF_APLY_ASGN_CATG", mode="append")

        logger.info("write_SSA_EMS_REF_APLY_ASGN_CATG write completed")
        logger.info("Step: write_SSA_EMS_REF_APLY_ASGN_CATG_STS")
        # Write to Target: write_SSA_EMS_REF_APLY_ASGN_CATG_STS
        df_write = df_UPD_SSAL2_STS
        # Map source columns to target columns using connector field map (handles name
        # mismatches) — done BEFORE the _update_flag split so UPDATE/DELETE use target
        # column names in batch_update/batch_delete.
        _field_map = {"APLY_ASGN_CATG_DESP": "APLY_ASGN_CATG_DESP", "APLY_ASGN_CATG_KEY": "APLY_ASGN_CATG_KEY", "APLY_ASGN_CATG_PRIOR_NUM": "APLY_ASGN_CATG_PRIOR_NUM", "BGN_DATE": "OUT_V_BGN_DATE", "DISP_SEQ_NUM": "DISP_SEQ_NUM", "END_DATE": "OUT_V_END_DATE", "LAST_REC_TXN_DATE": "OUT_V_LAST_REC_TXN_DATE", "LAST_REC_TXN_MBR_CODE": "LAST_REC_TXN_MBR_CODE", "LAST_REC_TXN_TYPE_CODE": "OUT_V_LAST_REC_TXN_TYPE_CODE", "OPR_IND": "OUT_V_OPR_IND", "REF_CODE_BGN_DATE": "REF_CODE_BGN_DATE", "REF_CODE_END_DATE": "REF_CODE_END_DATE", "SOR_DATE": "OUT_SOR_DATE"}
        for _tgt_col, _src_col in _field_map.items():
            if _tgt_col.lower() not in [x.lower() for x in df_write.columns] and _src_col.lower() in [x.lower() for x in df_write.columns]:
                # Drop any column that would conflict case-insensitively with the target name 
                for _c in list(df_write.columns):
        ...
        df_write = _df_ins
        # Add NULL for unmapped target columns (schema parity) - excluding identity columns
        df_write = df_write.withColumn("APLY_ASGN_CATG_CODE", lit(None).cast(StringType()))
        ...
        logger.info("write_SSA_EMS_REF_APLY_ASGN_CATG_STS write completed")
        
        metrics.complete()
        logger.info("Mapping M_EMS_SSAL2_TRAN_EMS_REF_APLY_ASGN_CATG completed: SUCCESS")
        return True
        
    except Exception as e:
        metrics.fail(e)
        logger.error(f"Mapping M_EMS_SSAL2_TRAN_EMS_REF_APLY_ASGN_CATG FAILED: {e}", exc_info=True)
        return False
...
def main():
    ...
    logger = lib.get_logger()
    config = lib.load_config('env/config.yml')
    spark = lib.get_spark_session("M_EMS_SSAL2_TRAN_EMS_REF_APLY_ASGN_CATG", config)
    ctx = lib.SparkContext(spark)
    metrics = lib.MappingMetrics("M_EMS_SSAL2_TRAN_EMS_REF_APLY_ASGN_CATG")
