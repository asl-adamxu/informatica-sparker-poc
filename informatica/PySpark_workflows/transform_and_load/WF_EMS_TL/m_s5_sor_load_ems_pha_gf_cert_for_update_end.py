...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SSA_EMS_PHA_GF_CERT = lib.read_sql(spark, _conn, table="SSA_EMS_PHA_GF_CERT")
        
        logger.info("Step: read_SSA_EMS_PHA_GF_CERT_STS")
        # Reading Data From Source - read_SSA_EMS_PHA_GF_CERT_STS
        # Resolve connection by alias (supports lookup/source connections dynamically)
        _conn = lib.get_db_config(config, "SSA")
        df_SSA_EMS_PHA_GF_CERT_STS = lib.read_sql(spark, _conn, table="SSA_EMS_PHA_GF_CERT")
        ...
        df_SQ_SSA_EMS_PHA_GF_CERT = df_SQ_SSA_EMS_PHA_GF_CERT.filter(expr("OPR_IND = 'E'"))
        ...
        df_SQ_SSA_EMS_PHA_GF_CERT_STS = df_SQ_SSA_EMS_PHA_GF_CERT_STS.filter(expr("OPR_IND = 'E' OR OPR_IND = 'EB'"))
        # Select only SQ output ports (matches Informatica behavior) — missing ports become lit(None)
        ...
        df_write = df_SQ_SSA_EMS_PHA_GF_CERT_STS
        # Map source columns to target columns using connector field map (handles name
        # mismatches) — done BEFORE the _update_flag split so UPDATE/DELETE use target
        # column names in batch_update/batch_delete.
