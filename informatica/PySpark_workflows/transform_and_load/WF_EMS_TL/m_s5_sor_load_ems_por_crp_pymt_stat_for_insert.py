...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SSA_EMS_POR_CRP_PYMT_STAT = lib.read_sql(spark, _conn, table="SSA_EMS_POR_CRP_PYMT_STAT")
        
        logger.info("Step: read_SSA_EMS_POR_CRP_PYMT_STAT_STS")
        # Reading Data From Source - read_SSA_EMS_POR_CRP_PYMT_STAT_STS
        # Resolve connection by alias (supports lookup/source connections dynamically)
        _conn = lib.get_db_config(config, "SSA")
        df_SSA_EMS_POR_CRP_PYMT_STAT_STS = lib.read_sql(spark, _conn, table="SSA_EMS_POR_CRP_PYMT_STAT")
