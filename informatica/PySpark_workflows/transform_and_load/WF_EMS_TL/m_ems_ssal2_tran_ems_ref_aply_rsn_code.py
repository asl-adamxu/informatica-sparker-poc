 ...
 ORDER BY SOR_EMS_REF_APLY_RSN_CODE_STS.REF_APLY_RSN_CODE_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_EMS_REF_APLY_RSN_CODE'"},
        ...
        lib.write_target(
            ...
            delete_keys=['ref_aply_rsn_code_key', 'aply_type_code', 'aply_rsn_catg_code', 'aply_rsn_code', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
        ...
        lib.write_target(
            ...
            delete_keys=['ref_aply_rsn_code_key', 'bgn_date', 'end_date', 'aply_rsn_desp', 'aply_rsn_chi_desp', 'ref_code_bgn_date', 'ref_code_end_date', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
            has_update_flag=True,
            config=config,
        )
