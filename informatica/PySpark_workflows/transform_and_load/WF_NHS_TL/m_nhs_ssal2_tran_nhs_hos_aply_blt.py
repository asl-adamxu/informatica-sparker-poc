...
FROM NHS_HOS_APLY_BLT"""
        ...
        df_SQ_NHS_HOS_APLY_BLT = lib.sq_output(
            input_df=df_SQ_NHS_HOS_APLY_BLT,
            port_cols={
                'PHASE_CODE': 'string',
...
ORDER BY SOR_NHS_HOS_APLY_BLT_STS.HOS_APLY_BLT_KEY """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_NHS_HOS_APLY_BLT'"},
        ...
        lib.write_target(
            ...
            delete_keys=['hos_aply_blt_key', 'hos_aply_key', 'blt_num', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
