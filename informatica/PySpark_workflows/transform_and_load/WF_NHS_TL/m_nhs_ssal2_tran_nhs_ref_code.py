...
FROM NHS_REF_CODE"""
        ...
        df_SQ_NHS_REF_CODE = lib.sq_output(
            input_df=df_SQ_NHS_REF_CODE,
            port_cols={
                'REF_CODE_TYPE_CODE': 'string',
                'REF_CODE': 'string',
                'REF_CODE_ENG_DESP': 'string',
                'REF_CODE_CHI_DESP': 'string',
                'ROW_VER_NUM': 'decimal',
                'LAST_REC_TXN_TYPE_CODE': 'string',
                'LAST_REC_TXN_DATE': 'date/time',
                'LAST_REC_TXN_USER_ID': 'string',
                'REF_CODE_SORT_NUM': 'string',
            },
        )
        ...
        df_MPLT_AGMT_NHS_REF_CODE_TYPE_input = lib.expression(
            input_df=df_EXP_BK,
            computed_columns=[
                {'name': 'IN_NHS_REF_CODE_TYPE_CODE', 'expr': 'REF_CODE_TYPE_CODE'}
            ],
        )
        ...
        df_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_NULL_BKEY = lib.expression(
            input_df=df_MPLT_AGMT_NHS_REF_CODE_TYPE_input,
            computed_columns=[
                {'name': 'OUT_NHS_REF_CODE_TYPE_CODE', 'expr': 'IN_NHS_REF_CODE_TYPE_CODE'}
            ],
        )
        ...
        df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_DUMMY = lib.expression(
            input_df=df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_NULL_BKEY,
            rename_columns=[
        ...
        df_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_DUMMY = lib.expression(
            input_df=df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_DUMMY,
            computed_columns=[
        ...
        df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_OUTPUT = lib.expression(
            input_df=df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_DUMMY,
            rename_columns=[
        ...
        df_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_OUTPUT = lib.expression(
            input_df=df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_OUTPUT,
            computed_columns=[
        ...
        df_MPLT_AGMT_NHS_REF_CODE_TYPE = lib.expression(
            input_df=df_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_OUTPUT,
            pass_through_cols=['SOR_CACHE_STATUS', 'SSA_CACHE_STATUS', 'V_AUG_IND', 'OPR_IND', 'LAST_REC_TXN_TYPE_CODE', 'LAST_REC_TXN_DATE', 'REF_CODE_TYPE_KEY', 'NHS_REF_CODE_TYPE_CODE'],
        )
        ...
        df_FILTRANS_NHS_REF_CODE_TYPE = lib.filter(
            input_df=df_MPLT_AGMT_NHS_REF_CODE_TYPE,
        ...
        lib.write_target(
            spark=spark,
            df=df_FILTRANS_NHS_REF_CODE_TYPE,
            conn=conn_target,
...
where SOR_NHS_REF_CODE_STS.REF_CODE_KEY = ss.REF_CODE_KEY and SOR_NHS_REF_CODE_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_NHS_REF_CODE_STS.REF_CODE_KEY  """
        ...
        df_FILTRANS_MSTR = lib.filter(
            input_df=df_lkp_merge_MPLT_AGMT_NHS_REF_CODE_TYPE,
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_NHS_REF_CODE'"},
        ...
        lib.write_target(
            ...
            delete_keys=['ref_code_key', 'bgn_date', 'end_date', 'ref_code_eng_desp', 'ref_code_chi_desp', 'ref_code_sort_num', 'row_ver_num', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
        ...
        lib.write_target(
            ...
            delete_keys=['ref_code_key', 'ref_code_type_key', 'nhs_ref_code', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
            has_update_flag=True,
            config=config,
        )
