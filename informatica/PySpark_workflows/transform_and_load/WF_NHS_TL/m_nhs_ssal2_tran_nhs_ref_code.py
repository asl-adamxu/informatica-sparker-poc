...
FROM NHS_REF_CODE"""
        ...
        df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_NULL_BKEY = lib.dynamic_lookup(
            spark=spark,
            input_df=_lkp_input,
            lookup_df=df_MPLT_AGMT_NHS_REF_CODE_TYPE_LKP_DYN_SOR_NHS_REF_CODE_TYPE,
            name='MPLT_AGMT_NHS_REF_CODE_TYPE_LKP_DYN_SOR_NHS_REF_CODE_TYPE',
            join_predicates=[{'source_col': 'OUT_NHS_REF_CODE_TYPE_CODE', 'lookup_col': 'NHS_REF_CODE_TYPE_CODE'}],
            output_columns=['REF_CODE_TYPE_KEY', 'NHS_REF_CODE_TYPE_CODE'],
            lookup_output_fields=[
                {'name': 'REF_CODE_TYPE_KEY', 'ref_field': 'Sequence-Id', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'integer'},
                {'name': 'NHS_REF_CODE_TYPE_CODE', 'ref_field': 'OUT_NHS_REF_CODE_TYPE_CODE', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'string'}
            ],
            new_lookup_row_col='NewLookupRow_LKP_DYN_SOR_NHS_REF_CODE_TYPE',
            sequence_config={'output_col': 'REF_CODE_TYPE_KEY'},
        ...
        df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_DUMMY = lib.dynamic_lookup(
            spark=spark,
            input_df=_lkp_input,
            lookup_df=df_MPLT_AGMT_NHS_REF_CODE_TYPE_LKP_DYN_SSA_NHS_REF_CODE_TYPE,
            name='MPLT_AGMT_NHS_REF_CODE_TYPE_LKP_DYN_SSA_NHS_REF_CODE_TYPE',
            join_predicates=[{'source_col': 'REF_CODE_TYPE_KEY', 'lookup_col': 'SURROGATE_KEY'}],
            output_columns=['SURROGATE_KEY', 'DUMMY'],
            lookup_output_fields=[
                {'name': 'SURROGATE_KEY', 'ref_field': 'REF_CODE_TYPE_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
                {'name': 'DUMMY', 'ref_field': 'DUMMY', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'}
            ],
            new_lookup_row_col='NewLookupRow_LKP_DYN_SSA_NHS_REF_CODE_TYPE',
        ...
        df_lkp_merge_MPLT_AGMT_NHS_REF_CODE_TYPE = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_MSTR',
            join_predicates=[{'source_col': 'IN_REF_CODE_TYPE_KEY', 'lookup_col': 'REF_CODE_TYPE_KEY'}, {'source_col': 'IN_NHS_REF_CODE', 'lookup_col': 'NHS_REF_CODE'}],
            output_columns=['REF_CODE_KEY', 'REF_CODE_TYPE_KEY', 'NHS_REF_CODE'],
            lookup_output_fields=[
                {'name': 'REF_CODE_KEY', 'ref_field': 'Sequence-Id', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'integer'},
                {'name': 'REF_CODE_TYPE_KEY', 'ref_field': 'REF_CODE_TYPE_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'decimal'},
                {'name': 'NHS_REF_CODE', 'ref_field': 'REF_CODE', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'string'}
            ],
            new_lookup_row_col='NewLookupRow',
            sequence_config={'output_col': 'REF_CODE_KEY'},
            insert_else_update=True,
            update_else_insert=False,
            update_condition='TRUE',
            output_old_value_on_update=False,
...
where SOR_NHS_REF_CODE_STS.REF_CODE_KEY = ss.REF_CODE_KEY and SOR_NHS_REF_CODE_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_NHS_REF_CODE_STS.REF_CODE_KEY  """
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_STS',
            join_predicates=[{'source_col': 'IN_REF_CODE_KEY', 'lookup_col': 'REF_CODE_KEY'}],
            output_columns=['REF_CODE_KEY', 'BGN_DATE', 'END_DATE', 'REF_CODE_ENG_DESP', 'REF_CODE_CHI_DESP', 'REF_CODE_SORT_NUM', 'ROW_VER_NUM'],
            lookup_output_fields=[
                {'name': 'REF_CODE_KEY', 'ref_field': 'REF_CODE_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
                ...
                {'name': 'REF_CODE_ENG_DESP', 'ref_field': 'REF_CODE_ENG_DESP', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'REF_CODE_CHI_DESP', 'ref_field': 'REF_CODE_CHI_DESP', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'REF_CODE_SORT_NUM', 'ref_field': 'REF_CODE_SORT_NUM', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
        ...
        df_lkp_merge_FILTRANS_MSTR = lib.dynamic_lookup(
            ...
            output_columns=['SURROGATE_KEY', 'DUMMY'],
            lookup_output_fields=[
                {'name': 'SURROGATE_KEY', 'ref_field': 'REF_CODE_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
