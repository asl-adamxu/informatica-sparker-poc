...
FROM NHS_REF_CODE"""
        ...
        df_MPLT_AGMT_NHS_REF_CODE_TYPE_input = df_EXP_BK
        df_MPLT_AGMT_NHS_REF_CODE_TYPE_input = df_MPLT_AGMT_NHS_REF_CODE_TYPE_input.withColumn("IN_NHS_REF_CODE_TYPE_CODE", expr("REF_CODE_TYPE_CODE"))
        ctx.register_df("df_MPLT_AGMT_NHS_REF_CODE_TYPE_input", df_MPLT_AGMT_NHS_REF_CODE_TYPE_input)
        ...
        df_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_NULL_BKEY = df_MPLT_AGMT_NHS_REF_CODE_TYPE_input
        ...
        _dup_cnt = df_MPLT_AGMT_NHS_REF_CODE_TYPE_LKP_DYN_SOR_NHS_REF_CODE_TYPE.groupBy(col("NHS_REF_CODE_TYPE_CODE")).count().filter(col("count") > 1).count()
        if _dup_cnt > 0:
            raise RuntimeError(f"Lookup apply_MPLT_AGMT_NHS_REF_CODE_TYPE_LKP_DYN_SOR_NHS_REF_CODE_TYPE: {_dup_cnt} duplicate keys found — Report Error policy")
        ...
        df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_NULL_BKEY = _lkp_input.alias("_main").join(
        ...
        if _nlr_lkp_cols:
            df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_NULL_BKEY = df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_NULL_BKEY.withColumn("NewLookupRow_LKP_DYN_SOR_NHS_REF_CODE_TYPE", expr("CASE WHEN `" + _nlr_lkp_cols[0] + "` IS NULL THEN 0 ELSE 1 END"))
        else:
            df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_NULL_BKEY = df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_NULL_BKEY.withColumn("NewLookupRow_LKP_DYN_SOR_NHS_REF_CODE_TYPE", lit(1))
        ctx.register_df("df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_NULL_BKEY", df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_NULL_BKEY)        
        logger.info("Step: rename_EXP_DUMMY")
        # Expression: rename_EXP_DUMMY
        df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_DUMMY = df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_NULL_BKEY
        df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_DUMMY = df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_DUMMY.drop("NewLookupRow").withColumnRenamed("NewLookupRow_LKP_DYN_SOR_NHS_REF_CODE_TYPE", "NewLookupRow")
        ctx.register_df("df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_DUMMY", df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_DUMMY)
        
        logger.info("Step: apply_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_DUMMY")
        # Expression: apply_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_DUMMY
        df_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_DUMMY = df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_DUMMY
        ...
        # Report Error on multiple match: check for duplicate join keys
        _dup_cnt = df_MPLT_AGMT_NHS_REF_CODE_TYPE_LKP_DYN_SSA_NHS_REF_CODE_TYPE.groupBy(col("SURROGATE_KEY")).count().filter(col("count") > 1).count()
        if _dup_cnt > 0:
            raise RuntimeError(f"Lookup apply_MPLT_AGMT_NHS_REF_CODE_TYPE_LKP_DYN_SSA_NHS_REF_CODE_TYPE: {_dup_cnt} duplicate keys found — Report Error policy")
        # Rename upstream columns to match lookup input port names before join
        _lkp_input = df_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_DUMMY
        # Join condition: REF_CODE_TYPE_KEY=SURROGATE_KEY
        # Alias-based join: _main.<source_col> == _lkp.<lookup_col>
        df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_DUMMY = _lkp_input.alias("_main").join(
        ...
        if (_nlr_key.lower() not in [x.lower() for x in _lkp_input.columns]
            ...
            _nlr_lkp_cols.insert(0, _nlr_key)
        if _nlr_lkp_cols:
            df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_DUMMY = df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_DUMMY.withColumn("NewLookupRow_LKP_DYN_SSA_NHS_REF_CODE_TYPE", expr("CASE WHEN `" + _nlr_lkp_cols[0] + "` IS NULL THEN 0 ELSE 1 END"))
        else:
            df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_DUMMY = df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_DUMMY.withColumn("NewLookupRow_LKP_DYN_SSA_NHS_REF_CODE_TYPE", lit(1))
        ctx.register_df("df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_DUMMY", df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_DUMMY)        
        logger.info("Step: rename_EXP_OUTPUT")
        # Expression: rename_EXP_OUTPUT
        df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_OUTPUT = df_mplt_lkp_chain_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_DUMMY
        df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_OUTPUT = df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_OUTPUT.drop("SOR_CACHE_STATUS").withColumnRenamed("NewLookupRow", "SOR_CACHE_STATUS")
        df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_OUTPUT = df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_OUTPUT.drop("SSA_CACHE_STATUS").withColumnRenamed("NewLookupRow_LKP_DYN_SSA_NHS_REF_CODE_TYPE", "SSA_CACHE_STATUS")
        ctx.register_df("df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_OUTPUT", df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_OUTPUT)
        
        logger.info("Step: apply_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_OUTPUT")
        # Expression: apply_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_OUTPUT
        df_MPLT_AGMT_NHS_REF_CODE_TYPE_EXP_OUTPUT = df_MPLT_AGMT_NHS_REF_CODE_TYPE_rename_EXP_OUTPUT
        ...
        # Alias-based join: _main.<source_col> == _lkp.<lookup_col>
        df_lkp_merge_MPLT_AGMT_NHS_REF_CODE_TYPE = _lkp_input.alias("_main").join(
        ...
        if (_nlr_key.lower() not in [x.lower() for x in _lkp_input.columns]
            ...
            _nlr_lkp_cols.insert(0, _nlr_key)
        if _nlr_lkp_cols:
            df_lkp_merge_MPLT_AGMT_NHS_REF_CODE_TYPE = df_lkp_merge_MPLT_AGMT_NHS_REF_CODE_TYPE.withColumn("NewLookupRow", expr("CASE WHEN `" + _nlr_lkp_cols[0] + "` IS NULL THEN 0 ELSE 1 END"))
        else:
            df_lkp_merge_MPLT_AGMT_NHS_REF_CODE_TYPE = df_lkp_merge_MPLT_AGMT_NHS_REF_CODE_TYPE.withColumn("NewLookupRow", lit(1))
        ctx.register_df("df_lkp_merge_MPLT_AGMT_NHS_REF_CODE_TYPE", df_lkp_merge_MPLT_AGMT_NHS_REF_CODE_TYPE)        
...
where SOR_NHS_REF_CODE_STS.REF_CODE_KEY = ss.REF_CODE_KEY and SOR_NHS_REF_CODE_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_NHS_REF_CODE_STS.REF_CODE_KEY  """
        ...
        # Rename upstream columns to match lookup input port names before join
        _lkp_input = df_lkp_merge_MPLT_AGMT_NHS_REF_CODE_TYPE
        ...
        __fil_input = df_lkp_merge_MPLT_AGMT_NHS_REF_CODE_TYPE
