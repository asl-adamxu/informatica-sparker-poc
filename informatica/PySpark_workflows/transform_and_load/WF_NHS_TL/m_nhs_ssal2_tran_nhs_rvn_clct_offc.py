...
FROM NHS_RVN_CLCT_OFFC"""
        ...
        df_SQ_NHS_RVN_CLCT_OFFC = lib.sq_output(
            input_df=df_SQ_NHS_RVN_CLCT_OFFC,
            port_cols={
 ...
 ORDER BY SOR_NHS_RVN_CLCT_OFFC_STS.RVN_CLCT_OFFC_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_NHS_RVN_CLCT_OFFC'"},
        ...
        lib.write_target(
            ...
            delete_keys=['rvn_clct_offc_key', 'nhs_rvn_clct_offc_key', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
