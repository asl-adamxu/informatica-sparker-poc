...
FROM NHS_RSCN_PCHS_STL"""
        ...
        df_SQ_NHS_RSCN_PCHS_STL = lib.sq_output(
            input_df=df_SQ_NHS_RSCN_PCHS_STL,
            port_cols={
 ...
 ORDER BY SOR_NHS_RSCN_PCHS_STL_STS.RSCN_PCHS_STL_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_NHS_RSCN_PCHS_STL'"},
        ...
        lib.write_target(
            ...
            delete_keys=['rscn_pchs_stl_key', 'pchs_stl_key', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
