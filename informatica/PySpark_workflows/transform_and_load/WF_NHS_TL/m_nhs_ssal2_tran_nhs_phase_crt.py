...
FROM NHS_PHASE_CRT"""
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_MSTR',
            join_predicates=[{'source_col': 'IN_NHS_PHASE_CODE', 'lookup_col': 'NHS_PHASE_CODE'}, {'source_col': 'IN_HOS_CRT_KEY', 'lookup_col': 'HOS_CRT_KEY'}],
            output_columns=['PHASE_CRT_KEY', 'NHS_PHASE_CODE', 'HOS_CRT_KEY'],
            lookup_output_fields=[
                {'name': 'PHASE_CRT_KEY', 'ref_field': 'Sequence-Id', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'integer'},
            ...
            sequence_config={'output_col': 'PHASE_CRT_KEY'},
            insert_else_update=True,
            update_else_insert=False,
            update_condition='TRUE',
            output_old_value_on_update=False,
...
where SOR_NHS_PHASE_CRT_STS.PHASE_CRT_KEY = ss.PHASE_CRT_KEY and SOR_NHS_PHASE_CRT_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_NHS_PHASE_CRT_STS.PHASE_CRT_KEY  """
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_STS',
            join_predicates=[{'source_col': 'IN_PHASE_CRT_KEY', 'lookup_col': 'PHASE_CRT_KEY'}],
            output_columns=['PHASE_CRT_KEY', 'BGN_DATE', 'END_DATE', 'ROW_VER_NUM'],
            lookup_output_fields=[
                {'name': 'PHASE_CRT_KEY', 'ref_field': 'PHASE_CRT_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
        ...
        df_lkp_merge_FILTRANS_MSTR = lib.dynamic_lookup(
            ...
            output_columns=['SURROGATE_KEY', 'DUMMY'],
            lookup_output_fields=[
                {'name': 'SURROGATE_KEY', 'ref_field': 'PHASE_CRT_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
