 ...
 ORDER BY SOR_NHS_PHASE_CRT_STS.PHASE_CRT_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_NHS_PHASE_CRT'"},
        ...
        lib.write_target(
            ...
            delete_keys=['phase_crt_key', 'nhs_phase_code', 'hos_crt_key', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
        ...
        lib.write_target(
            ...
            delete_keys=['phase_crt_key', 'bgn_date', 'end_date', 'row_ver_num', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
            has_update_flag=True,
            config=config,
        )
