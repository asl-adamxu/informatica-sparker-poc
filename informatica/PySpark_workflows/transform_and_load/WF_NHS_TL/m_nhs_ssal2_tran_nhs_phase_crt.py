...
FROM NHS_PHASE_CRT"""
        ...
        if _nlr_lkp_cols:
            df_mplt_lkp_chain_3 = df_mplt_lkp_chain_3.withColumn("NewLookupRow_LKP_DYN_SOR_NHS_HOS_CRT", expr("CASE WHEN `" + _nlr_lkp_cols[0] + "` IS NULL THEN 0 ELSE 1 END"))
        else:
            df_mplt_lkp_chain_3 = df_mplt_lkp_chain_3.withColumn("NewLookupRow_LKP_DYN_SOR_NHS_HOS_CRT", lit(1))
        ...
        df_MPLT_AGMT_NHS_HOS_CRT_rename_4 = df_MPLT_AGMT_NHS_HOS_CRT_rename_4.drop("NewLookupRow").withColumnRenamed("NewLookupRow_LKP_DYN_SOR_NHS_HOS_CRT", "NewLookupRow")
        ...
        if (_nlr_key.lower() not in [x.lower() for x in _lkp_input.columns]
            ...
            _nlr_lkp_cols.insert(0, _nlr_key)
        if _nlr_lkp_cols:
            df_mplt_lkp_chain_5 = df_mplt_lkp_chain_5.withColumn("NewLookupRow_LKP_DYN_SSA_NHS_HOS_CRT", expr("CASE WHEN `" + _nlr_lkp_cols[0] + "` IS NULL THEN 0 ELSE 1 END"))
        else:
            df_mplt_lkp_chain_5 = df_mplt_lkp_chain_5.withColumn("NewLookupRow_LKP_DYN_SSA_NHS_HOS_CRT", lit(1))
        ...
        df_MPLT_AGMT_NHS_HOS_CRT_rename_6 = df_MPLT_AGMT_NHS_HOS_CRT_rename_6.drop("SSA_CACHE_STATUS").withColumnRenamed("NewLookupRow_LKP_DYN_SSA_NHS_HOS_CRT", "SSA_CACHE_STATUS")
        ...
        _cc = list(dict.fromkeys(c for c in df_EXP_BK.columns if c.lower() in [x.lower() for x in df_MPLT_AGMT_NHS_HOS_CRT.columns]))
        if _cc:
            __lkp_dup = [c for c in df_MPLT_AGMT_NHS_HOS_CRT.columns if c.lower() in [x.lower() for x in df_EXP_BK.columns] and c.lower() not in [x.lower() for x in _cc]]
            ...
            logger.warning("No common columns between df_EXP_BK and df_MPLT_AGMT_NHS_HOS_CRT — using synthetic key join")
