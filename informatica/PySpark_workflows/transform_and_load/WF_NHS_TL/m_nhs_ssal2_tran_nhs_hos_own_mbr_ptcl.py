...
FROM NHS_HOS_OWN_MBR_PTCL"""
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_MSTR',
            join_predicates=[{'source_col': 'IN_HOS_OWN_KEY', 'lookup_col': 'HOS_OWN_KEY'}, {'source_col': 'IN_NHS_MBR_SEQ_NUM', 'lookup_col': 'NHS_MBR_SEQ_NUM'}],
            output_columns=['HOS_OWN_MBR_PTCL_KEY', 'HOS_OWN_KEY', 'NHS_MBR_SEQ_NUM'],
            lookup_output_fields=[
                {'name': 'HOS_OWN_MBR_PTCL_KEY', 'ref_field': 'Sequence-Id', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'integer'},
                {'name': 'HOS_OWN_KEY', 'ref_field': 'HOS_OWN_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'decimal'},
                {'name': 'NHS_MBR_SEQ_NUM', 'ref_field': 'MBR_SEQ_NUM', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'decimal'}
            ],
            new_lookup_row_col='NewLookupRow',
            sequence_config={'output_col': 'HOS_OWN_MBR_PTCL_KEY'},
            insert_else_update=True,
            update_else_insert=False,
            update_condition='TRUE',
            output_old_value_on_update=False,
...
where SOR_NHS_HOS_OWN_MBR_PTCL_STS.HOS_OWN_MBR_PTCL_KEY = ss.HOS_OWN_MBR_PTCL_KEY and SOR_NHS_HOS_OWN_MBR_PTCL_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_NHS_HOS_OWN_MBR_PTCL_STS.HOS_OWN_MBR_PTCL_KEY  """
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_STS',
            join_predicates=[{'source_col': 'IN_HOS_OWN_MBR_PTCL_KEY', 'lookup_col': 'HOS_OWN_MBR_PTCL_KEY'}],
            output_columns=['HOS_OWN_MBR_PTCL_KEY', 'BGN_DATE', 'END_DATE', 'MBR_ID_TYPE_CODE', 'MBR_ID_NUM', 'MBR_ID_CERT_NUM', 'MBR_ENG_SRNM_NAME', 'MBR_ENG_GIVE_NAME', 'MBR_CHI_NAME', 'MBR_GNDR_CODE', 'MBR_DOB_TEXT', 'MBR_RLTN_CODE', 'MBR_RLTN_DESP', 'MBR_MRTL_STS_CODE', 'MBR_OWNR_CODE', 'ROW_VER_NUM', 'MBR_DEL_RSN_CODE', 'MBR_DEL_RSN_TEXT'],
            lookup_output_fields=[
                {'name': 'HOS_OWN_MBR_PTCL_KEY', 'ref_field': 'HOS_OWN_MBR_PTCL_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
                ...
                {'name': 'MBR_ID_TYPE_CODE', 'ref_field': 'MBR_ID_TYPE_CODE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'MBR_ID_NUM', 'ref_field': 'MBR_ID_NUM', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'MBR_ID_CERT_NUM', 'ref_field': 'MBR_ID_CERT_NUM', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'MBR_ENG_SRNM_NAME', 'ref_field': 'MBR_ENG_SRNM_NAME', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'MBR_ENG_GIVE_NAME', 'ref_field': 'MBR_ENG_GIVE_NAME', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'MBR_CHI_NAME', 'ref_field': 'MBR_CHI_NAME', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'MBR_GNDR_CODE', 'ref_field': 'MBR_GNDR_CODE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'MBR_DOB_TEXT', 'ref_field': 'MBR_DOB_TEXT', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'MBR_RLTN_CODE', 'ref_field': 'MBR_RLTN_CODE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'MBR_RLTN_DESP', 'ref_field': 'MBR_RLTN_DESP', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'MBR_MRTL_STS_CODE', 'ref_field': 'MBR_MRTL_STS_CODE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                ...
                {'name': 'MBR_DEL_RSN_CODE', 'ref_field': 'MBR_DEL_RSN_CODE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'MBR_DEL_RSN_TEXT', 'ref_field': 'MBR_DEL_RSN_TEXT', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'}
            ],
            new_lookup_row_col='NewLookupRow',
            sequence_config=None,
            insert_else_update=True,
        ...
        df_lkp_merge_FILTRANS_MSTR = lib.dynamic_lookup(
            ...
            output_columns=['SURROGATE_KEY', 'DUMMY'],
            lookup_output_fields=[
                {'name': 'SURROGATE_KEY', 'ref_field': 'HOS_OWN_MBR_PTCL_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
