...
FROM NHS_PHASE"""
        ...
        df_SQ_NHS_PHASE = lib.sq_output(
            input_df=df_SQ_NHS_PHASE,
            port_cols={
                'PHASE_CODE': 'string',
 ...
 ORDER BY SOR_NHS_PHASE_STS.PHASE_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_NHS_PHASE'"},
        ...
        lib.write_target(
            ...
            delete_keys=['phase_key', 'nhs_phase_code', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
