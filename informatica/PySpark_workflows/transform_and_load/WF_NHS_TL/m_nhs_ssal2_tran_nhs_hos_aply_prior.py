...
and exists (select 1 from nhs_hos_aply_catg_prior)"""
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            _lkp_input,
            df_DLKP_SOR_MSTR,
            {'name': 'DLKP_SOR_MSTR', 'join_predicates': [{'source_col': 'IN_HOS_APLY_KEY', 'lookup_col': 'HOS_APLY_KEY'}, {'source_col': 'IN_NHS_PRIOR_CATG_CODE', 'lookup_col': 'NHS_PRIOR_CATG_CODE'}], 'output_columns': ['HOS_APLY_PRIOR_KEY', 'HOS_APLY_KEY', 'NHS_PRIOR_CATG_CODE'], 'lookup_output_fields': [{'name': 'HOS_APLY_PRIOR_KEY', 'ref_field': 'Sequence-Id', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'integer'}, {'name': 'HOS_APLY_KEY', 'ref_field': 'HOS_APLY_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'decimal'}, {'name': 'NHS_PRIOR_CATG_CODE', 'ref_field': 'PRIOR_CATG_CODE', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'string'}], 'new_lookup_row_col': 'NewLookupRow', 'sequence_config': {'output_col': 'HOS_APLY_PRIOR_KEY'}, 'insert_else_update': True, 'update_else_insert': False, 'update_condition': 'TRUE', 'output_old_value_on_update': False, 'case_sensitive_string_comparison': False, 'lookup_policy': 'Report Error', 'order_by_columns': []},
            config=config,
        )
...
where SOR_NHS_HOS_APLY_PRIOR_STS.HOS_APLY_PRIOR_KEY = ss.HOS_APLY_PRIOR_KEY and SOR_NHS_HOS_APLY_PRIOR_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_NHS_HOS_APLY_PRIOR_STS.HOS_APLY_PRIOR_KEY """
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            _lkp_input,
            df_DLKP_SOR_STS,
            {'name': 'DLKP_SOR_STS', 'join_predicates': [{'source_col': 'IN_HOS_APLY_PRIOR_KEY', 'lookup_col': 'HOS_APLY_PRIOR_KEY'}], 'output_columns': ['HOS_APLY_PRIOR_KEY', 'BGN_DATE', 'END_DATE', 'PRIOR_NUM', 'ROW_VER_NUM', 'PRIOR_CATG_GRP_CODE', 'EFAS_PRIOR_NUM_SFX_NUM'], 'lookup_output_fields': [{'name': 'HOS_APLY_PRIOR_KEY', 'ref_field': 'HOS_APLY_PRIOR_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'}, {'name': 'BGN_DATE', 'ref_field': 'DUMMY_DATE', 'ignore_in_compare': True, 'ignore_null_inputs': True, 'datatype': 'date/time'}, {'name': 'END_DATE', 'ref_field': 'DUMMY_DATE', 'ignore_in_compare': True, 'ignore_null_inputs': True, 'datatype': 'date/time'}, {'name': 'PRIOR_NUM', 'ref_field': 'PRIOR_NUM', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'}, {'name': 'ROW_VER_NUM', 'ref_field': 'ROW_VER_NUM', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'}, {'name': 'PRIOR_CATG_GRP_CODE', 'ref_field': 'PRIOR_CATG_GRP_CODE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'}, {'name': 'EFAS_PRIOR_NUM_SFX_NUM', 'ref_field': 'EFAS_PRIOR_NUM_SFX_NUM', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'}], 'new_lookup_row_col': 'NewLookupRow', 'sequence_config': None, 'insert_else_update': True, 'update_else_insert': False, 'update_condition': 'TRUE', 'output_old_value_on_update': False, 'case_sensitive_string_comparison': False, 'lookup_policy': 'Report Error', 'order_by_columns': []},
            config=config,
        )
        ctx.register_df("df_lkp_merge_EXP_BK", df_lkp_merge_EXP_BK)
