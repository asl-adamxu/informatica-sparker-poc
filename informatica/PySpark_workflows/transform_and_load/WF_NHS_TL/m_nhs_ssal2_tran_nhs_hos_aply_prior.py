...
and exists (select 1 from nhs_hos_aply_catg_prior)"""
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_MSTR',
            join_predicates=[{'source_col': 'IN_HOS_APLY_KEY', 'lookup_col': 'HOS_APLY_KEY'}, {'source_col': 'IN_NHS_PRIOR_CATG_CODE', 'lookup_col': 'NHS_PRIOR_CATG_CODE'}],
            output_columns=['HOS_APLY_PRIOR_KEY', 'HOS_APLY_KEY', 'NHS_PRIOR_CATG_CODE'],
            lookup_output_fields=[
                {'name': 'HOS_APLY_PRIOR_KEY', 'ref_field': 'Sequence-Id', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'integer'},
            ...
            sequence_config={'output_col': 'HOS_APLY_PRIOR_KEY'},
            insert_else_update=True,
            update_else_insert=False,
            update_condition='TRUE',
            output_old_value_on_update=False,
...
where SOR_NHS_HOS_APLY_PRIOR_STS.HOS_APLY_PRIOR_KEY = ss.HOS_APLY_PRIOR_KEY and SOR_NHS_HOS_APLY_PRIOR_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_NHS_HOS_APLY_PRIOR_STS.HOS_APLY_PRIOR_KEY """
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_STS',
            join_predicates=[{'source_col': 'IN_HOS_APLY_PRIOR_KEY', 'lookup_col': 'HOS_APLY_PRIOR_KEY'}],
            output_columns=['HOS_APLY_PRIOR_KEY', 'BGN_DATE', 'END_DATE', 'PRIOR_NUM', 'ROW_VER_NUM', 'PRIOR_CATG_GRP_CODE', 'EFAS_PRIOR_NUM_SFX_NUM'],
            lookup_output_fields=[
                {'name': 'HOS_APLY_PRIOR_KEY', 'ref_field': 'HOS_APLY_PRIOR_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
        ...
        df_lkp_merge_FILTRANS_MSTR = lib.dynamic_lookup(
            ...
            output_columns=['SURROGATE_KEY', 'DUMMY'],
            lookup_output_fields=[
                {'name': 'SURROGATE_KEY', 'ref_field': 'HOS_APLY_PRIOR_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
