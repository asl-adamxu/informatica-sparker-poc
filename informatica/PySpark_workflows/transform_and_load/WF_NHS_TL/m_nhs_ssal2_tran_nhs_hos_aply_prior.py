...
and exists (select 1 from nhs_hos_aply_catg_prior)"""
        ...
        df_SQ_NHS_HOS_APLY_CATG_PRIOR_END = lib.sq_output(
            input_df=df_SQ_NHS_HOS_APLY_CATG_PRIOR_END,
            port_cols={
        ...
        df_SQ_NHS_HOS_APLY_CATG_PRIOR = lib.sq_output(
            input_df=df_SQ_NHS_HOS_APLY_CATG_PRIOR,
            port_cols={
                'HOS_APLY_KEY': 'decimal',
 ...
 ORDER BY SOR_NHS_HOS_APLY_PRIOR_STS.HOS_APLY_PRIOR_KEY """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_NHS_HOS_APLY_PRIOR'"},
