...
FROM NHS_PCHS_STL"""
        ...
        df_SQ_NHS_PCHS_STL = lib.sq_output(
            input_df=df_SQ_NHS_PCHS_STL,
            port_cols={
 ...
 ORDER BY SOR_NHS_PCHS_STL_STS.PCHS_STL_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_NHS_PCHS_STL'"},
        ...
        lib.write_target(
            ...
            delete_keys=['pchs_stl_key', 'nhs_pchs_stl_key', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
        ...
        lib.write_target(
            ...
            delete_keys=['pchs_stl_key', 'bgn_date', 'end_date', 'pchs_stl_ostd_amt', 'ovrd_intrst_amt', 'pchs_stl_date', 'pchs_stl_bank_rcv_date', 'pchs_stl_rscn_date', 'hos_own_key', 'pchs_stl_vrfy_date', 'asgn_slctr_id', 'slctr_inpt_bsns_date', 'row_ver_num', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date', 'pchsr_slctr_eng_name'],
            has_update_flag=True,
            config=config,
        )
