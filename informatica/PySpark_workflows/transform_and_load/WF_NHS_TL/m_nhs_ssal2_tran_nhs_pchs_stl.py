...
FROM NHS_PCHS_STL"""
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_MSTR',
            join_predicates=[{'source_col': 'IN_NHS_PCHS_STL_KEY', 'lookup_col': 'NHS_PCHS_STL_KEY'}],
            ...
            lookup_output_fields=[
                ...
                {'name': 'NHS_PCHS_STL_KEY', 'ref_field': 'PCHS_STL_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'decimal'}
            ],
...
where SOR_NHS_PCHS_STL_STS.PCHS_STL_KEY = ss.PCHS_STL_KEY and SOR_NHS_PCHS_STL_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_NHS_PCHS_STL_STS.PCHS_STL_KEY  """
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            output_columns=['PCHS_STL_KEY', 'BGN_DATE', 'END_DATE', 'PCHS_STL_OSTD_AMT', 'OVRD_INTRST_AMT', 'PCHS_STL_DATE', 'PCHS_STL_BANK_RCV_DATE', 'PCHS_STL_RSCN_DATE', 'HOS_OWN_KEY', 'PCHS_STL_VRFY_DATE', 'ASGN_SLCTR_ID', 'SLCTR_INPT_BSNS_DATE', 'ROW_VER_NUM', 'PCHSR_SLCTR_ENG_NAME'],
            lookup_output_fields=[
                {'name': 'PCHS_STL_KEY', 'ref_field': 'PCHS_STL_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
                ...
                {'name': 'PCHS_STL_OSTD_AMT', 'ref_field': 'PCHS_STL_OSTD_AMT', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'},
                {'name': 'OVRD_INTRST_AMT', 'ref_field': 'OVRD_INTRST_AMT', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'},
                {'name': 'PCHS_STL_DATE', 'ref_field': 'PCHS_STL_DATE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'date/time'},
                {'name': 'PCHS_STL_BANK_RCV_DATE', 'ref_field': 'PCHS_STL_BANK_RCV_DATE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'date/time'},
                {'name': 'PCHS_STL_RSCN_DATE', 'ref_field': 'PCHS_STL_RSCN_DATE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'date/time'},
                {'name': 'HOS_OWN_KEY', 'ref_field': 'HOS_OWN_KEY', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'},
                {'name': 'PCHS_STL_VRFY_DATE', 'ref_field': 'PCHS_STL_VRFY_DATE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'date/time'},
                {'name': 'ASGN_SLCTR_ID', 'ref_field': 'ASGN_SLCTR_ID', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'},
                {'name': 'SLCTR_INPT_BSNS_DATE', 'ref_field': 'SLCTR_INPT_BSNS_DATE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'date/time'},
                {'name': 'ROW_VER_NUM', 'ref_field': 'ROW_VER_NUM', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'},
                {'name': 'PCHSR_SLCTR_ENG_NAME', 'ref_field': 'PCHSR_SLCTR_ENG_NAME', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'}
            ],
            new_lookup_row_col='NewLookupRow',
            sequence_config=None,
            insert_else_update=True,
