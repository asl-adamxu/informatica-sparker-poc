...
FROM NHS_PCHS_STL"""
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            _lkp_input,
            df_DLKP_SOR_MSTR,
            {'name': 'DLKP_SOR_MSTR', 'join_predicates': [{'source_col': 'IN_NHS_PCHS_STL_KEY', 'lookup_col': 'NHS_PCHS_STL_KEY'}], 'output_columns': ['PCHS_STL_KEY', 'NHS_PCHS_STL_KEY'], 'lookup_output_fields': [{'name': 'PCHS_STL_KEY', 'ref_field': 'Sequence-Id', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'integer'}, {'name': 'NHS_PCHS_STL_KEY', 'ref_field': 'PCHS_STL_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'decimal'}], 'new_lookup_row_col': 'NewLookupRow', 'sequence_config': {'output_col': 'PCHS_STL_KEY'}, 'insert_else_update': True, 'update_else_insert': False, 'update_condition': 'TRUE', 'output_old_value_on_update': False, 'case_sensitive_string_comparison': False, 'lookup_policy': 'Report Error', 'order_by_columns': []},
            config=config,
        )
        ...
        df_MPLT_AGMT_NHS_HOS_OWN_input = df_lkp_merge_EXP_BK
...
where SOR_NHS_PCHS_STL_STS.PCHS_STL_KEY = ss.PCHS_STL_KEY and SOR_NHS_PCHS_STL_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_NHS_PCHS_STL_STS.PCHS_STL_KEY  """
        ...
        _cc = list(dict.fromkeys(c for c in df_lkp_merge_EXP_BK.columns if c.lower() in [x.lower() for x in df_MPLT_AGMT_NHS_HOS_OWN.columns]))
        if _cc:
            __lkp_dup = [c for c in df_MPLT_AGMT_NHS_HOS_OWN.columns if c.lower() in [x.lower() for x in df_lkp_merge_EXP_BK.columns] and c.lower() not in [x.lower() for x in _cc]]
            ...
            logger.warning("No common columns between df_lkp_merge_EXP_BK and df_MPLT_AGMT_NHS_HOS_OWN — using synthetic key join")
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            _lkp_input,
            df_DLKP_SOR_STS,
            {'name': 'DLKP_SOR_STS', 'join_predicates': [{'source_col': 'IN_PCHS_STL_KEY', 'lookup_col': 'PCHS_STL_KEY'}], 'output_columns': ['PCHS_STL_KEY', 'BGN_DATE', 'END_DATE', 'PCHS_STL_OSTD_AMT', 'OVRD_INTRST_AMT', 'PCHS_STL_DATE', 'PCHS_STL_BANK_RCV_DATE', 'PCHS_STL_RSCN_DATE', 'HOS_OWN_KEY', 'PCHS_STL_VRFY_DATE', 'ASGN_SLCTR_ID', 'SLCTR_INPT_BSNS_DATE', 'ROW_VER_NUM', 'PCHSR_SLCTR_ENG_NAME'], 'lookup_output_fields': [{'name': 'PCHS_STL_KEY', 'ref_field': 'PCHS_STL_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'}, {'name': 'BGN_DATE', 'ref_field': 'DUMMY_DATE', 'ignore_in_compare': True, 'ignore_null_inputs': True, 'datatype': 'date/time'}, {'name': 'END_DATE', 'ref_field': 'DUMMY_DATE', 'ignore_in_compare': True, 'ignore_null_inputs': True, 'datatype': 'date/time'}, {'name': 'PCHS_STL_OSTD_AMT', 'ref_field': 'PCHS_STL_OSTD_AMT', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'}, {'name': 'OVRD_INTRST_AMT', 'ref_field': 'OVRD_INTRST_AMT', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'}, {'name': 'PCHS_STL_DATE', 'ref_field': 'PCHS_STL_DATE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'date/time'}, {'name': 'PCHS_STL_BANK_RCV_DATE', 'ref_field': 'PCHS_STL_BANK_RCV_DATE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'date/time'}, {'name': 'PCHS_STL_RSCN_DATE', 'ref_field': 'PCHS_STL_RSCN_DATE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'date/time'}, {'name': 'HOS_OWN_KEY', 'ref_field': 'HOS_OWN_KEY', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'}, {'name': 'PCHS_STL_VRFY_DATE', 'ref_field': 'PCHS_STL_VRFY_DATE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'date/time'}, {'name': 'ASGN_SLCTR_ID', 'ref_field': 'ASGN_SLCTR_ID', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'}, {'name': 'SLCTR_INPT_BSNS_DATE', 'ref_field': 'SLCTR_INPT_BSNS_DATE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'date/time'}, {'name': 'ROW_VER_NUM', 'ref_field': 'ROW_VER_NUM', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'}, {'name': 'PCHSR_SLCTR_ENG_NAME', 'ref_field': 'PCHSR_SLCTR_ENG_NAME', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'}], 'new_lookup_row_col': 'NewLookupRow', 'sequence_config': None, 'insert_else_update': True, 'update_else_insert': False, 'update_condition': 'TRUE', 'output_old_value_on_update': False, 'case_sensitive_string_comparison': False, 'lookup_policy': 'Report Error', 'order_by_columns': []},
            config=config,
        )
        ctx.register_df("df_lkp_merge_EXP_BK", df_lkp_merge_EXP_BK)
        ...
        df_lkp_merge_FILTRANS_MSTR = lib.dynamic_lookup(
            ...
            _lkp_input,
            df_DLKP_SSA_MSTR,
            {'name': 'DLKP_SSA_MSTR', 'join_predicates': [{'source_col': 'IN_SURROGATE_KEY', 'lookup_col': 'SURROGATE_KEY'}], 'output_columns': ['SURROGATE_KEY', 'DUMMY'], 'lookup_output_fields': [{'name': 'SURROGATE_KEY', 'ref_field': 'PCHS_STL_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'}, {'name': 'DUMMY', 'ref_field': 'v_NULL', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'}], 'new_lookup_row_col': 'NewLookupRow', 'sequence_config': None, 'insert_else_update': False, 'update_else_insert': False, 'update_condition': 'TRUE', 'output_old_value_on_update': False, 'case_sensitive_string_comparison': False, 'lookup_policy': 'Report Error', 'order_by_columns': []},
            config=config,
        )
