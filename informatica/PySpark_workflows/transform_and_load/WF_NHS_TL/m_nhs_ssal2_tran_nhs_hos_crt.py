...
SELECT NHS_HOS_CRT.HSE_DSTR_KEY FROM NHS_HOS_CRT"""
        ...
        for _old, _new in __expr_renames:
            df_MPLT_AGMT_NHS_HSE_DSTR_rename_EXP_DUMMY = df_MPLT_AGMT_NHS_HSE_DSTR_rename_EXP_DUMMY.drop(_new).withColumnRenamed(_old, _new)
        ...
        for _old, _new in __expr_renames:
            df_MPLT_AGMT_NHS_HSE_DSTR_rename_EXP_OUTPUT = df_MPLT_AGMT_NHS_HSE_DSTR_rename_EXP_OUTPUT.drop(_new).withColumnRenamed(_old, _new)
