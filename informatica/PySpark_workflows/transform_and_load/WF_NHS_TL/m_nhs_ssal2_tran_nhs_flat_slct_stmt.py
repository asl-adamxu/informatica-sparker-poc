...
FROM NHS_FLAT_SLCT_STMT"""
        ...
        # Alias-based join: _main.<source_col> == _lkp.<lookup_col>
        df_lkp_merge_MPLT_AGMT_NHS_FLAT_SLCT = _lkp_input.alias("_main").join(
        ...
        if (_nlr_key.lower() not in [x.lower() for x in _lkp_input.columns]
            ...
            _nlr_lkp_cols.insert(0, _nlr_key)
        if _nlr_lkp_cols:
            df_lkp_merge_MPLT_AGMT_NHS_FLAT_SLCT = df_lkp_merge_MPLT_AGMT_NHS_FLAT_SLCT.withColumn("NewLookupRow", expr("CASE WHEN `" + _nlr_lkp_cols[0] + "` IS NULL THEN 0 ELSE 1 END"))
        else:
            df_lkp_merge_MPLT_AGMT_NHS_FLAT_SLCT = df_lkp_merge_MPLT_AGMT_NHS_FLAT_SLCT.withColumn("NewLookupRow", lit(1))
