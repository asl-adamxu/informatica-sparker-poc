...
FROM NHS_REF_CODE_TYPE"""
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_MSTR',
            join_predicates=[{'source_col': 'IN_NHS_REF_CODE_TYPE_CODE', 'lookup_col': 'NHS_REF_CODE_TYPE_CODE'}],
            ...
            lookup_output_fields=[
                ...
                {'name': 'NHS_REF_CODE_TYPE_CODE', 'ref_field': 'REF_CODE_TYPE_CODE', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'string'}
            ],
...
where SOR_NHS_REF_CODE_TYPE_STS.REF_CODE_TYPE_KEY = ss.REF_CODE_TYPE_KEY and SOR_NHS_REF_CODE_TYPE_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_NHS_REF_CODE_TYPE_STS.REF_CODE_TYPE_KEY  """
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_STS',
            join_predicates=[{'source_col': 'IN_REF_CODE_TYPE_KEY', 'lookup_col': 'REF_CODE_TYPE_KEY'}],
            output_columns=['REF_CODE_TYPE_KEY', 'BGN_DATE', 'END_DATE', 'REF_CODE_TYPE_DESP', 'ROW_VER_NUM'],
            lookup_output_fields=[
                {'name': 'REF_CODE_TYPE_KEY', 'ref_field': 'REF_CODE_TYPE_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
                ...
                {'name': 'REF_CODE_TYPE_DESP', 'ref_field': 'REF_CODE_TYPE_DESP', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
