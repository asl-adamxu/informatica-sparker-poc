...
FROM NHS_REF_CODE_TYPE"""
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            _lkp_input,
            df_DLKP_SOR_MSTR,
            {'name': 'DLKP_SOR_MSTR', 'join_predicates': [{'source_col': 'IN_NHS_REF_CODE_TYPE_CODE', 'lookup_col': 'NHS_REF_CODE_TYPE_CODE'}], 'output_columns': ['REF_CODE_TYPE_KEY', 'NHS_REF_CODE_TYPE_CODE'], 'lookup_output_fields': [{'name': 'REF_CODE_TYPE_KEY', 'ref_field': 'Sequence-Id', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'integer'}, {'name': 'NHS_REF_CODE_TYPE_CODE', 'ref_field': 'REF_CODE_TYPE_CODE', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'string'}], 'new_lookup_row_col': 'NewLookupRow', 'sequence_config': {'output_col': 'REF_CODE_TYPE_KEY'}, 'insert_else_update': True, 'update_else_insert': False, 'update_condition': 'TRUE', 'output_old_value_on_update': False, 'case_sensitive_string_comparison': False, 'lookup_policy': 'Report Error', 'order_by_columns': []},
            config=config,
        )
...
where SOR_NHS_REF_CODE_TYPE_STS.REF_CODE_TYPE_KEY = ss.REF_CODE_TYPE_KEY and SOR_NHS_REF_CODE_TYPE_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_NHS_REF_CODE_TYPE_STS.REF_CODE_TYPE_KEY  """
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            _lkp_input,
            df_DLKP_SOR_STS,
            {'name': 'DLKP_SOR_STS', 'join_predicates': [{'source_col': 'IN_REF_CODE_TYPE_KEY', 'lookup_col': 'REF_CODE_TYPE_KEY'}], 'output_columns': ['REF_CODE_TYPE_KEY', 'BGN_DATE', 'END_DATE', 'REF_CODE_TYPE_DESP', 'ROW_VER_NUM'], 'lookup_output_fields': [{'name': 'REF_CODE_TYPE_KEY', 'ref_field': 'REF_CODE_TYPE_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'}, {'name': 'BGN_DATE', 'ref_field': 'DUMMY_DATE', 'ignore_in_compare': True, 'ignore_null_inputs': True, 'datatype': 'date/time'}, {'name': 'END_DATE', 'ref_field': 'DUMMY_DATE', 'ignore_in_compare': True, 'ignore_null_inputs': True, 'datatype': 'date/time'}, {'name': 'REF_CODE_TYPE_DESP', 'ref_field': 'REF_CODE_TYPE_DESP', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'}, {'name': 'ROW_VER_NUM', 'ref_field': 'ROW_VER_NUM', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'}], 'new_lookup_row_col': 'NewLookupRow', 'sequence_config': None, 'insert_else_update': True, 'update_else_insert': False, 'update_condition': 'TRUE', 'output_old_value_on_update': False, 'case_sensitive_string_comparison': False, 'lookup_policy': 'Report Error', 'order_by_columns': []},
            config=config,
        )
        ctx.register_df("df_lkp_merge_EXP_BK", df_lkp_merge_EXP_BK)
