...
FROM NHS_FLAT_SLCT_QUE"""
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            _lkp_input,
            df_DLKP_SOR_MSTR,
            {'name': 'DLKP_SOR_MSTR', 'join_predicates': [{'source_col': 'IN_NHS_FLAT_SLCT_QUE_KEY', 'lookup_col': 'NHS_FLAT_SLCT_QUE_KEY'}], 'output_columns': ['FLAT_SLCT_QUE_KEY', 'NHS_FLAT_SLCT_QUE_KEY'], 'lookup_output_fields': [{'name': 'FLAT_SLCT_QUE_KEY', 'ref_field': 'Sequence-Id', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'integer'}, {'name': 'NHS_FLAT_SLCT_QUE_KEY', 'ref_field': 'FLAT_SLCT_QUE_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'decimal'}], 'new_lookup_row_col': 'NewLookupRow', 'sequence_config': {'output_col': 'FLAT_SLCT_QUE_KEY'}, 'insert_else_update': True, 'update_else_insert': False, 'update_condition': 'TRUE', 'output_old_value_on_update': False, 'case_sensitive_string_comparison': False, 'lookup_policy': 'Report Error', 'order_by_columns': []},
            config=config,
        )
        ...
        df_mplt_lkp_chain_MPLT_AGMT_NHS_PHASE_EXP_NULL_BKEY = lib.dynamic_lookup(
            spark,
            _lkp_input,
            df_MPLT_AGMT_NHS_PHASE_LKP_DYN_SOR_NHS_PHASE,
            {'name': 'MPLT_AGMT_NHS_PHASE_LKP_DYN_SOR_NHS_PHASE', 'join_predicates': [{'source_col': 'OUT_NHS_PHASE_CODE', 'lookup_col': 'NHS_PHASE_CODE'}], 'output_columns': ['PHASE_KEY', 'NHS_PHASE_CODE'], 'lookup_output_fields': [{'name': 'PHASE_KEY', 'ref_field': 'Sequence-Id', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'integer'}, {'name': 'NHS_PHASE_CODE', 'ref_field': 'OUT_NHS_PHASE_CODE', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'string'}], 'new_lookup_row_col': 'NewLookupRow_LKP_DYN_SOR_NHS_PHASE', 'sequence_config': {'output_col': 'PHASE_KEY'}, 'insert_else_update': True, 'update_else_insert': False, 'update_condition': 'TRUE', 'output_old_value_on_update': False, 'case_sensitive_string_comparison': False, 'lookup_policy': 'Report Error', 'order_by_columns': []},
            config=config,
        )
        ...
        df_mplt_lkp_chain_MPLT_AGMT_NHS_PHASE_EXP_DUMMY = lib.dynamic_lookup(
            spark,
            _lkp_input,
            df_MPLT_AGMT_NHS_PHASE_LKP_DYN_SSA_NHS_PHASE,
            {'name': 'MPLT_AGMT_NHS_PHASE_LKP_DYN_SSA_NHS_PHASE', 'join_predicates': [{'source_col': 'PHASE_KEY', 'lookup_col': 'SURROGATE_KEY'}], 'output_columns': ['SURROGATE_KEY', 'DUMMY'], 'lookup_output_fields': [{'name': 'SURROGATE_KEY', 'ref_field': 'PHASE_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'}, {'name': 'DUMMY', 'ref_field': 'DUMMY', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'}], 'new_lookup_row_col': 'NewLookupRow_LKP_DYN_SSA_NHS_PHASE', 'sequence_config': None, 'insert_else_update': False, 'update_else_insert': False, 'update_condition': 'TRUE', 'output_old_value_on_update': False, 'case_sensitive_string_comparison': False, 'lookup_policy': 'Report Error', 'order_by_columns': []},
            config=config,
        )
...
where SOR_NHS_FLAT_SLCT_QUE_STS.FLAT_SLCT_QUE_KEY = ss.FLAT_SLCT_QUE_KEY and SOR_NHS_FLAT_SLCT_QUE_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_NHS_FLAT_SLCT_QUE_STS.FLAT_SLCT_QUE_KEY  """
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            _lkp_input,
            df_DLKP_SOR_STS,
            {'name': 'DLKP_SOR_STS', 'join_predicates': [{'source_col': 'IN_FLAT_SLCT_QUE_KEY', 'lookup_col': 'FLAT_SLCT_QUE_KEY'}], 'output_columns': ['FLAT_SLCT_QUE_KEY', 'BGN_DATE', 'END_DATE', 'MBR_OWNR_RGSTR_TIME', 'CUR_PRIOR_NUM', 'HOS_APLY_KEY', 'PHASE_KEY', 'FLAT_SLCT_SSN_KEY', 'APLY_1D_BRCD_NUM', 'ROW_VER_NUM', 'PRIOR_CATG_GRP_CODE', 'FLAT_SLCT_ORD_NUM', 'EFAS_PRIOR_NUM_SFX_NUM'], 'lookup_output_fields': [{'name': 'FLAT_SLCT_QUE_KEY', 'ref_field': 'FLAT_SLCT_QUE_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'}, {'name': 'BGN_DATE', 'ref_field': 'DUMMY_DATE', 'ignore_in_compare': True, 'ignore_null_inputs': True, 'datatype': 'date/time'}, {'name': 'END_DATE', 'ref_field': 'DUMMY_DATE', 'ignore_in_compare': True, 'ignore_null_inputs': True, 'datatype': 'date/time'}, {'name': 'MBR_OWNR_RGSTR_TIME', 'ref_field': 'MBR_OWNR_RGSTR_TIME', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'date/time'}, {'name': 'CUR_PRIOR_NUM', 'ref_field': 'CUR_PRIOR_NUM', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'}, {'name': 'HOS_APLY_KEY', 'ref_field': 'HOS_APLY_KEY', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'}, {'name': 'PHASE_KEY', 'ref_field': 'PHASE_KEY', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'}, {'name': 'FLAT_SLCT_SSN_KEY', 'ref_field': 'FLAT_SLCT_SSN_KEY', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'}, {'name': 'APLY_1D_BRCD_NUM', 'ref_field': 'APLY_1D_BRCD_NUM', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'}, {'name': 'ROW_VER_NUM', 'ref_field': 'ROW_VER_NUM', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'}, {'name': 'PRIOR_CATG_GRP_CODE', 'ref_field': 'PRIOR_CATG_GRP_CODE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'}, {'name': 'FLAT_SLCT_ORD_NUM', 'ref_field': 'FLAT_SLCT_ORD_NUM', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'decimal'}, {'name': 'EFAS_PRIOR_NUM_SFX_NUM', 'ref_field': 'EFAS_PRIOR_NUM_SFX_NUM', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'}], 'new_lookup_row_col': 'NewLookupRow', 'sequence_config': None, 'insert_else_update': True, 'update_else_insert': False, 'update_condition': 'TRUE', 'output_old_value_on_update': False, 'case_sensitive_string_comparison': False, 'lookup_policy': 'Report Error', 'order_by_columns': []},
            config=config,
        )
        ctx.register_df("df_lkp_merge_EXP_BK", df_lkp_merge_EXP_BK)
        ...
        df_lkp_merge_FILTRANS_MSTR = lib.dynamic_lookup(
            ...
            _lkp_input,
            df_DLKP_SSA_MSTR,
            {'name': 'DLKP_SSA_MSTR', 'join_predicates': [{'source_col': 'IN_SURROGATE_KEY', 'lookup_col': 'SURROGATE_KEY'}], 'output_columns': ['SURROGATE_KEY', 'DUMMY'], 'lookup_output_fields': [{'name': 'SURROGATE_KEY', 'ref_field': 'FLAT_SLCT_QUE_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'}, {'name': 'DUMMY', 'ref_field': 'v_NULL', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'}], 'new_lookup_row_col': 'NewLookupRow', 'sequence_config': None, 'insert_else_update': False, 'update_else_insert': False, 'update_condition': 'TRUE', 'output_old_value_on_update': False, 'case_sensitive_string_comparison': False, 'lookup_policy': 'Report Error', 'order_by_columns': []},
            config=config,
        )
