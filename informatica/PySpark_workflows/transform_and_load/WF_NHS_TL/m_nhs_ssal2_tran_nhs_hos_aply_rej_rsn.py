...
and exists (select 1 from nhs_hos_aply_rej_rsn)"""
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_MSTR',
            join_predicates=[{'source_col': 'IN_HOS_APLY_KEY', 'lookup_col': 'HOS_APLY_KEY'}, {'source_col': 'IN_NHS_REJ_RSN_SEQ_NUM', 'lookup_col': 'NHS_REJ_RSN_SEQ_NUM'}],
            output_columns=['HOS_APLY_REJ_RSN_KEY', 'HOS_APLY_KEY', 'NHS_REJ_RSN_SEQ_NUM'],
            lookup_output_fields=[
                {'name': 'HOS_APLY_REJ_RSN_KEY', 'ref_field': 'Sequence-Id', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'integer'},
                {'name': 'HOS_APLY_KEY', 'ref_field': 'HOS_APLY_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'decimal'},
                {'name': 'NHS_REJ_RSN_SEQ_NUM', 'ref_field': 'REJ_RSN_SEQ_NUM', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'decimal'}
            ],
            new_lookup_row_col='NewLookupRow',
            sequence_config={'output_col': 'HOS_APLY_REJ_RSN_KEY'},
            insert_else_update=True,
            update_else_insert=False,
            update_condition='TRUE',
            output_old_value_on_update=False,
...
where SOR_NHS_HOS_APLY_REJ_RSN_STS.HOS_APLY_REJ_RSN_KEY = ss.HOS_APLY_REJ_RSN_KEY and SOR_NHS_HOS_APLY_REJ_RSN_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_NHS_HOS_APLY_REJ_RSN_STS.HOS_APLY_REJ_RSN_KEY  """
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_STS',
            join_predicates=[{'source_col': 'IN_HOS_APLY_REJ_RSN_KEY', 'lookup_col': 'HOS_APLY_REJ_RSN_KEY'}],
            output_columns=['HOS_APLY_REJ_RSN_KEY', 'BGN_DATE', 'END_DATE', 'REJ_RSN_DESP', 'APLY_STS_CODE', 'ROW_VER_NUM'],
            lookup_output_fields=[
                {'name': 'HOS_APLY_REJ_RSN_KEY', 'ref_field': 'HOS_APLY_REJ_RSN_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
                ...
                {'name': 'REJ_RSN_DESP', 'ref_field': 'REJ_RSN_DESP', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
        ...
        df_lkp_merge_FILTRANS_MSTR = lib.dynamic_lookup(
            ...
            output_columns=['SURROGATE_KEY', 'DUMMY'],
            lookup_output_fields=[
                {'name': 'SURROGATE_KEY', 'ref_field': 'HOS_APLY_REJ_RSN_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
