...
FROM NHS_HOS_APLY_REJ_RSN"""
        ...
        df_SQ_NHS_HOS_APLY_REJ_RSN = lib.sq_output(
            input_df=df_SQ_NHS_HOS_APLY_REJ_RSN,
            port_cols={
...
and exists (select 1 from nhs_hos_aply_rej_rsn)"""
        ...
        df_SQ_NHS_HOS_APLY_REJ_RSN_END = lib.sq_output(
            input_df=df_SQ_NHS_HOS_APLY_REJ_RSN_END,
            port_cols={
                'HOS_APLY_REJ_RSN_KEY': 'decimal',
                'BGN_DATE': 'date/time',
            },
        )
        ...
        df_EXP_SSAL2_TRANS_END = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'SURROGATE_KEY', 'expr': 'HOS_APLY_REJ_RSN_KEY'},
 ...
 ORDER BY SOR_NHS_HOS_APLY_REJ_RSN_STS.HOS_APLY_REJ_RSN_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_NHS_HOS_APLY_REJ_RSN'"},
        ...
        lib.write_target(
            ...
            delete_keys=['hos_aply_rej_rsn_key', 'hos_aply_key', 'nhs_rej_rsn_seq_num', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
