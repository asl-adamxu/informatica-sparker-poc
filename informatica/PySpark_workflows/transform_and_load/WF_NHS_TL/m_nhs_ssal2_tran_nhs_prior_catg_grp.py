...
FROM
 NHS_PRIOR_CATG_GRP"""
        ...
        df_SQ_NHS_PRIOR_CATG_GRP = lib.sq_output(
            input_df=df_SQ_NHS_PRIOR_CATG_GRP,
            port_cols={
                'PHASE_CODE': 'string',
 ...
 ORDER BY SOR_NHS_PRIOR_CATG_GRP_STS.PRIOR_CATG_GRP_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_NHS_PRIOR_CATG_GRP'"},
        ...
        lib.write_target(
            ...
            delete_keys=['prior_catg_grp_key', 'nhs_phase_code', 'nhs_prior_catg_code', 'nhs_prior_catg_grp_code', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
        ...
        lib.write_target(
            ...
            delete_keys=['prior_catg_grp_key', 'bgn_date', 'end_date', 'row_ver_num', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date', 'prior_catg_gf_elgbl_ind'],
            has_update_flag=True,
            config=config,
        )
