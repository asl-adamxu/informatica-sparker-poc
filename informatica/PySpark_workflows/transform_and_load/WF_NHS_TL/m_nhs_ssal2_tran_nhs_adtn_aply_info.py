...
FROM NHS_ADTN_APLY_INFO"""
        ...
        if _cc:
            ...
            df_merge_LKP_DYN_SOR_NHS_ADTN_APLY_INFO_0 = df_EXP_BK.join(
                __rhs,
                on=_cc, how="left"
            )
        else:
            ...
            __rhs = __rhs.select(*[col(c).alias(c) for c in __rhs.columns])
            df_merge_LKP_DYN_SOR_NHS_ADTN_APLY_INFO_0 = df_EXP_BK.withColumn("_join_key", lit(1)).join(
                __rhs,
                on="_join_key", how="left").drop("_join_key")
        ctx.register_df("df_merge_LKP_DYN_SOR_NHS_ADTN_APLY_INFO_0", df_merge_LKP_DYN_SOR_NHS_ADTN_APLY_INFO_0)
        ...
        # Rename upstream columns to match lookup input port names before join
        _lkp_input = df_merge_LKP_DYN_SOR_NHS_ADTN_APLY_INFO_0
