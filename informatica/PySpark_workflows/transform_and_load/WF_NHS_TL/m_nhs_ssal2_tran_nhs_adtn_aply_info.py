...
FROM NHS_ADTN_APLY_INFO"""
        ...
        df_SQ_NHS_ADTN_APLY_INFO = lib.sq_output(
            input_df=df_SQ_NHS_ADTN_APLY_INFO,
            port_cols={
 ...
 ORDER BY SOR_NHS_ADTN_APLY_INFO_STS.ADTN_APLY_INFO_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_NHS_ADTN_APLY_INFO'"},
        ...
        lib.write_target(
            ...
            delete_keys=['adtn_aply_info_key', 'hos_aply_key', 'nhs_adtn_aply_info_attr_name', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
