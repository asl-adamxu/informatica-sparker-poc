...
FROM NHS_APLY_VET_RSLT"""
        ...
        df_SQ_NHS_APLY_VET_RSLT = lib.sq_output(
            input_df=df_SQ_NHS_APLY_VET_RSLT,
            port_cols={
 ...
 ORDER BY SOR_NHS_APLY_VET_RSLT_STS.APLY_VET_RSLT_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_NHS_APLY_VET_RSLT'"},
        ...
        lib.write_target(
            ...
            delete_keys=['aply_vet_rslt_key', 'hos_aply_key', 'nhs_aply_vet_seq_num', 'nhs_aply_vet_stg_code', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
