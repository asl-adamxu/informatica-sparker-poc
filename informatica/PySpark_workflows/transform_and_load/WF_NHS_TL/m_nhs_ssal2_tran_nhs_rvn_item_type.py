...
FROM NHS_RVN_ITEM_TYPE"""
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_MSTR',
            join_predicates=[{'source_col': 'IN_NHS_CLCT_ITEM_TYPE_CODE', 'lookup_col': 'NHS_CLCT_ITEM_TYPE_CODE'}],
            ...
            lookup_output_fields=[
                ...
                {'name': 'NHS_CLCT_ITEM_TYPE_CODE', 'ref_field': 'CLCT_ITEM_TYPE_CODE', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'string'}
            ],
...
where SOR_NHS_RVN_ITEM_TYPE_STS.RVN_ITEM_TYPE_KEY = ss.RVN_ITEM_TYPE_KEY and SOR_NHS_RVN_ITEM_TYPE_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_NHS_RVN_ITEM_TYPE_STS.RVN_ITEM_TYPE_KEY  """
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_STS',
            join_predicates=[{'source_col': 'IN_RVN_ITEM_TYPE_KEY', 'lookup_col': 'RVN_ITEM_TYPE_KEY'}],
            output_columns=['RVN_ITEM_TYPE_KEY', 'BGN_DATE', 'END_DATE', 'CLCT_ITEM_ENG_DESP', 'CLCT_ITEM_CHI_DESP', 'CLCT_ITEM_ACCT_SBHD_CODE', 'CLCT_ITEM_ACCT_DTL_CODE', 'ROW_VER_NUM'],
            lookup_output_fields=[
                {'name': 'RVN_ITEM_TYPE_KEY', 'ref_field': 'RVN_ITEM_TYPE_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
                ...
                {'name': 'CLCT_ITEM_ENG_DESP', 'ref_field': 'CLCT_ITEM_ENG_DESP', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'CLCT_ITEM_CHI_DESP', 'ref_field': 'CLCT_ITEM_CHI_DESP', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'CLCT_ITEM_ACCT_SBHD_CODE', 'ref_field': 'CLCT_ITEM_ACCT_SBHD_CODE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
                {'name': 'CLCT_ITEM_ACCT_DTL_CODE', 'ref_field': 'CLCT_ITEM_ACCT_DTL_CODE', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'string'},
