...
FROM NHS_RVN_ITEM_TYPE"""
        ...
        df_SQ_NHS_RVN_ITEM_TYPE = lib.sq_output(
            input_df=df_SQ_NHS_RVN_ITEM_TYPE,
            port_cols={
                'CLCT_ITEM_TYPE_CODE': 'string',
                'CLCT_ITEM_ENG_DESP': 'string',
                'CLCT_ITEM_CHI_DESP': 'string',
                'CLCT_ITEM_ACCT_SBHD_CODE': 'string',
                'CLCT_ITEM_ACCT_DTL_CODE': 'string',
                'ROW_VER_NUM': 'decimal',
 ...
 ORDER BY SOR_NHS_RVN_ITEM_TYPE_STS.RVN_ITEM_TYPE_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_NHS_RVN_ITEM_TYPE'"},
        ...
        lib.write_target(
            ...
            delete_keys=['rvn_item_type_key', 'nhs_clct_item_type_code', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
