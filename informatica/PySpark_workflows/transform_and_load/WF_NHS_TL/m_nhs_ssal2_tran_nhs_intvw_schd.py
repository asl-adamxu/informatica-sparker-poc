...
FROM NHS_INTVW_SCHD"""
        ...
        df_SQ_NHS_INTVW_SCHD = lib.sq_output(
            input_df=df_SQ_NHS_INTVW_SCHD,
            port_cols={
                'PHASE_CODE': 'string',
 ...
 ORDER BY SOR_NHS_INTVW_SCHD_STS.INTVW_SCHD_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_NHS_INTVW_SCHD'"},
        ...
        lib.write_target(
            ...
            delete_keys=['intvw_schd_key', 'phase_key', 'nhs_intvw_schd_date', 'nhs_intvw_schd_bgn_time', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
        ...
        lib.write_target(
            ...
            delete_keys=['intvw_schd_key', 'bgn_date', 'end_date', 'intvw_schd_end_time', 'intvw_schd_aply_max_num', 'intvw_schd_aply_alct_num', 'row_ver_num', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
            has_update_flag=True,
            config=config,
        )
