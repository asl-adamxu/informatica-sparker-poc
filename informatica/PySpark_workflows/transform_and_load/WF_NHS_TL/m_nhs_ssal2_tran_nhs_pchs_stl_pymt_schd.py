...
FROM NHS_PCHS_STL_PYMT_SCHD"""
        ...
        df_SQ_NHS_PCHS_STL_PYMT_SCHD = lib.sq_output(
            input_df=df_SQ_NHS_PCHS_STL_PYMT_SCHD,
            port_cols={
                'PCHS_STL_KEY': 'decimal',
                'PCHS_TXN_CMPLT_NOTE_DATE': 'date/time',
                'PCHS_STL_FRST_PYMT_DATE': 'date/time',
                'PCHS_STL_LAST_PYMT_DATE': 'date/time',
                'PCHS_STL_PYMT_SCHD_RMK_TEXT': 'string',
                'ROW_VER_NUM': 'decimal',
        ...
        df_MPLT_AGMT_NHS_PCHS_STL_input = lib.expression(
            input_df=df_EXP_BK,
            computed_columns=[
                {'name': 'IN_NHS_PCHS_STL_KEY', 'expr': 'PCHS_STL_KEY'}
            ],
        )
        ...
        df_MPLT_AGMT_NHS_PCHS_STL_EXP_NULL_BKEY = lib.expression(
            input_df=df_MPLT_AGMT_NHS_PCHS_STL_input,
            computed_columns=[
                {'name': 'OUT_NHS_PCHS_STL_KEY', 'expr': 'IN_NHS_PCHS_STL_KEY'}
            ],
        )
        ...
        df_MPLT_AGMT_NHS_PCHS_STL_rename_EXP_DUMMY = lib.expression(
            input_df=df_mplt_lkp_chain_MPLT_AGMT_NHS_PCHS_STL_EXP_NULL_BKEY,
            rename_columns=[
        ...
        df_MPLT_AGMT_NHS_PCHS_STL_EXP_DUMMY = lib.expression(
            input_df=df_MPLT_AGMT_NHS_PCHS_STL_rename_EXP_DUMMY,
            computed_columns=[
        ...
        df_MPLT_AGMT_NHS_PCHS_STL_rename_EXP_OUTPUT = lib.expression(
            input_df=df_mplt_lkp_chain_MPLT_AGMT_NHS_PCHS_STL_EXP_DUMMY,
            rename_columns=[
        ...
        df_MPLT_AGMT_NHS_PCHS_STL_EXP_OUTPUT = lib.expression(
            input_df=df_MPLT_AGMT_NHS_PCHS_STL_rename_EXP_OUTPUT,
            computed_columns=[
        ...
        df_MPLT_AGMT_NHS_PCHS_STL = lib.expression(
            input_df=df_MPLT_AGMT_NHS_PCHS_STL_EXP_OUTPUT,
            pass_through_cols=['SOR_CACHE_STATUS', 'SSA_CACHE_STATUS', 'V_AUG_IND', 'OPR_IND', 'LAST_REC_TXN_TYPE_CODE', 'LAST_REC_TXN_DATE', 'PCHS_STL_KEY', 'NHS_PCHS_STL_KEY'],
        )
        ...
        df_FILTRANS_NHS_PCHS_STL = lib.filter(
            input_df=df_MPLT_AGMT_NHS_PCHS_STL,
...
where SOR_NHS_PCHS_STL_PYMT_SCHD_STS.PCHS_STL_PYMT_SCHD_KEY = ss.PCHS_STL_PYMT_SCHD_KEY and SOR_NHS_PCHS_STL_PYMT_SCHD_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_NHS_PCHS_STL_PYMT_SCHD_STS.PCHS_STL_PYMT_SCHD_KEY  """
        ...
        df_FILTRANS_MSTR = lib.filter(
            input_df=df_lkp_merge_MPLT_AGMT_NHS_PCHS_STL,
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_NHS_PCHS_STL_PYMT_SCHD'"},
        ...
        lib.write_target(
            ...
            mode='append',
            source_columns=[
                'PCHS_STL_PYMT_SCHD_KEY',
                'OUT_V_BGN_DATE',
                'OUT_V_END_DATE',
                'PCHS_TXN_CMPLT_NOTE_DATE',
                'PCHS_STL_FRST_PYMT_DATE',
                'PCHS_STL_LAST_PYMT_DATE',
                'PCHS_STL_PYMT_SCHD_RMK_TEXT',
                'MANU_UPD_IND',
                'ROW_VER_NUM',
            ...
            delete_keys=['pchs_stl_pymt_schd_key', 'bgn_date', 'end_date', 'pchs_txn_cmplt_note_date', 'pchs_stl_frst_pymt_date', 'pchs_stl_last_pymt_date', 'pchs_stl_pymt_schd_rmk_text', 'manu_upd_ind', 'row_ver_num', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
        ...
        lib.write_target(
            ...
            delete_keys=['pchs_stl_pymt_schd_key', 'pchs_stl_key', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
            has_update_flag=True,
            config=config,
        )
