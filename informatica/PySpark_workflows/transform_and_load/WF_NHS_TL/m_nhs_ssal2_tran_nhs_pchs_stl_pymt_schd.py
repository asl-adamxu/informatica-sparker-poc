...
FROM NHS_PCHS_STL_PYMT_SCHD"""
        ...
        __expr_renames = [
            ("NewLookupRow_LKP_DYN_SOR_NHS_PCHS_STL", "NewLookupRow"),
        ]
        for _old, _new in __expr_renames:
            df_MPLT_AGMT_NHS_PCHS_STL_rename_EXP_DUMMY = df_MPLT_AGMT_NHS_PCHS_STL_rename_EXP_DUMMY.drop(_new).withColumnRenamed(_old, _new)
        ...
        __expr_renames = [
            ...
            ("NewLookupRow_LKP_DYN_SSA_NHS_PCHS_STL", "SSA_CACHE_STATUS"),
        ]
        for _old, _new in __expr_renames:
            df_MPLT_AGMT_NHS_PCHS_STL_rename_EXP_OUTPUT = df_MPLT_AGMT_NHS_PCHS_STL_rename_EXP_OUTPUT.drop(_new).withColumnRenamed(_old, _new)
