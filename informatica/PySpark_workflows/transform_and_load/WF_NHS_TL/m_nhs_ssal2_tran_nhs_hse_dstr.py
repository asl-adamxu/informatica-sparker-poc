...
FROM NHS_HSE_DSTR"""
        ...
        df_SQ_NHS_HSE_DSTR = lib.sq_output(
            input_df=df_SQ_NHS_HSE_DSTR,
            port_cols={
                'HSE_DSTR_KEY': 'string',
                'HSE_RGN_KEY': 'string',
                'HSE_DSTR_CODE': 'string',
                'HSE_DSTR_ENG_NAME': 'string',
        ...
        df_MPLT_AGMT_NHS_HSE_RGN_input = lib.expression(
            input_df=df_lkp_merge_EXP_BK,
            computed_columns=[
                {'name': 'IN_NHS_HSE_RGN_KEY', 'expr': 'HSE_RGN_KEY'}
            ],
        )
        ...
        df_MPLT_AGMT_NHS_HSE_RGN_EXP_NULL_BKEY = lib.expression(
            input_df=df_MPLT_AGMT_NHS_HSE_RGN_input,
            computed_columns=[
                {'name': 'OUT_NHS_HSE_RGN_KEY', 'expr': 'IN_NHS_HSE_RGN_KEY'}
            ],
        )
        ...
        df_MPLT_AGMT_NHS_HSE_RGN_rename_EXP_DUMMY = lib.expression(
            input_df=df_mplt_lkp_chain_MPLT_AGMT_NHS_HSE_RGN_EXP_NULL_BKEY,
            rename_columns=[
        ...
        df_MPLT_AGMT_NHS_HSE_RGN_EXP_DUMMY = lib.expression(
            input_df=df_MPLT_AGMT_NHS_HSE_RGN_rename_EXP_DUMMY,
            computed_columns=[
        ...
        df_MPLT_AGMT_NHS_HSE_RGN_rename_EXP_OUTPUT = lib.expression(
            input_df=df_mplt_lkp_chain_MPLT_AGMT_NHS_HSE_RGN_EXP_DUMMY,
            rename_columns=[
        ...
        df_MPLT_AGMT_NHS_HSE_RGN_EXP_OUTPUT = lib.expression(
            input_df=df_MPLT_AGMT_NHS_HSE_RGN_rename_EXP_OUTPUT,
            computed_columns=[
        ...
        df_MPLT_AGMT_NHS_HSE_RGN = lib.expression(
            input_df=df_MPLT_AGMT_NHS_HSE_RGN_EXP_OUTPUT,
            pass_through_cols=['SOR_CACHE_STATUS', 'SSA_CACHE_STATUS', 'V_AUG_IND', 'OPR_IND', 'LAST_REC_TXN_TYPE_CODE', 'LAST_REC_TXN_DATE', 'HSE_RGN_KEY', 'NHS_HSE_RGN_KEY'],
        )
...
where SOR_NHS_HSE_DSTR_STS.HSE_DSTR_KEY = ss.HSE_DSTR_KEY and SOR_NHS_HSE_DSTR_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_NHS_HSE_DSTR_STS.HSE_DSTR_KEY  """
        ...
        df_FILTRANS_NHS_HSE_RGN = lib.filter(
            input_df=df_MPLT_AGMT_NHS_HSE_RGN,
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_NHS_HSE_DSTR'"},
        ...
        lib.write_target(
            ...
            delete_keys=['hse_dstr_key', 'nhs_hse_dstr_key', 'agmt_ind', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
