...
SELECT NHS_EST_BANK.EST_BANK_TXN_CNCL_TRML_ID FROM NHS_EST_BANK"""
        ...
        for _old, _new in __expr_renames:
            df_MPLT_AGMT_NHS_RVN_CLCT_OFFC_rename_EXP_DUMMY = df_MPLT_AGMT_NHS_RVN_CLCT_OFFC_rename_EXP_DUMMY.drop(_new).withColumnRenamed(_old, _new)
        ...
        for _old, _new in __expr_renames:
            df_MPLT_AGMT_NHS_RVN_CLCT_OFFC_rename_EXP_OUTPUT = df_MPLT_AGMT_NHS_RVN_CLCT_OFFC_rename_EXP_OUTPUT.drop(_new).withColumnRenamed(_old, _new)
