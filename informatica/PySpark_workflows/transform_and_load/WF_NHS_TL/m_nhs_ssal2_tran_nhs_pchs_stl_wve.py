...
FROM NHS_PCHS_STL_WVE_INTRST"""
        ...
        df_SQ_NHS_PCHS_STL_WVE_INTRST = lib.sq_output(
            input_df=df_SQ_NHS_PCHS_STL_WVE_INTRST,
            port_cols={
 ...
 ORDER BY SOR_NHS_PCHS_STL_WVE_STS.PCHS_STL_WVE_KEY  """
        ...
        df_EXPTRANS_MSTR = lib.expression(
            ...
            computed_columns=[
                ...
                {'name': 'v_SSAL2_TBL_NAME', 'expr': "'SSA_NHS_PCHS_STL_WVE'"},
        ...
        lib.write_target(
            ...
            source_columns=[
                ...
                'OUT_V_END_DATE',
                'ADJ_OVRD_INTRST_AMT',
                'PCHS_STL_WVE_INTRST_RMK_TEXT',
                'PCHS_STL_INTRST_WVE_DATE',
                'ROW_VER_NUM',
                'OUT_V_LAST_REC_TXN_TYPE_CODE',
                'OUT_V_LAST_REC_TXN_DATE',
                'OUT_V_OPR_IND',
            ...
            delete_keys=['pchs_stl_wve_key', 'bgn_date', 'end_date', 'adj_ovrd_intrst_amt', 'pchs_stl_wve_intrst_rmk_text', 'pchs_stl_intrst_wve_date', 'row_ver_num', 'last_rec_txn_type_code', 'last_rec_txn_date', 'opr_ind', 'sor_date'],
            has_update_flag=True,
            config=config,
        )
