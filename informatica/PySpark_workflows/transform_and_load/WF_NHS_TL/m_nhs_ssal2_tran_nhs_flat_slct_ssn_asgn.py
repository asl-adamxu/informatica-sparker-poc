...
FROM
 NHS_FLAT_SLCT_SSN_ASGN"""
        ...
        for _old, _new in __expr_renames:
            df_MPLT_AGMT_NHS_INTVW_SCHD_rename_EXP_DUMMY = df_MPLT_AGMT_NHS_INTVW_SCHD_rename_EXP_DUMMY.drop(_new).withColumnRenamed(_old, _new)
        ...
        for _old, _new in __expr_renames:
            df_MPLT_AGMT_NHS_INTVW_SCHD_rename_EXP_OUTPUT = df_MPLT_AGMT_NHS_INTVW_SCHD_rename_EXP_OUTPUT.drop(_new).withColumnRenamed(_old, _new)
