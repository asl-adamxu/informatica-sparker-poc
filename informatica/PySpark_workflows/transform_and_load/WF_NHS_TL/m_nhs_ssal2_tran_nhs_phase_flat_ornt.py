...
FROM NHS_PHASE_FLAT_ORNT"""
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_MSTR',
            join_predicates=[{'source_col': 'IN_NHS_PHASE_FLAT_ORNT_ID', 'lookup_col': 'NHS_PHASE_FLAT_ORNT_ID'}],
            output_columns=['PHASE_FLAT_ORNT_KEY', 'NHS_PHASE_FLAT_ORNT_ID'],
            lookup_output_fields=[
                {'name': 'PHASE_FLAT_ORNT_KEY', 'ref_field': 'Sequence-Id', 'ignore_in_compare': False, 'ignore_null_inputs': False, 'datatype': 'integer'},
                {'name': 'NHS_PHASE_FLAT_ORNT_ID', 'ref_field': 'PHASE_FLAT_ORNT_ID', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'decimal'}
            ],
            new_lookup_row_col='NewLookupRow',
            sequence_config={'output_col': 'PHASE_FLAT_ORNT_KEY'},
...
where SOR_NHS_PHASE_FLAT_ORNT_STS.PHASE_FLAT_ORNT_KEY = ss.PHASE_FLAT_ORNT_KEY and SOR_NHS_PHASE_FLAT_ORNT_STS.bgn_date = ss.max_bgn_date
 ORDER BY SOR_NHS_PHASE_FLAT_ORNT_STS.PHASE_FLAT_ORNT_KEY  """
        ...
        df_lkp_merge_EXP_BK = lib.dynamic_lookup(
            ...
            name='DLKP_SOR_STS',
            join_predicates=[{'source_col': 'IN_PHASE_FLAT_ORNT_KEY', 'lookup_col': 'PHASE_FLAT_ORNT_KEY'}],
            output_columns=['PHASE_FLAT_ORNT_KEY', 'BGN_DATE', 'END_DATE', 'PHASE_CODE', 'FLAT_NUM', 'ORNT_CODE', 'HOS_BLK_KEY', 'ROW_VER_NUM'],
            lookup_output_fields=[
                {'name': 'PHASE_FLAT_ORNT_KEY', 'ref_field': 'PHASE_FLAT_ORNT_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
        ...
        df_lkp_merge_FILTRANS_MSTR = lib.dynamic_lookup(
            ...
            output_columns=['SURROGATE_KEY', 'DUMMY'],
            lookup_output_fields=[
                {'name': 'SURROGATE_KEY', 'ref_field': 'PHASE_FLAT_ORNT_KEY', 'ignore_in_compare': True, 'ignore_null_inputs': False, 'datatype': 'integer'},
