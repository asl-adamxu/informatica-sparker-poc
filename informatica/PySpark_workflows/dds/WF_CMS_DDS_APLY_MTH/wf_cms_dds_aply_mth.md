...
flowchart TD
    ...
    n6["S_DPA_SUMMARIZE_FACT_CMS_CASE_SMRY<br/><i>(M_DPA_SUMMARIZE_FACT_CMS_CASE_SMRY)</i>"]
    n7["S_DPA_SUMMARIZE_FACT_CMS_CASE_PRNT_SMRY<br/><i>(M_DPA_SUMMARIZE_FACT_CMS_CASE_PRNT_SMRY)</i>"]
    ...
    n12["S_DDS_APLY_FACT_CMS_CASE_PRNT_SMRY<br/><i>(M_DDS_APLY_FACT_CMS_CASE_PRNT_SMRY)</i>"]
    n13["S_DDS_APLY_FACT_CMS_CASE_SMRY<br/><i>(M_DDS_APLY_FACT_CMS_CASE_SMRY)</i>"]
