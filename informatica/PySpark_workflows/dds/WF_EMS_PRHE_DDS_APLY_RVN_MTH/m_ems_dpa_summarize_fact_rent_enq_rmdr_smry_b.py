...
AND  SOR_EMS_ELP_CUST_RGSTR_STS.CUST_TNT_CODE_BGN_DATE = max_cust_tnt_code.CUST_TNT_CODE_BGN_DATE"""
        ...
        df_lkp_merge_1 = df_EXPTRANS1.alias("_main").join(
            ...
            *[df_LKP_SOR_EMS_ELP_CUST_RGSTR[c] for c in df_LKP_SOR_EMS_ELP_CUST_RGSTR.columns if c not in df_EXPTRANS1.columns]
        )
...
SOR_HSM_UNIT.BLK_KEY = SOR_HSM_BLK.BLK_KEY"""
        ...
        df_lkp_merge_2 = df_lkp_merge_1.alias("_main").join(
            ...
            *[df_LKP_EST_KEY_BY_TNCY_AGRMT_BK[c] for c in df_LKP_EST_KEY_BY_TNCY_AGRMT_BK.columns if c not in df_lkp_merge_1.columns]
        )
...
WHERE add_months(TO_DATE('$$v_rpt_mth'||'01', 'YYYYMMDD'),1)-1 between DDS_HRCHY_EMS_EST.BGN_DATE AND DDS_HRCHY_EMS_EST.END_DATE"""
        ...
        # Alias-based join: _main.<source_col> == _lkp.<lookup_col>
        df_mplt_lkp_chain_14 = df_MPLT_LKP_RENT_ENQ_RMDR_SMRY_KEY_EXPTRANS1.alias("_main").join(
        ...
        # Alias-based join: _main.<source_col> == _lkp.<lookup_col>
        df_mplt_lkp_chain_14 = df_mplt_lkp_chain_14.alias("_main").join(
            ...
            *[df_mplt_lkp_chain_14[c] for c in df_mplt_lkp_chain_14.columns],
            *[df_MPLT_LKP_RENT_ENQ_RMDR_SMRY_KEY_LKP_DDS_DMNS_RENT_ENQ_RMDR_DTL[c] for c in df_MPLT_LKP_RENT_ENQ_RMDR_SMRY_KEY_LKP_DDS_DMNS_RENT_ENQ_RMDR_DTL.columns if c not in df_mplt_lkp_chain_14.columns]
        )
        ...
        df_mplt_lkp_chain_14 = df_mplt_lkp_chain_14.alias("_main").join(
            ...
            *[df_mplt_lkp_chain_14[c] for c in df_mplt_lkp_chain_14.columns],
            *[df_MPLT_LKP_RENT_ENQ_RMDR_SMRY_KEY_LKP_DDS_DMNS_ENQ_CHNL_TYPE[c] for c in df_MPLT_LKP_RENT_ENQ_RMDR_SMRY_KEY_LKP_DDS_DMNS_ENQ_CHNL_TYPE.columns if c not in df_mplt_lkp_chain_14.columns]
        )
