...
SOR_HSM_UNIT.BLK_KEY = SOR_HSM_BLK.BLK_KEY"""
        ...
        df_mplt_rename_13 = df_mplt_input_12
        df_mplt_rename_13 = df_mplt_rename_13.drop("EST_KEY").withColumnRenamed("EST_KEY1", "EST_KEY")
        df_mplt_rename_13 = df_mplt_rename_13.drop("SYS_RPT_YEAR").withColumnRenamed("SYS_RPT_YEAR1", "SYS_RPT_YEAR")
        df_mplt_rename_13 = df_mplt_rename_13.drop("SYS_RPT_MTH").withColumnRenamed("SYS_RPT_MTH1", "SYS_RPT_MTH")
        ctx.register_df("df_mplt_rename_13", df_mplt_rename_13)
        
        logger.info("Step: apply_mplt_EXPTRANS1")
        # Expression: apply_mplt_EXPTRANS1
        df_mplt_EXPTRANS1 = df_mplt_rename_13
...
WHERE add_months(TO_DATE('$$v_rpt_mth'||'01', 'YYYYMMDD'),1)-1 between DDS_HRCHY_EMS_EST.BGN_DATE AND DDS_HRCHY_EMS_EST.END_DATE"""
        ...
        # Resolve connection by alias (supports lookup/source connections dynamically)
        _conn = lib.get_db_config(config, "target")
        df_mplt_lkp_15 = lib.read_sql(spark, _conn, table="DDS_DMNS_RENT_ENQ_RMDR_DTL")
        ...
        df_mplt_rename_17 = df_mplt_LKP_DDS_DMNS_ENQ_CHNL_TYPE
        df_mplt_rename_17 = df_mplt_rename_17.drop("EST_KEY").withColumnRenamed("EST_KEY1", "EST_KEY")
        df_mplt_rename_17 = df_mplt_rename_17.drop("SYS_RPT_YEAR").withColumnRenamed("SYS_RPT_YEAR1", "SYS_RPT_YEAR")
        df_mplt_rename_17 = df_mplt_rename_17.drop("SYS_RPT_MTH").withColumnRenamed("SYS_RPT_MTH1", "SYS_RPT_MTH")
        ctx.register_df("df_mplt_rename_17", df_mplt_rename_17)
        
        logger.info("Step: apply_mplt_EXPTRANS2")
        # Expression: apply_mplt_EXPTRANS2
        df_mplt_EXPTRANS2 = df_mplt_rename_17
