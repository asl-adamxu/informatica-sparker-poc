...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    try:
        ...
        df_SQ_DPA_FACT_TNCY_AND_PLT_SMRY = df_SQ_DPA_FACT_TNCY_AND_PLT_SMRY.select([col(c) if c in df_SQ_DPA_FACT_TNCY_AND_PLT_SMRY.columns else lit(None).alias(c) for c in _port_cols])
