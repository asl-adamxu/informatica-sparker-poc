...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        # Select only SQ output ports (matches Informatica behavior) — missing ports become lit(None)
        _port_cols = ["TIME_DMNS_KEY", "EST_SCD_KEY", "TNCY_SCHM_TYPE_DMNS_KEY", "DSTR_BRD_DSTR_DMNS_KEY", "DSTR_CHC_DSTR_SCD_KEY", "RSDN_LNG_DMNS_KEY", "RENT_FCTR_DMNS_KEY", "HSHLD_MBR_CNT", "HSHLD_MALE_MBR_CNT", "HSHLD_FML_MBR_CNT", "HSHLD_UKWN_GNDR_MBR_CNT", "HSHLD_DSBL_MBR_CNT", "CUST_AGE"]
        df_SQ_DPA_FACT_TNCY_AND_PLT_SMRY = df_SQ_DPA_FACT_TNCY_AND_PLT_SMRY.select([col(c) if c.lower() in [x.lower() for x in df_SQ_DPA_FACT_TNCY_AND_PLT_SMRY.columns] else lit(None).alias(c) for c in _port_cols])
        ...
        df_EXP_SET_DEL_INFO = df_EXP_SET_DEL_INFO.withColumn("TBL_NAME", expr("'DDS_FACT_TNCY_AND_PLT_SMRY'"))
        ...
        df_write = df_SQ_DPA_FACT_TNCY_AND_PLT_SMRY
        # Map source columns to target columns using connector field map (handles name
        # mismatches) — done BEFORE the _update_flag split so UPDATE/DELETE use target
        # column names in batch_update/batch_delete.
        _field_map = {"CUST_AGE": "CUST_AGE", "DSTR_BRD_DSTR_DMNS_KEY": "DSTR_BRD_DSTR_DMNS_KEY", "DSTR_CHC_DSTR_SCD_KEY": "DSTR_CHC_DSTR_SCD_KEY", "EST_SCD_KEY": "EST_SCD_KEY", "HSHLD_DSBL_MBR_CNT": "HSHLD_DSBL_MBR_CNT", "HSHLD_FML_MBR_CNT": "HSHLD_FML_MBR_CNT", "HSHLD_MALE_MBR_CNT": "HSHLD_MALE_MBR_CNT", "HSHLD_MBR_CNT": "HSHLD_MBR_CNT", "HSHLD_UKWN_GNDR_MBR_CNT": "HSHLD_UKWN_GNDR_MBR_CNT", "RENT_FCTR_DMNS_KEY": "RENT_FCTR_DMNS_KEY", "RSDN_LNG_DMNS_KEY": "RSDN_LNG_DMNS_KEY", "TIME_DMNS_KEY": "TIME_DMNS_KEY", "TNCY_SCHM_TYPE_DMNS_KEY": "TNCY_SCHM_TYPE_DMNS_KEY"}
        ...
        lib.write_table(df_write, conn_target, "DDS_FACT_TNCY_AND_PLT_SMRY", mode="append")
