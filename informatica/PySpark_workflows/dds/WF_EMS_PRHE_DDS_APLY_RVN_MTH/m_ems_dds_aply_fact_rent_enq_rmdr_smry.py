...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    try:
        ...
        # Select only SQ output ports (matches Informatica behavior)
        df_SQ_DPA_FACT_RENT_ENQ_RMDR_SMRY = df_SQ_DPA_FACT_RENT_ENQ_RMDR_SMRY.select("RENT_ENQ_RMDR_DTL_KEY", "TIME_DMNS_KEY", "EST_SCD_KEY", "ENQ_CHNL_TYPE_KEY", "RENT_ENQ_RMDR_VAL_NUM")
