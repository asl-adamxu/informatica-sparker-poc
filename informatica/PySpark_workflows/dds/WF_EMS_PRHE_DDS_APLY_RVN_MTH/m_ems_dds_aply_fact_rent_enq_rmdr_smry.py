...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_DPA_FACT_RENT_ENQ_RMDR_SMRY = lib.sq_output(
            input_df=df_SQ_DPA_FACT_RENT_ENQ_RMDR_SMRY,
            port_cols={
                'RENT_ENQ_RMDR_DTL_KEY': 'decimal',
                'TIME_DMNS_KEY': 'decimal',
                'EST_SCD_KEY': 'decimal',
                'ENQ_CHNL_TYPE_KEY': 'decimal',
                'RENT_ENQ_RMDR_VAL_NUM': 'decimal',
            },
        )
        ...
        df_EXP_SET_DEL_INFO = lib.expression(
            input_df=df_SQ_SP_DELETE,
            computed_columns=[
                {'name': 'TBL_NAME', 'expr': "'DDS_FACT_RENT_ENQ_RMDR_SMRY'"},
                {'name': 'RM_FLG', 'expr': "'Y'"},
        ...
        lib.write_target(
            spark=spark,
            df=df_SQ_DPA_FACT_RENT_ENQ_RMDR_SMRY,
            conn=conn_target,
