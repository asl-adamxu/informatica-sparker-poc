'''
* Script - M_EMS_DDS_APLY_FACT_TNCY_AND_HSHLD_SMRY.py
...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    """
    Execute the M_EMS_DDS_APLY_FACT_TNCY_AND_HSHLD_SMRY mapping transformations.
    ...
    logger.info("Start to run mapping M_EMS_DDS_APLY_FACT_TNCY_AND_HSHLD_SMRY")

    config = lib.load_config('env/config.yml')
    objects = config.get('objects', {})

    spark = ctx.spark if ctx else lib.get_spark_session("M_EMS_DDS_APLY_FACT_TNCY_AND_HSHLD_SMRY", config)
    ...
    try:
        logger.info("Step: read_DPA_FACT_TNCY_AND_HSHLD_SMRY")
        # Reading Data From Source - read_DPA_FACT_TNCY_AND_HSHLD_SMRY
        # Resolve connection by alias (supports lookup/source connections dynamically)
        _conn = lib.get_db_config(config, "DPA")
        df_DPA_FACT_TNCY_AND_HSHLD_SMRY = lib.read_sql(spark, _conn, table="DPA_FACT_TNCY_AND_HSHLD_SMRY")
        
        logger.info("Step: apply_SQ_SP_DELETE")
        # Source Qualifier: apply_SQ_SP_DELETE
        df_SQ_SP_DELETE = df_DPA_FACT_TNCY_AND_HSHLD_SMRY
        ...
        logger.info("Step: apply_SQ_DPA_FACT_TNCY_AND_HSHLD_SMRY")
        # Source Qualifier: apply_SQ_DPA_FACT_TNCY_AND_HSHLD_SMRY
        df_SQ_DPA_FACT_TNCY_AND_HSHLD_SMRY = df_DPA_FACT_TNCY_AND_HSHLD_SMRY
        # Select only SQ output ports (matches Informatica behavior) — missing ports become lit(None)
        _port_cols = ["TIME_DMNS_KEY", "EST_SCD_KEY", "RENT_FCTR_DMNS_KEY", "RVN_TXN_MODE_DMNS_KEY", "TNCY_SCHM_TYPE_DMNS_KEY", "DSTR_BRD_DSTR_DMNS_KEY", "DSTR_CHC_DSTR_SCD_KEY", "RNTL_PSTN_DMNS_KEY", "RSDN_LNG_DMNS_KEY", "HSHLD_SIZE_DMNS_KEY", "HSHLD_CNT", "HSHLD_MBR_CNT", "HSHLD_MALE_MBR_CNT", "HSHLD_FML_MBR_CNT", "HSHLD_UKWN_GNDR_MBR_CNT", "HSHLD_DSBL_MBR_CNT", "DSBL_HSHLD_CNT", "PRH_ALL_CSSA_HSHLD_CNT", "PRH_PART_CSSA_HSHLD_CNT", "HSHLD_AEM_IND", "HSHLD_ELDR_IND"]
        df_SQ_DPA_FACT_TNCY_AND_HSHLD_SMRY = df_SQ_DPA_FACT_TNCY_AND_HSHLD_SMRY.select([col(c) if c.lower() in [x.lower() for x in df_SQ_DPA_FACT_TNCY_AND_HSHLD_SMRY.columns] else lit(None).alias(c) for c in _port_cols])
        ctx.register_df("df_SQ_DPA_FACT_TNCY_AND_HSHLD_SMRY", df_SQ_DPA_FACT_TNCY_AND_HSHLD_SMRY)
        
        logger.info("Step: apply_EXP_SET_DEL_INFO")
        # Expression: apply_EXP_SET_DEL_INFO
        df_EXP_SET_DEL_INFO = df_SQ_SP_DELETE
        df_EXP_SET_DEL_INFO = df_EXP_SET_DEL_INFO.withColumn("TBL_NAME", expr("'DDS_FACT_TNCY_AND_HSHLD_SMRY'"))
        df_EXP_SET_DEL_INFO = df_EXP_SET_DEL_INFO.withColumn("RM_FLG", expr("'N'"))
        _expr = """'$$v_REC_RLS_IND'"""
        ...
        logger.info("Step: write_DDS_FACT_TNCY_AND_HSHLD_SMRY")
        # Write to Target: write_DDS_FACT_TNCY_AND_HSHLD_SMRY
        df_write = df_SQ_DPA_FACT_TNCY_AND_HSHLD_SMRY
        # Map source columns to target columns using connector field map (handles name
        # mismatches) — done BEFORE the _update_flag split so UPDATE/DELETE use target
        # column names in batch_update/batch_delete.
        _field_map = {"DSBL_HSHLD_CNT": "DSBL_HSHLD_CNT", "DSTR_BRD_DSTR_DMNS_KEY": "DSTR_BRD_DSTR_DMNS_KEY", "DSTR_CHC_DSTR_SCD_KEY": "DSTR_CHC_DSTR_SCD_KEY", "EST_SCD_KEY": "EST_SCD_KEY", "HSHLD_AEM_IND": "HSHLD_AEM_IND", "HSHLD_CNT": "HSHLD_CNT", "HSHLD_DSBL_MBR_CNT": "HSHLD_DSBL_MBR_CNT", "HSHLD_ELDR_IND": "HSHLD_ELDR_IND", "HSHLD_FML_MBR_CNT": "HSHLD_FML_MBR_CNT", "HSHLD_MALE_MBR_CNT": "HSHLD_MALE_MBR_CNT", "HSHLD_MBR_CNT": "HSHLD_MBR_CNT", "HSHLD_SIZE_DMNS_KEY": "HSHLD_SIZE_DMNS_KEY", "HSHLD_UKWN_GNDR_MBR_CNT": "HSHLD_UKWN_GNDR_MBR_CNT", "PRH_ALL_CSSA_HSHLD_CNT": "PRH_ALL_CSSA_HSHLD_CNT", "PRH_PART_CSSA_HSHLD_CNT": "PRH_PART_CSSA_HSHLD_CNT", "RENT_FCTR_DMNS_KEY": "RENT_FCTR_DMNS_KEY", "RNTL_PSTN_DMNS_KEY": "RNTL_PSTN_DMNS_KEY", "RSDN_LNG_DMNS_KEY": "RSDN_LNG_DMNS_KEY", "RVN_TXN_MODE_DMNS_KEY": "RVN_TXN_MODE_DMNS_KEY", "TIME_DMNS_KEY": "TIME_DMNS_KEY", "TNCY_SCHM_TYPE_DMNS_KEY": "TNCY_SCHM_TYPE_DMNS_KEY"}
        ...
        metrics.complete()
        logger.info("Mapping M_EMS_DDS_APLY_FACT_TNCY_AND_HSHLD_SMRY completed: SUCCESS")
        return True
        
    except Exception as e:
        metrics.fail(e)
        logger.error(f"Mapping M_EMS_DDS_APLY_FACT_TNCY_AND_HSHLD_SMRY FAILED: {e}", exc_info=True)
        return False
...
def main():
    ...
    logger = lib.get_logger()
    config = lib.load_config('env/config.yml')
    spark = lib.get_spark_session("M_EMS_DDS_APLY_FACT_TNCY_AND_HSHLD_SMRY", config)
    ctx = lib.SparkContext(spark)
    metrics = lib.MappingMetrics("M_EMS_DDS_APLY_FACT_TNCY_AND_HSHLD_SMRY")
