...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_DPA_FACT_TNCY_AND_HSHLD_SMRY = lib.sq_output(
            input_df=df_SQ_DPA_FACT_TNCY_AND_HSHLD_SMRY,
            port_cols={
                'TIME_DMNS_KEY': 'decimal',
                'EST_SCD_KEY': 'decimal',
                ...
                'DSBL_HSHLD_CNT': 'decimal',
                'PRH_ALL_CSSA_HSHLD_CNT': 'decimal',
                'PRH_PART_CSSA_HSHLD_CNT': 'decimal',
        ...
        df_EXP_SET_DEL_INFO = lib.expression(
            input_df=df_SQ_SP_DELETE,
            computed_columns=[
                {'name': 'TBL_NAME', 'expr': "'DDS_FACT_TNCY_AND_HSHLD_SMRY'"},
                {'name': 'RM_FLG', 'expr': "'N'"},
        ...
        lib.write_target(
            spark=spark,
            df=df_SQ_DPA_FACT_TNCY_AND_HSHLD_SMRY,
            conn=conn_target,
