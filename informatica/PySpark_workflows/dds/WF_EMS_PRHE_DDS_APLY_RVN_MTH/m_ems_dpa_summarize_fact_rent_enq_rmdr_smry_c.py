...
AND  LAST_DAY(TO_DATE('$$v_rpt_mth' || '01','YYYYMMDD')) BETWEEN BGN_DATE AND END_DATE"""
        ...
        df_lkp_merge_4 = df_rtr_non_wo1_2.join(
            ...
            (df_rtr_non_wo1_2["EST_NAME3"] == _lkp_right["EST_NAME"]),
            "left"
        )
...
AND  LAST_DAY(TO_DATE('$$v_rpt_mth' || '01','YYYYMMDD')) BETWEEN BGN_DATE AND END_DATE"""
        ...
        df_mplt_rename_22 = df_mplt_input_21
        df_mplt_rename_22 = df_mplt_rename_22.drop("EST_KEY").withColumnRenamed("EST_KEY1", "EST_KEY")
        df_mplt_rename_22 = df_mplt_rename_22.drop("SYS_RPT_YEAR").withColumnRenamed("SYS_RPT_YEAR1", "SYS_RPT_YEAR")
        df_mplt_rename_22 = df_mplt_rename_22.drop("SYS_RPT_MTH").withColumnRenamed("SYS_RPT_MTH1", "SYS_RPT_MTH")
        ctx.register_df("df_mplt_rename_22", df_mplt_rename_22)
        
        logger.info("Step: apply_mplt_EXPTRANS1")
        # Expression: apply_mplt_EXPTRANS1
        df_mplt_EXPTRANS1 = df_mplt_rename_22
...
WHERE add_months(TO_DATE('$$v_rpt_mth'||'01', 'YYYYMMDD'),1)-1 between DDS_HRCHY_EMS_EST.BGN_DATE AND DDS_HRCHY_EMS_EST.END_DATE"""
        ...
        df_mplt_rename_26 = df_mplt_LKP_DDS_DMNS_ENQ_CHNL_TYPE
        df_mplt_rename_26 = df_mplt_rename_26.drop("EST_KEY").withColumnRenamed("EST_KEY1", "EST_KEY")
        df_mplt_rename_26 = df_mplt_rename_26.drop("SYS_RPT_YEAR").withColumnRenamed("SYS_RPT_YEAR1", "SYS_RPT_YEAR")
        df_mplt_rename_26 = df_mplt_rename_26.drop("SYS_RPT_MTH").withColumnRenamed("SYS_RPT_MTH1", "SYS_RPT_MTH")
        ctx.register_df("df_mplt_rename_26", df_mplt_rename_26)
        
        logger.info("Step: apply_mplt_EXPTRANS2")
        # Expression: apply_mplt_EXPTRANS2
        df_mplt_EXPTRANS2 = df_mplt_rename_26
