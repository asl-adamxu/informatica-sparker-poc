...
```mermaid
flowchart TD
    n1["S_GMS_ETL_PARAM_SETUP<br/><i>(M_UTL_PARAM_SETUP)</i>"]
    n2["S_GMS_ETL_DPA_TRUNCATE<br/><i>(M_UTL_DPA_TRUNCATE)</i>"]
    subgraph pg3[Parallel]
        n1
        n2
    end
    subgraph wkl4["WL_GMS_DDS_SUM"]
    n5["S_DPA_SUM_FACT_GMS_DLY_MSD_INCDT<br/><i>(M_DPA_SUM_FACT_GMS_DLY_MSD_INCDT)</i>"]
    n6["S_DPA_SUM_FACT_GMS_DLY_MSD_SMRY<br/><i>(M_DPA_SUM_FACT_GMS_DLY_MSD_SMRY)</i>"]
    n7["S_DPA_SUM_FACT_GMS_DLY_DOG_RGSTR<br/><i>(M_DPA_SUM_FACT_GMS_DLY_DOG_RGSTR)</i>"]
    ...
    n10["S_DDS_APL_FACT_GMS_DLY_MSD_INCDT<br/><i>(M_DDS_APL_FACT_GMS_DLY_MSD_INCDT)</i>"]
    n11["S_DDS_APL_FACT_GMS_DLY_DOG_RGSTR<br/><i>(M_DDS_APL_FACT_GMS_DLY_DOG_RGSTR)</i>"]
    n12["S_DDS_APL_FACT_GMS_DLY_MSD_SMRY<br/><i>(M_DDS_APL_FACT_GMS_DLY_MSD_SMRY)</i>"]
