...
flowchart TD
    ...
    n6["S_DPA_SUM_FACT_GMS_DLY_MSD_INCDT<br/><i>(M_DPA_SUM_FACT_GMS_DLY_MSD_INCDT)</i>"]
    ...
    n10["S_DDS_APL_FACT_GMS_DLY_MSD_SMRY<br/><i>(M_DDS_APL_FACT_GMS_DLY_MSD_SMRY)</i>"]
    n11["S_DDS_APL_FACT_GMS_DLY_MSD_INCDT<br/><i>(M_DDS_APL_FACT_GMS_DLY_MSD_INCDT)</i>"]
    n12["S_DDS_APL_FACT_GMS_DLY_DOG_RGSTR<br/><i>(M_DDS_APL_FACT_GMS_DLY_DOG_RGSTR)</i>"]
