...
GROUP BY 
	...
	, VWO.WORK_ORD_KEY"""
        ...
        df_lkp_merge_2 = df_EXPTRANS1.join(
            broadcast(_lkp_right),
            (df_EXPTRANS1["WORK_VFRA_TYPE_CODE"] == _lkp_right["_lkp_WORK_VFRA_TYPE_CODE"]) &
            (df_EXPTRANS1["WORK_ORD_KEY"] == _lkp_right["_lkp_WORK_ORD_KEY"]),
            "left"
...
SELECT     	RM.UNIT_KEY as UNIT_KEY,
	...
	AND RM.TNCY_AGRMT_KEY = TAMS.TNCY_AGRMT_KEY
        ...
        df_mplt_input_4 = df_mplt_input_4.withColumn("END_DATE", expr("WORK_DRFT_ORD_ISS_DATE"))
        ...
        df_mplt_rename_5 = df_mplt_rename_5.drop("END_DATE").withColumnRenamed("WORK_DRFT_ORD_ISS_DATE", "END_DATE")
...
GROUP BY
	SOR_HSM_EST.EST_KEY"""
        ...
        df_lkp_merge_6 = df_lkp_merge_6.join(
            broadcast(_lkp_right),
            (df_lkp_merge_6["UNIT_TYPE_CODE1"] == _lkp_right["FLAT_TYPE_CODE"]),
            "left"
        )
