...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    try:
        ...
        df_src_1 = lib.read_sql(spark, _conn, table="DPA_FACT_EMS_REHSE_ANLS")
        ...
        df_sq_3 = df_src_1
        # Select only SQ output ports (matches Informatica behavior)
        df_sq_3 = df_sq_3.select("EST_SCD_KEY", "DSTR_BRD_DSTR_DMNS_KEY", "DSTR_CHC_DSTR_SCD_KEY", "TFR_TYPE_DMNS_KEY", "TFR_CASE_RSN_DMNS_KEY", "TIME_DMNS_KEY", "OR_TYPE_CODE", "REHSE_NEW_CASE_CNT", "REHSE_OSTD_CASE_CNT", "REHSE_STL_CASE_CNT", "REHSE_CNCL_CASE_CNT", "REHSE_BF_CASE_CNT")
        ctx.register_df("df_sq_3", df_sq_3)
        
        logger.info("Step: apply_EXP_SET_DEL_INFO")
        # Expression: apply_EXP_SET_DEL_INFO
        df_exp_4 = df_sq_2
        df_exp_4 = df_exp_4.withColumn("TBL_NAME", expr("'DDS_FACT_EMS_REHSE_ANLS'"))
        ...
        df_agg_5 = df_sq_3.groupBy("EST_SCD_KEY", "DSTR_BRD_DSTR_DMNS_KEY", "DSTR_CHC_DSTR_SCD_KEY", "TFR_TYPE_DMNS_KEY", "TFR_CASE_RSN_DMNS_KEY", "TIME_DMNS_KEY", "OR_TYPE_CODE")
