...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        # Select only SQ output ports (matches Informatica behavior) — missing ports become lit(None)
        _port_cols = ["EST_SCD_KEY", "DSTR_BRD_DSTR_DMNS_KEY", "DSTR_CHC_DSTR_SCD_KEY", "TFR_TYPE_DMNS_KEY", "TFR_CASE_RSN_DMNS_KEY", "TIME_DMNS_KEY", "OR_TYPE_CODE", "REHSE_NEW_CASE_CNT", "REHSE_OSTD_CASE_CNT", "REHSE_STL_CASE_CNT", "REHSE_CNCL_CASE_CNT", "REHSE_BF_CASE_CNT"]
        df_SQ_DPA_FACT_EMS_REHSE_ANLS = df_SQ_DPA_FACT_EMS_REHSE_ANLS.select([col(c) if c.lower() in [x.lower() for x in df_SQ_DPA_FACT_EMS_REHSE_ANLS.columns] else lit(None).alias(c) for c in _port_cols])
