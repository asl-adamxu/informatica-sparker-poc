...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_DPA_FACT_EMS_REHSE_ANLS = lib.sq_output(
            input_df=df_SQ_DPA_FACT_EMS_REHSE_ANLS,
            port_cols={
                'EST_SCD_KEY': 'decimal',
                'DSTR_BRD_DSTR_DMNS_KEY': 'decimal',
                'DSTR_CHC_DSTR_SCD_KEY': 'decimal',
                'TFR_TYPE_DMNS_KEY': 'decimal',
                'TFR_CASE_RSN_DMNS_KEY': 'decimal',
                'TIME_DMNS_KEY': 'decimal',
                'OR_TYPE_CODE': 'string',
                'REHSE_NEW_CASE_CNT': 'decimal',
                'REHSE_OSTD_CASE_CNT': 'decimal',
                'REHSE_STL_CASE_CNT': 'decimal',
                'REHSE_CNCL_CASE_CNT': 'decimal',
                'REHSE_BF_CASE_CNT': 'decimal',
            },
        )
        ...
        df_EXP_SET_DEL_INFO = lib.expression(
            input_df=df_SQTRANS,
            computed_columns=[
                {'name': 'TBL_NAME', 'expr': "'DDS_FACT_EMS_REHSE_ANLS'"},
                {'name': 'RM_FLG', 'expr': "'Y'"},
        ...
        lib.write_target(
            ...
            source_columns=[
                ...
                'OR_TYPE_CODE',
                'REHSE_NEW_CASE_CNT1',
                'REHSE_OSTD_CASE_CNT1',
                'REHSE_STL_CASE_CNT1',
                'REHSE_CNCL_CASE_CNT1',
                'REHSE_BF_CASE_CNT1',
            ],
            target_columns=[
                'EST_SCD_KEY',
