...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_DPA_FACT_EMS_IH_CASE_MTH_ANLS = lib.sq_output(
            input_df=df_SQ_DPA_FACT_EMS_IH_CASE_MTH_ANLS,
            port_cols={
                ...
                'OPR_TYPE_DMNS_KEY': 'decimal',
                'IH_NEW_CASE_CNT': 'decimal',
        ...
        lib.write_target(
            spark=spark,
            df=df_SQ_DPA_FACT_EMS_IH_CASE_MTH_ANLS,
            conn=conn_target,
        ...
        df_EXP_SET_DEL_INFO = lib.expression(
            input_df=df_SQTRANS,
            computed_columns=[
                {'name': 'TBL_NAME', 'expr': "'DDS_FACT_EMS_IH_CASE_MTH_ANLS'"},
                {'name': 'RM_FLG', 'expr': "'Y'"},
