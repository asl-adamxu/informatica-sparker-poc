...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        _port_cols = ["TIME_DMNS_KEY", "EST_SCD_KEY", "DSTR_BRD_DSTR_DMNS_KEY", "DSTR_CHC_DSTR_SCD_KEY", "CATG_USER_TYPE_CODE", "FLAT_TYPE_DMNS_KEY", "MAX_UNIT_HEAD_CNT", "MIN_UNIT_HEAD_CNT", "RENT_FCTR_DMNS_KEY", "OPR_TYPE_DMNS_KEY", "IH_NEW_CASE_CNT", "ACTV_TNCY_CNT"]
        df_SQ_DPA_FACT_EMS_IH_CASE_MTH_ANLS = df_SQ_DPA_FACT_EMS_IH_CASE_MTH_ANLS.select([col(c) if c.lower() in [x.lower() for x in df_SQ_DPA_FACT_EMS_IH_CASE_MTH_ANLS.columns] else lit(None).alias(c) for c in _port_cols])
