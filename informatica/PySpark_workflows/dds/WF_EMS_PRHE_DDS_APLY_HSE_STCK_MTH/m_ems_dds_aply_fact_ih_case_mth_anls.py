...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    try:
        ...
        df_SQ_DPA_FACT_EMS_IH_CASE_MTH_ANLS = df_SQ_DPA_FACT_EMS_IH_CASE_MTH_ANLS.select([col(c) if c in df_SQ_DPA_FACT_EMS_IH_CASE_MTH_ANLS.columns else lit(None).alias(c) for c in _port_cols])
