...
group by RM.unit_key
        ...
        df_mplt_rename_3 = df_mplt_rename_3.drop("COUNT_IN").withColumnRenamed("TOT_OFR_BFR_SUCC_RLET_CNT", "COUNT_IN")
        df_mplt_rename_3 = df_mplt_rename_3.drop("BGN_DATE").withColumnRenamed("OFR_DATE", "BGN_DATE")
        df_mplt_rename_3 = df_mplt_rename_3.drop("END_DATE").withColumnRenamed("TNCY_AGRMT_CMNC_DATE", "END_DATE")
        ctx.register_df("df_mplt_rename_3", df_mplt_rename_3)
        
        logger.info("Step: apply_mplt_EXPTRANS")
        # Expression: apply_mplt_EXPTRANS
        df_mplt_EXPTRANS = df_mplt_rename_3
        ...
        df_MPLT_DPA_OFR_RLET_CALC = df_mplt_AGGTRANS
        ...
        df_mplt_rename_5 = df_mplt_rename_5.drop("BGN_DATE").withColumnRenamed("FRST_OFR_DATE", "BGN_DATE")
        df_mplt_rename_5 = df_mplt_rename_5.drop("END_DATE").withColumnRenamed("TNCY_AGRMT_CMNC_DATE", "END_DATE")
        ...
        df_MPLT_DPA_FRST_OFR_RLET_CALC = df_mplt_AGGTRANS
