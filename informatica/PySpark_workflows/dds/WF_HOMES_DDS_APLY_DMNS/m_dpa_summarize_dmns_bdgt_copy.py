...
and  TO_DATE ('$$v_snsh_date', 'YYYYMMDD') BETWEEN mm.bgn_date AND mm.end_date
        ...
        for _col in ["IN_COPY_CODE", "BDGT_PRCS_YEAR", "DMNS_BDGT_COPY_KEY", "COPY_CODE", "COPY_VER_NUM", "IN_BDGT_PRCS_YEAR", "IN_COPY_VER_NUM", "BDGT_COPY_DESP", "BDGT_COPY_DISP_SEQ_NUM"]:
