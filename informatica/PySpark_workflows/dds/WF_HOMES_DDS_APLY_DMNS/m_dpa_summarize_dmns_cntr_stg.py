...
ORDER BY SOR_HOM_CON_CNTR_STG.CNTR_STG_CODE"""
        ...
        df_SQ_SOR_HOM_CON_CNTR_STG = df_SQ_SOR_HOM_CON_CNTR_STG.select([col(c) if c.lower() in [x.lower() for x in df_SQ_SOR_HOM_CON_CNTR_STG.columns] else lit(None).alias(c) for c in _port_cols])
