...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    try:
        ...
        # Select only SQ output ports (matches Informatica behavior)
        df_SQ_DPA_FACT_EMS_SMS_RENT_TXN = df_SQ_DPA_FACT_EMS_SMS_RENT_TXN.select("RENT_IND_DESP_DMNS_KEY", "DESP_DTL_DMNS_KEY", "TIME_DMNS_KEY", "TXN_CNT", "LAST_REC_TXN_DATE", "LAST_REC_TXN_TYPE_CODE", "REC_RLS_IND")
