...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    try:
        ...
        df_src_1 = lib.read_sql(spark, _conn, table="DPA_FACT_EMS_SMS_RENT_TXN")
        ...
        df_sq_3 = df_src_1
        # Select only SQ output ports (matches Informatica behavior)
        df_sq_3 = df_sq_3.select("RENT_IND_DESP_DMNS_KEY", "DESP_DTL_DMNS_KEY", "TIME_DMNS_KEY", "TXN_CNT", "LAST_REC_TXN_DATE", "LAST_REC_TXN_TYPE_CODE", "REC_RLS_IND")
        ctx.register_df("df_sq_3", df_sq_3)
        
        logger.info("Step: apply_EXP_SET_DEL_INFO")
        # Expression: apply_EXP_SET_DEL_INFO
        df_exp_4 = df_sq_2
        df_exp_4 = df_exp_4.withColumn("TBL_NAME", expr("'DDS_FACT_EMS_SMS_RENT_TXN'"))
        ...
        df_agg_5 = df_sq_3.groupBy("RENT_IND_DESP_DMNS_KEY", "DESP_DTL_DMNS_KEY", "TIME_DMNS_KEY")
