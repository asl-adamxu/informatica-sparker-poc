...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_DPA_FACT_EMS_OVRCRD_RLF = lib.sq_output(
            input_df=df_SQ_DPA_FACT_EMS_OVRCRD_RLF,
            port_cols={
                'LVNG_DNSTY_CNT': 'decimal',
                'TIME_DMNS_KEY': 'decimal',
                'DSTR_DMNS_KEY': 'decimal',
                'EST_DMNS_KEY': 'decimal',
                'LVNG_DNSTY_DMNS_KEY': 'decimal',
        ...
        df_EXP_SET_DEL_INFO = lib.expression(
            input_df=df_SQ_SP_DELETE,
            computed_columns=[
                {'name': 'TBL_NAME', 'expr': "'DDS_FACT_EMS_OVRCRD_RLF'"},
                {'name': 'RM_FLG', 'expr': "'Y'"},
