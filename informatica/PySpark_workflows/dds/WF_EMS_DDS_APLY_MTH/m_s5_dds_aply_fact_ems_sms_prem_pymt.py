...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_DPA_FACT_EMS_SMS_PREM_PYMT = lib.sq_output(
            input_df=df_SQ_DPA_FACT_EMS_SMS_PREM_PYMT,
            port_cols={
                'UNIT_TYPE_DMNS_KEY': 'decimal',
                'DESP_DTL_DMNS_KEY': 'decimal',
                'TIME_DMNS_KEY': 'decimal',
                'PREM_PYMT_AMT': 'decimal',
        ...
        df_EXP_SET_DEL_INFO = lib.expression(
            input_df=df_SQ_SP_DELETE,
            computed_columns=[
                {'name': 'TBL_NAME', 'expr': "'DDS_FACT_EMS_SMS_PREM_PYMT'"},
                {'name': 'RM_FLG', 'expr': "'Y'"},
