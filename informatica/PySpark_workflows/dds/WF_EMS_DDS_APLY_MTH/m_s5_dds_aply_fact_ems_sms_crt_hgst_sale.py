...
From DPA_FACT_EMS_SMS_CRT_HGST_SALE"""
        ...
        for _i in range(len(_sql_cols) if len(_sql_cols) < len(_port_cols) else len(_port_cols)):
            if _sql_cols[_i].lower() != _port_cols[_i].lower():
                df_SQ_DPA_FACT_EMS_SMS_CRT_HGST_SALE = df_SQ_DPA_FACT_EMS_SMS_CRT_HGST_SALE.withColumnRenamed(_sql_cols[_i], _port_cols[_i])
        # Select only SQ output ports (matches Informatica behavior)
        df_SQ_DPA_FACT_EMS_SMS_CRT_HGST_SALE = df_SQ_DPA_FACT_EMS_SMS_CRT_HGST_SALE.select("DESP_DTL_DMNS_KEY", "UNIT_TYPE_DMNS_KEY", "TIME_DMNS_KEY", "CRT_DMNS_KEY", "TXN_CNT", "LAST_REC_TXN_DATE", "LAST_REC_TXN_TYPE_CODE", "REC_RLS_IND")
