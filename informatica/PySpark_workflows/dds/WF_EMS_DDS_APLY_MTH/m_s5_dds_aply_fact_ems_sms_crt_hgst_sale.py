...
From DPA_FACT_EMS_SMS_CRT_HGST_SALE"""
        ...
        df_SQ_DPA_FACT_EMS_SMS_CRT_HGST_SALE = df_SQ_DPA_FACT_EMS_SMS_CRT_HGST_SALE.select([col(c) if c in df_SQ_DPA_FACT_EMS_SMS_CRT_HGST_SALE.columns else lit(None).alias(c) for c in _port_cols])
