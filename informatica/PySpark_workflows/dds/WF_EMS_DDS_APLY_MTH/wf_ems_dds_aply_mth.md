...
flowchart TD
    ...
    n2["S_EMS_ETL_DPA_TRUNCATE<br/><i>(M_UTL_DPA_TRUNCATE)</i>"]
    n3["T_RM_EMS_CACHE"]
    ...
    n6["S_S5_DPA_SUMMARIZE_FACT_EMS_SMS_TXN<br/><i>(M_S5_DPA_SUMMARIZE_FACT_EMS_SMS_TXN)</i>"]
    n7["S_S5_DPA_SUMMARIZE_FACT_EMS_SMS_DSTR_TXN<br/><i>(M_S5_DPA_SUMMARIZE_FACT_EMS_SMS_DSTR_TXN)</i>"]
    n8["S_S5_DPA_SUMMARIZE_FACT_EMS_SMS_RENT_TXN<br/><i>(M_S5_DPA_SUMMARIZE_FACT_EMS_SMS_RENT_TXN)</i>"]
    n9["S_S5_DPA_SUMMARIZE_FACT_EMS_SMS_FLAT_PRC_TXN<br/><i>(M_S5_DPA_SUMMARIZE_FACT_EMS_SMS_FLAT_PRC_TXN)</i>"]
    n10["S_S5_DPA_SUMMARIZE_FACT_EMS_SMS_APLY_TYPE_TXN<br/><i>(M_S5_DPA_SUMMARIZE_FACT_EMS_SMS_APLY_TYPE_TXN)</i>"]
    n11["S_S5_DPA_SUMMARIZE_FACT_EMS_SMS_CRT_HGST_SALE<br/><i>(M_S5_DPA_SUMMARIZE_FACT_EMS_SMS_CRT_HGST_SALE)</i>"]
    n12["S_S5_DPA_SUMMARIZE_FACT_EMS_SMS_PREM_PYMT_A<br/><i>(M_S5_DPA_SUMMARIZE_FACT_EMS_SMS_PREM_PYMT_A)</i>"]
    n13["S_S5_DPA_SUMMARIZE_FACT_EMS_SMS_PGS<br/><i>(M_S5_DPA_SUMMARIZE_FACT_EMS_SMS_PGS)</i>"]
    n14["S_S5_DPA_SUMMARIZE_FACT_EMS_SMS_FLAT_SIZE_TXN<br/><i>(M_S5_DPA_SUMMARIZE_FACT_EMS_SMS_FLAT_SIZE_TXN)</i>"]
    ...
    n18["S_S5_DPA_SUMMARIZE_FACT_EMS_PRH_ABU<br/><i>(M_S5_DPA_SUMMARIZE_FACT_EMS_PRH_ABU)</i>"]
    n19["S_S5_DPA_SUMMARIZE_FACT_EMS_HSC_STCK<br/><i>(M_S5_DPA_SUMMARIZE_FACT_EMS_HSC_STCK)</i>"]
    n20["S_S5_DPA_SUMMARIZE_FACT_EMS_RMV_RDEV_ALWN<br/><i>(M_S5_DPA_SUMMARIZE_FACT_EMS_RMV_RDEV_ALWN)</i>"]
    n21["S_S5_DPA_SUMMARIZE_FACT_EMS_FLAT_RENT<br/><i>(M_S5_DPA_SUMMARIZE_FACT_EMS_FLAT_RENT)</i>"]
    n22["S_S5_DPA_SUMMARIZE_FACT_EMS_TNCY_TFR<br/><i>(M_S5_DPA_SUMMARIZE_FACT_EMS_TNCY_TFR)</i>"]
    n23["S_S5_DPA_SUMMARIZE_FACT_EMS_ADTN_DEL<br/><i>(M_S5_DPA_SUMMARIZE_FACT_EMS_ADTN_DEL)</i>"]
    ...
    n37["S_S5_DDS_APLY_FACT_EMS_SMS_DSTR_TXN<br/><i>(M_S5_DDS_APLY_FACT_EMS_SMS_DSTR_TXN)</i>"]
    n38["S_S5_DDS_APLY_FACT_EMS_SMS_RENT_TXN<br/><i>(M_S5_DDS_APLY_FACT_EMS_SMS_RENT_TXN)</i>"]
    n39["S_S5_DDS_APLY_FACT_EMS_SMS_CRT_HGST_SALE<br/><i>(M_S5_DDS_APLY_FACT_EMS_SMS_CRT_HGST_SALE)</i>"]
    n40["S_S5_DDS_APLY_FACT_EMS_SMS_FLAT_SIZE_TXN<br/><i>(M_S5_DDS_APLY_FACT_EMS_SMS_FLAT_SIZE_TXN)</i>"]
    n41["S_S5_DDS_APLY_FACT_EMS_SMS_FLAT_PRC_TXN<br/><i>(M_S5_DDS_APLY_FACT_EMS_SMS_FLAT_PRC_TXN)</i>"]
    n42["S_S5_DDS_APLY_FACT_EMS_SMS_PREM_PYMT<br/><i>(M_S5_DDS_APLY_FACT_EMS_SMS_PREM_PYMT)</i>"]
    n43["S_S5_DDS_APLY_FACT_EMS_SMS_APLY_TYPE_TXN<br/><i>(M_S5_DDS_APLY_FACT_EMS_SMS_APLY_TYPE_TXN)</i>"]
    n44["S_S5_DDS_APLY_FACT_EMS_SMS_PGS<br/><i>(M_S5_DDS_APLY_FACT_EMS_SMS_PGS)</i>"]
    n45["S_S5_DDS_APLY_FACT_EMS_SMS_TXN<br/><i>(M_S5_DDS_APLY_FACT_EMS_SMS_TXN)</i>"]
    ...
    n48["S_S5_DDS_APLY_FACT_EMS_EST_PLT<br/><i>(M_S5_DDS_APLY_FACT_EMS_EST_PLT)</i>"]
    n49["S_S5_DDS_APLY_FACT_EMS_RAS_HDSP<br/><i>(M_S5_DDS_APLY_FACT_EMS_RAS_HDSP)</i>"]
    n50["S_S5_DDS_APLY_FACT_EMS_VCNT_FLAT<br/><i>(M_S5_DDS_APLY_FACT_EMS_VCNT_FLAT)</i>"]
    n51["S_S5_DDS_APLY_FACT_EMS_DSTR_COUNCIL_EST<br/><i>(M_S5_DDS_APLY_FACT_EMS_DSTR_COUNCIL_EST)</i>"]
    n52["S_S5_DDS_APLY_FACT_EMS_ADTN_DEL<br/><i>(M_S5_DDS_APLY_FACT_EMS_ADTN_DEL)</i>"]
    n53["S_S5_DDS_APLY_FACT_EMS_PRH_ABU<br/><i>(M_S5_DDS_APLY_FACT_EMS_PRH_ABU)</i>"]
    n54["S_S5_DDS_APLY_FACT_EMS_OVRCRD_RLF<br/><i>(M_S5_DDS_APLY_FACT_EMS_OVRCRD_RLF)</i>"]
    n55["S_S5_DDS_APLY_FACT_EMS_HSC_STCK<br/><i>(M_S5_DDS_APLY_FACT_EMS_HSC_STCK)</i>"]
    n56["S_S5_DDS_APLY_FACT_EMS_BD<br/><i>(M_S5_DDS_APLY_FACT_EMS_BD)</i>"]
    n57["S_S5_DDS_APLY_FACT_EMS_TNCY_TFR<br/><i>(M_S5_DDS_APLY_FACT_EMS_TNCY_TFR)</i>"]
    n58["S_S5_DDS_APLY_FACT_EMS_UND_OCPY<br/><i>(M_S5_DDS_APLY_FACT_EMS_UND_OCPY)</i>"]
    n59["S_S5_DDS_APLY_FACT_EMS_RMV_RDEV_ALWN<br/><i>(M_S5_DDS_APLY_FACT_EMS_RMV_RDEV_ALWN)</i>"]
    n60["S_S5_DDS_APLY_FACT_EMS_FLAT_RENT<br/><i>(M_S5_DDS_APLY_FACT_EMS_FLAT_RENT)</i>"]
