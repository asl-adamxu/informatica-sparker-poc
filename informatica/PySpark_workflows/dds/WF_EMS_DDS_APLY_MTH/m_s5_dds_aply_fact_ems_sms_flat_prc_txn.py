...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_DPA_FACT_EMS_SMS_FLAT_PRC_TXN = df_SQ_DPA_FACT_EMS_SMS_FLAT_PRC_TXN.select([col(c) if c.lower() in [x.lower() for x in df_SQ_DPA_FACT_EMS_SMS_FLAT_PRC_TXN.columns] else lit(None).alias(c) for c in _port_cols])
        ...
        df_EXP_SET_DEL_INFO = df_EXP_SET_DEL_INFO.withColumn("TBL_NAME", expr("'DDS_FACT_EMS_SMS_FLAT_PRC_TXN'"))
        ...
        _field_map = {"DESP_DTL_DMNS_KEY": "DESP_DTL_DMNS_KEY", "LAST_REC_TXN_DATE": "LAST_REC_TXN_DATE", "LAST_REC_TXN_TYPE_CODE": "LAST_REC_TXN_TYPE_CODE", "REC_RLS_IND": "REC_RLS_IND", "TIME_DMNS_KEY": "TIME_DMNS_KEY", "TXN_CNT": "TXN_CNT_OUT", "UNIT_PRC_DMNS_KEY": "UNIT_PRC_DMNS_KEY", "UNIT_TYPE_DMNS_KEY": "UNIT_TYPE_DMNS_KEY"}
        ...
        lib.write_table(df_write, conn_target, "DDS_FACT_EMS_SMS_FLAT_PRC_TXN", mode="append")
