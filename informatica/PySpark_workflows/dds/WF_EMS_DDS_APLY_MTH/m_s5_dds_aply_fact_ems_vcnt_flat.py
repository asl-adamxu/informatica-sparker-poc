...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    try:
        ...
        df_src_1 = lib.read_sql(spark, _conn, table="DPA_FACT_EMS_VCNT_FLAT")
        ...
        df_sq_3 = df_src_1
        # Select only SQ output ports (matches Informatica behavior)
        df_sq_3 = df_sq_3.select("EST_DMNS_KEY", "FLAT_TYPE_DMNS_KEY", "TIME_DMNS_KEY", "VCNT_FLAT_TYPE_DMNS_KEY", "FLAT_CNT", "LAST_REC_TXN_DATE", "LAST_REC_TXN_TYPE_CODE", "DSTR_DMNS_KEY", "REC_RLS_IND")
        ctx.register_df("df_sq_3", df_sq_3)
        
        logger.info("Step: apply_EXP_SET_DEL_INFO")
        # Expression: apply_EXP_SET_DEL_INFO
        df_exp_4 = df_sq_2
        df_exp_4 = df_exp_4.withColumn("TBL_NAME", expr("'DDS_FACT_EMS_VCNT_FLAT'"))
        ...
        df_agg_5 = df_sq_3.groupBy("EST_DMNS_KEY", "FLAT_TYPE_DMNS_KEY", "TIME_DMNS_KEY", "VCNT_FLAT_TYPE_DMNS_KEY", "DSTR_DMNS_KEY")
