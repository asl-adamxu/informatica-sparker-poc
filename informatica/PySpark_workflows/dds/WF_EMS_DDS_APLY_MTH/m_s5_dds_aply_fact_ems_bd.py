...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_DPA_FACT_EMS_BD = lib.sq_output(
            input_df=df_SQ_DPA_FACT_EMS_BD,
            port_cols={
                'EXST_TNCY_CNT': 'decimal',
                'PRN_FORM_CNT': 'decimal',
                'RTN_FORM_CNT': 'decimal',
                'BD_CYCL_BGN_DATE': 'date/time',
                'TASK_FORCE_CASE_CNT': 'decimal',
                'BD_CYCL_END_DATE': 'date/time',
                'CMPLT_CNT': 'decimal',
                'TIME_DMNS_KEY': 'decimal',
                'RGN_DMNS_KEY': 'decimal',
                'DSTR_DMNS_KEY': 'decimal',
                'LAST_REC_TXN_DATE': 'date/time',
                'LAST_REC_TXN_TYPE_CODE': 'string',
                'REC_RLS_IND': 'string',
                'TRGT_CMPLT_PCT': 'decimal',
            },
        )
        ...
        df_EXP_SET_DEL_INFO = lib.expression(
            input_df=df_SQ_SP_DELETE,
            computed_columns=[
                {'name': 'TBL_NAME', 'expr': "'DDS_FACT_EMS_BD'"},
                {'name': 'RM_FLG', 'expr': "'Y'"},
