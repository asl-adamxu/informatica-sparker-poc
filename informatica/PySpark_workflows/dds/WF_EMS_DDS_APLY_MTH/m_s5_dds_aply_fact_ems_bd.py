...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_DPA_FACT_EMS_BD = lib.read_sql(spark, _conn, table="DPA_FACT_EMS_BD")
        
        logger.info("Step: apply_SQ_SP_DELETE")
        # Source Qualifier: apply_SQ_SP_DELETE
        df_SQ_SP_DELETE = df_DPA_FACT_EMS_BD
        ...
        df_SQ_DPA_FACT_EMS_BD = df_DPA_FACT_EMS_BD
        # Select only SQ output ports (matches Informatica behavior) — missing ports become lit(None)
        _port_cols = ["EXST_TNCY_CNT", "PRN_FORM_CNT", "RTN_FORM_CNT", "BD_CYCL_BGN_DATE", "TASK_FORCE_CASE_CNT", "BD_CYCL_END_DATE", "CMPLT_CNT", "TIME_DMNS_KEY", "RGN_DMNS_KEY", "DSTR_DMNS_KEY", "LAST_REC_TXN_DATE", "LAST_REC_TXN_TYPE_CODE", "REC_RLS_IND", "TRGT_CMPLT_PCT"]
        df_SQ_DPA_FACT_EMS_BD = df_SQ_DPA_FACT_EMS_BD.select([col(c) if c.lower() in [x.lower() for x in df_SQ_DPA_FACT_EMS_BD.columns] else lit(None).alias(c) for c in _port_cols])
        ctx.register_df("df_SQ_DPA_FACT_EMS_BD", df_SQ_DPA_FACT_EMS_BD)
        
        logger.info("Step: apply_EXP_SET_DEL_INFO")
        # Expression: apply_EXP_SET_DEL_INFO
        df_EXP_SET_DEL_INFO = df_SQ_SP_DELETE
        df_EXP_SET_DEL_INFO = df_EXP_SET_DEL_INFO.withColumn("TBL_NAME", expr("'DDS_FACT_EMS_BD'"))
        ...
        _agg_input = df_SQ_DPA_FACT_EMS_BD.select(
            col("EXST_TNCY_CNT"),
            col("PRN_FORM_CNT"),
            col("RTN_FORM_CNT"),
            col("BD_CYCL_BGN_DATE"),
            col("TASK_FORCE_CASE_CNT"),
            col("BD_CYCL_END_DATE"),
            col("CMPLT_CNT"),
            col("TIME_DMNS_KEY"),
            col("RGN_DMNS_KEY"),
            col("DSTR_DMNS_KEY"),
            ...
            col("TRGT_CMPLT_PCT")        )
        df_AGGTRANS = _agg_input.groupBy("TIME_DMNS_KEY", "RGN_DMNS_KEY", "DSTR_DMNS_KEY", "LAST_REC_TXN_DATE", "LAST_REC_TXN_TYPE_CODE")
