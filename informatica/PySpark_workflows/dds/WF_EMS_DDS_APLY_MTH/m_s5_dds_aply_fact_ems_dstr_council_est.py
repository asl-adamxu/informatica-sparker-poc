...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    try:
        ...
        # Select only SQ output ports (matches Informatica behavior)
        df_SQ_DPA_FACT_EMS_FLAT = df_SQ_DPA_FACT_EMS_FLAT.select("BLK_CNT", "GEOG_DSTR_NAME", "DSTR_CNL_NAME", "TNCY_SCHM_TYPE_DMNS_KEY", "TIME_DMNS_KEY", "RGN_DMNS_KEY", "EST_DMNS_KEY", "LAST_REC_TXN_DATE", "LAST_REC_TXN_TYPE_CODE", "REC_RLS_IND", "MGT_DSTR_CODE", "BLK_SCD_KEY")
