...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    try:
        ...
        df_sq_3 = df_src_1
        # Select only SQ output ports (matches Informatica behavior)
        df_sq_3 = df_sq_3.select("BLK_CNT", "GEOG_DSTR_NAME", "DSTR_CNL_NAME", "TNCY_SCHM_TYPE_DMNS_KEY", "TIME_DMNS_KEY", "RGN_DMNS_KEY", "EST_DMNS_KEY", "LAST_REC_TXN_DATE", "LAST_REC_TXN_TYPE_CODE", "REC_RLS_IND", "MGT_DSTR_CODE", "BLK_SCD_KEY")
        ctx.register_df("df_sq_3", df_sq_3)
        
        logger.info("Step: apply_EXP_SET_DEL_INFO")
        # Expression: apply_EXP_SET_DEL_INFO
        df_exp_4 = df_sq_2
        df_exp_4 = df_exp_4.withColumn("TBL_NAME", expr("'DDS_FACT_EMS_FLAT'"))
        ...
        df_agg_5 = df_sq_3.groupBy("GEOG_DSTR_NAME", "DSTR_CNL_NAME", "TNCY_SCHM_TYPE_DMNS_KEY", "TIME_DMNS_KEY", "RGN_DMNS_KEY", "EST_DMNS_KEY", "MGT_DSTR_CODE", "BLK_SCD_KEY")
