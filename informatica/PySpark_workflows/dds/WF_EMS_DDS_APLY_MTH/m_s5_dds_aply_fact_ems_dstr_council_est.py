...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_DPA_FACT_EMS_FLAT = lib.sq_output(
            input_df=df_SQ_DPA_FACT_EMS_FLAT,
            port_cols={
                'BLK_CNT': 'decimal',
                'GEOG_DSTR_NAME': 'string',
                'DSTR_CNL_NAME': 'string',
        ...
        df_EXP_SET_DEL_INFO = lib.expression(
            input_df=df_SQ_SP_DELETE,
            computed_columns=[
                {'name': 'TBL_NAME', 'expr': "'DDS_FACT_EMS_FLAT'"},
                {'name': 'RM_FLG', 'expr': "'Y'"},
