...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_DPA_FACT_EMS_TNCY_TFR = lib.sq_output(
            input_df=df_SQ_DPA_FACT_EMS_TNCY_TFR,
            port_cols={
                'TNCY_TFR_CASE_CNT': 'decimal',
                'TIME_DMNS_KEY': 'decimal',
                'TFR_CASE_RSN_DMNS_KEY': 'decimal',
                'TFR_CASE_STS_DMNS_KEY': 'decimal',
        ...
        df_EXP_SET_DEL_INFO = lib.expression(
            input_df=df_SQ_SP_DELETE,
            computed_columns=[
                {'name': 'TBL_NAME', 'expr': "'DDS_FACT_EMS_TNCY_TFR'"},
                {'name': 'RM_FLG', 'expr': "'Y'"},
