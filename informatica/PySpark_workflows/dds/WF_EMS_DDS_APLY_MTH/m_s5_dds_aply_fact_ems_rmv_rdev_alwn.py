'''
* Script - M_S5_DDS_APLY_FACT_EMS_RMV_RDEV_ALWN.py
...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    """
    Execute the M_S5_DDS_APLY_FACT_EMS_RMV_RDEV_ALWN mapping transformations.
    ...
    logger.info("Start to run mapping M_S5_DDS_APLY_FACT_EMS_RMV_RDEV_ALWN")

    config = lib.load_config('env/config.yml')
    objects = config.get('objects', {})

    spark = ctx.spark if ctx else lib.get_spark_session("M_S5_DDS_APLY_FACT_EMS_RMV_RDEV_ALWN", config)
    ...
    try:
        logger.info("Step: read_DPA_FACT_EMS_RMV_RDEV_ALWN")
        # Reading Data From Source - read_DPA_FACT_EMS_RMV_RDEV_ALWN
        # Resolve connection by alias (supports lookup/source connections dynamically)
        _conn = lib.get_db_config(config, "DPA")
        df_DPA_FACT_EMS_RMV_RDEV_ALWN = lib.read_sql(spark, _conn, table="DPA_FACT_EMS_RMV_RDEV_ALWN")
        ...
        df_EXP_SET_DEL_INFO = df_EXP_SET_DEL_INFO.withColumn("TBL_NAME", expr("'DDS_FACT_EMS_RMV_RDEV_ALWN'"))
        ...
        _agg_input = df_SQ_DPA_FACT_EMS_RMV_RDEV_ALWN.select(
            col("OPR_CODE"),
            col("TRGT_EVCT_DATE"),
            col("FMLY_CNT"),
            col("ALWN_AMT"),
            col("TIME_DMNS_KEY"),
            col("RMV_CASE_DMNS_KEY"),
            col("OPR_DESP"),
            ...
            col("OPR_TO_DATE"),
            col("SCHM_CODE")        )
        df_AGGTRANS = _agg_input.groupBy("OPR_CODE", "TRGT_EVCT_DATE", "TIME_DMNS_KEY", "RMV_CASE_DMNS_KEY", "LAST_REC_TXN_DATE", "LAST_REC_TXN_TYPE_CODE", "OPR_DESP", "OPR_RMK_TEXT", "OPR_FROM_DATE", "OPR_TO_DATE", "SCHM_CODE")
        df_AGGTRANS = df_AGGTRANS.agg(
            sum("FMLY_CNT").alias("OUT_FMLY_CNT"),
            sum("ALWN_AMT").alias("OUT_ALWN_AMT"),
        ...
        logger.info("Step: write_DDS_FACT_EMS_RMV_RDEV_ALWN")
        # Write to Target: write_DDS_FACT_EMS_RMV_RDEV_ALWN
        ...
        _field_map = {"ALWN_AMT": "OUT_ALWN_AMT", "FMLY_CNT": "OUT_FMLY_CNT", "LAST_REC_TXN_DATE": "LAST_REC_TXN_DATE", "LAST_REC_TXN_TYPE_CODE": "LAST_REC_TXN_TYPE_CODE", "OPR_CODE": "OPR_CODE", "OPR_DESP": "OPR_DESP", "OPR_FROM_DATE": "OPR_FROM_DATE", "OPR_RMK_TEXT": "OPR_RMK_TEXT", "OPR_TO_DATE": "OPR_TO_DATE", "OPR_TRGT_EVCT_DATE": "TRGT_EVCT_DATE", "REC_RLS_IND": "REC_RLS_IND", "RMV_CASE_DMNS_KEY": "RMV_CASE_DMNS_KEY", "SCHM_CODE": "SCHM_CODE", "TIME_DMNS_KEY": "TIME_DMNS_KEY"}
        ...
        lib.write_table(df_write, conn_target, "DDS_FACT_EMS_RMV_RDEV_ALWN", mode="append")

        logger.info("write_DDS_FACT_EMS_RMV_RDEV_ALWN write completed")
        ...
        metrics.complete()
        logger.info("Mapping M_S5_DDS_APLY_FACT_EMS_RMV_RDEV_ALWN completed: SUCCESS")
        return True
        
    except Exception as e:
        metrics.fail(e)
        logger.error(f"Mapping M_S5_DDS_APLY_FACT_EMS_RMV_RDEV_ALWN FAILED: {e}", exc_info=True)
        return False
...
def main():
    ...
    logger = lib.get_logger()
    config = lib.load_config('env/config.yml')
    spark = lib.get_spark_session("M_S5_DDS_APLY_FACT_EMS_RMV_RDEV_ALWN", config)
    ctx = lib.SparkContext(spark)
    metrics = lib.MappingMetrics("M_S5_DDS_APLY_FACT_EMS_RMV_RDEV_ALWN")
