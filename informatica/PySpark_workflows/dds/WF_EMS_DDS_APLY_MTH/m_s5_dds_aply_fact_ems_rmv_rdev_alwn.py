...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_DPA_FACT_EMS_RMV_RDEV_ALWN = df_SQ_DPA_FACT_EMS_RMV_RDEV_ALWN.select([col(c) if c.lower() in [x.lower() for x in df_SQ_DPA_FACT_EMS_RMV_RDEV_ALWN.columns] else lit(None).alias(c) for c in _port_cols])
