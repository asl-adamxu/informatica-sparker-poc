...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    try:
        ...
        df_src_1 = lib.read_sql(spark, _conn, table="DPA_FACT_EMS_RMV_RDEV_ALWN")
        ...
        df_sq_3 = df_src_1
        # Select only SQ output ports (matches Informatica behavior)
        df_sq_3 = df_sq_3.select("OPR_CODE", "TRGT_EVCT_DATE", "FMLY_CNT", "ALWN_AMT", "TIME_DMNS_KEY", "RMV_CASE_DMNS_KEY", "LAST_REC_TXN_DATE", "LAST_REC_TXN_TYPE_CODE", "REC_RLS_IND", "OPR_DESP", "OPR_RMK_TEXT", "OPR_FROM_DATE", "OPR_TO_DATE", "SCHM_CODE")
        ctx.register_df("df_sq_3", df_sq_3)
        
        logger.info("Step: apply_EXP_SET_DEL_INFO")
        # Expression: apply_EXP_SET_DEL_INFO
        df_exp_4 = df_sq_2
        df_exp_4 = df_exp_4.withColumn("TBL_NAME", expr("'DDS_FACT_EMS_RMV_RDEV_ALWN'"))
        ...
        df_agg_5 = df_sq_3.groupBy("OPR_CODE", "TRGT_EVCT_DATE", "TIME_DMNS_KEY", "RMV_CASE_DMNS_KEY", "OPR_DESP", "OPR_RMK_TEXT", "OPR_FROM_DATE", "OPR_TO_DATE", "SCHM_CODE")
