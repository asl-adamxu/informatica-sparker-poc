...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_DPA_FACT_EMS_RMV_RDEV_ALWN = lib.sq_output(
            input_df=df_SQ_DPA_FACT_EMS_RMV_RDEV_ALWN,
            port_cols={
                'OPR_CODE': 'string',
                'TRGT_EVCT_DATE': 'date/time',
                'FMLY_CNT': 'decimal',
                'ALWN_AMT': 'decimal',
                'TIME_DMNS_KEY': 'decimal',
                'RMV_CASE_DMNS_KEY': 'decimal',
                'LAST_REC_TXN_DATE': 'date/time',
                'LAST_REC_TXN_TYPE_CODE': 'string',
                'REC_RLS_IND': 'string',
                'OPR_DESP': 'string',
                'OPR_RMK_TEXT': 'string',
                'OPR_FROM_DATE': 'date/time',
                'OPR_TO_DATE': 'date/time',
                'SCHM_CODE': 'string',
            },
        )
        ...
        df_EXP_SET_DEL_INFO = lib.expression(
            input_df=df_SQ_SP_DELETE,
            computed_columns=[
                {'name': 'TBL_NAME', 'expr': "'DDS_FACT_EMS_RMV_RDEV_ALWN'"},
                {'name': 'RM_FLG', 'expr': "'Y'"},
