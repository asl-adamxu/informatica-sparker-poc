...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    try:
        ...
        # Select only SQ output ports (matches Informatica behavior) — missing ports become lit(None)
        _port_cols = ["CASE_CNT", "ADTN_DEL_DMNS_KEY", "TIME_DMNS_KEY", "LAST_REC_TXN_DATE", "LAST_REC_TXN_TYPE", "REC_RLS_IND", "RGN_DMNS_KEY", "DSTR_DMNS_KEY"]
        df_SQ_DPA_FACT_EMS_TNCY_ADTN_DEL = df_SQ_DPA_FACT_EMS_TNCY_ADTN_DEL.select([col(c) if c in df_SQ_DPA_FACT_EMS_TNCY_ADTN_DEL.columns else lit(None).alias(c) for c in _port_cols])
        ...
        _agg_input = df_SQ_DPA_FACT_EMS_TNCY_ADTN_DEL.select(
            ...
            col("RGN_DMNS_KEY"),
            col("DSTR_DMNS_KEY")        )
        df_AGGTRANS1 = _agg_input.groupBy("ADTN_DEL_DMNS_KEY", "TIME_DMNS_KEY", "LAST_REC_TXN_DATE", "LAST_REC_TXN_TYPE", "RGN_DMNS_KEY", "DSTR_DMNS_KEY")
