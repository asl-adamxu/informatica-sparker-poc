...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_DPA_FACT_EMS_TNCY_ADTN_DEL = df_SQ_DPA_FACT_EMS_TNCY_ADTN_DEL.select([col(c) if c.lower() in [x.lower() for x in df_SQ_DPA_FACT_EMS_TNCY_ADTN_DEL.columns] else lit(None).alias(c) for c in _port_cols])
