...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_DPA_FACT_EMS_TNCY_ADTN_DEL = lib.sq_output(
            input_df=df_SQ_DPA_FACT_EMS_TNCY_ADTN_DEL,
            port_cols={
                'CASE_CNT': 'decimal',
                'ADTN_DEL_DMNS_KEY': 'decimal',
                'TIME_DMNS_KEY': 'decimal',
                'LAST_REC_TXN_DATE': 'date/time',
                'LAST_REC_TXN_TYPE': 'string',
                'REC_RLS_IND': 'string',
        ...
        df_EXP_SET_DEL_INFO = lib.expression(
            input_df=df_SQ_SP_DELETE,
            computed_columns=[
                {'name': 'TBL_NAME', 'expr': "'DDS_FACT_EMS_TNCY_ADTN_DEL'"},
                {'name': 'RM_FLG', 'expr': "'Y'"},
