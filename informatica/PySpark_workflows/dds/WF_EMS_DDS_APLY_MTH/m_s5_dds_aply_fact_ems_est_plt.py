...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    try:
        ...
        # Select only SQ output ports (matches Informatica behavior)
        df_SQ_DPA_FACT_EMS_EST_PLT = df_SQ_DPA_FACT_EMS_EST_PLT.select("PLT_CNT", "AGE_GRP_DMNS_KEY", "TIME_DMNS_KEY", "EST_PLT_SCHM_CODE", "LAST_REC_TXN_DATE", "LAST_REC_TXN_TYPE_CODE", "REC_RLS_IND", "EST_PLT_TYPE_DMNS_KEY", "EST_DMNS_KEY", "DSTR_DMNS_KEY", "BLK_SCD_KEY")
