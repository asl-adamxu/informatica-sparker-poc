...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_DPA_FACT_EMS_EST_PLT = lib.sq_output(
            input_df=df_SQ_DPA_FACT_EMS_EST_PLT,
            port_cols={
                'PLT_CNT': 'decimal',
                'AGE_GRP_DMNS_KEY': 'decimal',
                'TIME_DMNS_KEY': 'decimal',
                'EST_PLT_SCHM_CODE': 'string',
                'LAST_REC_TXN_DATE': 'date/time',
                'LAST_REC_TXN_TYPE_CODE': 'string',
                'REC_RLS_IND': 'string',
                'EST_PLT_TYPE_DMNS_KEY': 'decimal',
        ...
        df_EXP_SET_DEL_INFO = lib.expression(
            input_df=df_SQ_SP_DELETE,
            computed_columns=[
                {'name': 'TBL_NAME', 'expr': "'DDS_FACT_EMS_EST_PLT'"},
                {'name': 'RM_FLG', 'expr': "'Y'"},
