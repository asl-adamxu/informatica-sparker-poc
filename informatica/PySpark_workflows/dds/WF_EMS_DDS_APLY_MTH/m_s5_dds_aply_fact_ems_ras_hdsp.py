...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_DPA_FACT_EMS_RAS_HDSP = lib.sq_output(
            input_df=df_SQ_DPA_FACT_EMS_RAS_HDSP,
            port_cols={
                'TFR_DATE': 'date/time',
                'FMR_CODE_ADDR': 'string',
                'FMR_IFA_AREA': 'decimal',
                'FMR_NRML_RENT_AMT': 'decimal',
                'TFR_CODE_ADDR': 'string',
                'TFR_IFA_AREA': 'decimal',
                'TFR_NRML_RENT_AMT': 'decimal',
                'HSHLD_SIZE_NUM': 'decimal',
                'RAS_CSSA_STS_CODE': 'string',
                'RMK_TEXT': 'string',
                'TIME_DMNS_KEY': 'decimal',
        ...
        df_EXP_SET_DEL_INFO = lib.expression(
            input_df=df_SQ_SP_DELETE,
            computed_columns=[
                {'name': 'TBL_NAME', 'expr': "'DDS_FACT_EMS_RAS_HDSP'"},
                {'name': 'RM_FLG', 'expr': "'Y'"},
