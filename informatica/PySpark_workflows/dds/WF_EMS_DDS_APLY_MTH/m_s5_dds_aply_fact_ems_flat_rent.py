...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_DPA_FACT_EMS_FLAT_RENT = lib.sq_output(
            input_df=df_SQ_DPA_FACT_EMS_FLAT_RENT,
            port_cols={
                'IFA_AREA': 'decimal',
                ...
                'FLAT_CNT': 'decimal',
                'EXST_RATE_AMT': 'decimal',
                'EXST_NET_RENT_AMT': 'decimal',
                'EXST_INCLD_RENT_AMT': 'decimal',
                'EXST_RENT_BGN_DATE': 'date/time',
                'NEW_RATE_AMT': 'decimal',
                'NEW_NET_RENT_AMT': 'decimal',
                'NEW_INCLD_RENT_AMT': 'decimal',
                'NEW_RENT_BGN_DATE': 'date/time',
                'EST_DMNS_KEY': 'decimal',
                'LAST_REC_TXN_DATE': 'date/time',
                'LAST_REC_TXN_TYPE_CODE': 'string',
                'REC_RLS_IND': 'string',
                'BLK_DMNS_KEY': 'decimal',
        ...
        df_EXP_SET_DEL_INFO = lib.expression(
            input_df=df_SQ_SP_DELETE,
            computed_columns=[
                {'name': 'TBL_NAME', 'expr': "'DDS_FACT_EMS_FLAT_RENT'"},
                {'name': 'RM_FLG', 'expr': "'Y'"},
