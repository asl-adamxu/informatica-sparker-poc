...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    try:
        ...
        df_agg_4 = df_sq_2.groupBy("IFA_AREA", "UNIT_ENV_CODE", "TIME_DMNS_KEY", "FLAT_TYPE_DMNS_KEY", "EST_DMNS_KEY", "BLK_DMNS_KEY", "TNT_RENT_CODE_CATG_CODE")
        ...
        df_exp_5 = df_sq_3
        df_exp_5 = df_exp_5.withColumn("TBL_NAME", expr("'DDS_FACT_EMS_FLAT_RENT'"))
        df_exp_5 = df_exp_5.withColumn("RM_FLG", expr("'Y'"))
        _expr = """'$$v_REC_RLS_IND'"""
        _expr = _expr.replace("$$v_REC_RLS_IND", str(v_REC_RLS_IND))
        df_exp_5 = df_exp_5.withColumn("RSL_CTL_IND", expr(_expr))
        ...
        df_exp_5 = df_exp_5.select("TIME_DMNS_KEY", "TBL_NAME", "RM_FLG", "RSL_CTL_IND")
        ...
        _input_vals = [row["TBL_NAME, MIN_TIME_DMNS_KEY, RM_FLG"] for row in df_exp_5.select("TBL_NAME, MIN_TIME_DMNS_KEY, RM_FLG").collect()]
