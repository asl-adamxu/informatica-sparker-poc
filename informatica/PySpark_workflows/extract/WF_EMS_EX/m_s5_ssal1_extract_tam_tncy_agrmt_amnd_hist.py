...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_TAM_TNCY_AGRMT_AMND_HIST = lib.read_sql(spark, _conn, table="TAM_TNCY_AGRMT_AMND_HIST")
        
        logger.info("Step: apply_SQ_TAM_TNCY_AGRMT_AMND_HIST")
        # Source Qualifier: apply_SQ_TAM_TNCY_AGRMT_AMND_HIST
        df_SQ_TAM_TNCY_AGRMT_AMND_HIST = df_TAM_TNCY_AGRMT_AMND_HIST
        ...
        df_SQ_TAM_TNCY_AGRMT_AMND_HIST = df_SQ_TAM_TNCY_AGRMT_AMND_HIST.filter(expr(_filter_text))
        ...
        df_SQ_TAM_TNCY_AGRMT_AMND_HIST = df_SQ_TAM_TNCY_AGRMT_AMND_HIST.select([col(c) if c.lower() in [x.lower() for x in df_SQ_TAM_TNCY_AGRMT_AMND_HIST.columns] else lit(None).alias(c) for c in _port_cols])
        ctx.register_df("df_SQ_TAM_TNCY_AGRMT_AMND_HIST", df_SQ_TAM_TNCY_AGRMT_AMND_HIST)
        
        logger.info("Step: apply_EXPTRANS")
        # Expression: apply_EXPTRANS
        df_EXPTRANS = df_SQ_TAM_TNCY_AGRMT_AMND_HIST
        ...
        df_EXPTRANS = df_EXPTRANS.withColumn("RENT_ADJ_PRCS_DATE_OUT", expr("RENT_ADJ_PRCS_DATE"))
        df_EXPTRANS = df_EXPTRANS.withColumn("ORIG_TNT_DOC_DATE_OUT", expr("ORIG_TNT_DOC_DATE"))
        ...
        df_EXPTRANS = df_EXPTRANS.withColumn("RENT_CHNG_IND_OUT", expr("ltrim(rtrim(RENT_CHNG_IND))"))
        ...
        df_EXPTRANS = df_EXPTRANS.withColumn("LAST_REC_UPD_DATE_OUT", expr("ltrim(rtrim(LAST_REC_UPD_DATE))"))
        df_EXPTRANS = df_EXPTRANS.withColumn("LAST_REC_TXN_DATE_OUT", expr("ltrim(rtrim(LAST_REC_TXN_DATE))"))
        # Ensure any missing pass-through columns exist (no connector feeding them)
        for _col in ["LAST_REC_UPD_DATE", "LAST_REC_TXN_DATE", "EFAS_DBR_TFR_END_DATE", "HSHLD_AST_AMT", "HSHLD_INCM_AMT", "UNDOCPY_STAY_PUT_END_DATE", "MKT_RENT_CATG_CODE", "NEXT_MKT_RENT_CATG_CODE", "DSBL_ALWN_RCPT_LMT_OVER_IND", "CUST_DPO_IND", "HSHLD_INCM_OVER_IND", "HSHLD_AST_OVER_IND", "RENT_EXMPT_IND", "BD_NEXT_RVW_DATE"]:
