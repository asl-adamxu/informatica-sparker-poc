...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_SQ_CMM_HOS_APLY_REJ_RSN = df_SQ_CMM_HOS_APLY_REJ_RSN.select([col(c) if c.lower() in [x.lower() for x in df_SQ_CMM_HOS_APLY_REJ_RSN.columns] else lit(None).alias(c) for c in _port_cols])
        ...
        df_EXP_L1 = df_SQ_CMM_HOS_APLY_REJ_RSN
