...
flowchart TD
    ...
    n6["S_NHS_SSAL1_EXTR_NHS_PHASE_FLAT<br/><i>(M_NHS_SSAL1_EXTR_NHS_PHASE_FLAT)</i>"]
    n7["S_NHS_SSAL1_EXTR_NHS_RVN_TXN_ITEM<br/><i>(M_NHS_SSAL1_EXTR_NHS_RVN_TXN_ITEM)</i>"]
    n8["S_NHS_SSAL1_EXTR_NHS_HOS_APLY_REJ_RSN<br/><i>(M_NHS_SSAL1_EXTR_NHS_HOS_APLY_REJ_RSN)</i>"]
    n9["S_NHS_SSAL1_EXTR_NHS_HOS_OWN<br/><i>(M_NHS_SSAL1_EXTR_NHS_HOS_OWN)</i>"]
    n10["S_NHS_SSAL1_EXTR_NHS_HOS_CRT<br/><i>(M_NHS_SSAL1_EXTR_NHS_HOS_CRT)</i>"]
    n11["S_NHS_SSAL1_EXTR_NHS_PHASE_FLAT_ORNT<br/><i>(M_NHS_SSAL1_EXTR_NHS_PHASE_FLAT_ORNT)</i>"]
    n12["S_NHS_SSAL1_EXTR_NHS_RVN_CLCT_TRML<br/><i>(M_NHS_SSAL1_EXTR_NHS_RVN_CLCT_TRML)</i>"]
    n13["S_NHS_SSAL1_EXTR_NHS_HOS_BLK<br/><i>(M_NHS_SSAL1_EXTR_NHS_HOS_BLK)</i>"]
    n14["S_NHS_SSAL1_EXTR_NHS_EST_BANK<br/><i>(M_NHS_SSAL1_EXTR_NHS_EST_BANK)</i>"]
    n15["S_NHS_SSAL1_EXTR_NHS_RSCN_PCHS_STL<br/><i>(M_NHS_SSAL1_EXTR_NHS_RSCN_PCHS_STL)</i>"]
    n16["S_NHS_SSAL1_EXTR_NHS_INTVW_SCHD<br/><i>(M_NHS_SSAL1_EXTR_NHS_INTVW_SCHD)</i>"]
    n17["S_NHS_SSAL1_EXTR_NHS_REF_CODE_TYPE<br/><i>(M_NHS_SSAL1_EXTR_NHS_REF_CODE_TYPE)</i>"]
    n18["S_NHS_SSAL1_EXTR_NHS_PCHS_STL_WVE_INTRST<br/><i>(M_NHS_SSAL1_EXTR_NHS_PCHS_STL_WVE_INTRST)</i>"]
    n19["S_NHS_SSAL1_EXTR_NHS_FLAT_SLCT_SSN<br/><i>(M_NHS_SSAL1_EXTR_NHS_FLAT_SLCT_SSN)</i>"]
    n20["S_NHS_SSAL1_EXTR_NHS_RVN_ITEM_TYPE<br/><i>(M_NHS_SSAL1_EXTR_NHS_RVN_ITEM_TYPE)</i>"]
    n21["S_NHS_SSAL1_EXTR_NHS_PCHS_STL_PYMT_SCHD<br/><i>(M_NHS_SSAL1_EXTR_NHS_PCHS_STL_PYMT_SCHD)</i>"]
    n22["S_NHS_SSAL1_EXTR_NHS_FLAT_SLCT_SSN_ASGN<br/><i>(M_NHS_SSAL1_EXTR_NHS_FLAT_SLCT_SSN_ASGN)</i>"]
    n23["S_NHS_SSAL1_EXTR_NHS_PRIOR_CATG_GRP<br/><i>(M_NHS_SSAL1_EXTR_NHS_PRIOR_CATG_GRP)</i>"]
    n24["S_NHS_SSAL1_EXTR_NHS_HOS_OWN_MBR_PTCL<br/><i>(M_NHS_SSAL1_EXTR_NHS_HOS_OWN_MBR_PTCL)</i>"]
    n25["S_NHS_SSAL1_EXTR_NHS_PCHS_STL<br/><i>(M_NHS_SSAL1_EXTR_NHS_PCHS_STL)</i>"]
    n26["S_NHS_SSAL1_EXTR_NHS_HOS_APLY_CATG_PRIOR<br/><i>(M_NHS_SSAL1_EXTR_NHS_HOS_APLY_CATG_PRIOR)</i>"]
    n27["S_NHS_SSAL1_EXTR_NHS_HSE_DSTR<br/><i>(M_NHS_SSAL1_EXTR_NHS_HSE_DSTR)</i>"]
    n28["S_NHS_SSAL1_EXTR_NHS_PHASE_ASP<br/><i>(M_NHS_SSAL1_EXTR_NHS_PHASE_ASP)</i>"]
    n29["S_NHS_SSAL1_EXTR_NHS_DUP_CHK_RSLT<br/><i>(M_NHS_SSAL1_EXTR_NHS_DUP_CHK_RSLT)</i>"]
    n30["S_NHS_SSAL1_EXTR_NHS_RVN_TXN_PYMT<br/><i>(M_NHS_SSAL1_EXTR_NHS_RVN_TXN_PYMT)</i>"]
    n31["S_NHS_SSAL1_EXTR_NHS_FLAT_SLCT_QUE<br/><i>(M_NHS_SSAL1_EXTR_NHS_FLAT_SLCT_QUE)</i>"]
    n32["S_NHS_SSAL1_EXTR_NHS_REF_CODE<br/><i>(M_NHS_SSAL1_EXTR_NHS_REF_CODE)</i>"]
    n33["S_NHS_SSAL1_EXTR_NHS_FLAT_SLCT<br/><i>(M_NHS_SSAL1_EXTR_NHS_FLAT_SLCT)</i>"]
    n34["S_NHS_SSAL1_EXTR_NHS_EST_BANK_ITEM<br/><i>(M_NHS_SSAL1_EXTR_NHS_EST_BANK_ITEM)</i>"]
    n35["S_NHS_SSAL1_EXTR_NHS_PHASE<br/><i>(M_NHS_SSAL1_EXTR_NHS_PHASE)</i>"]
    n36["S_NHS_SSAL1_EXTR_NHS_HSE_RGN<br/><i>(M_NHS_SSAL1_EXTR_NHS_HSE_RGN)</i>"]
    n37["S_NHS_SSAL1_EXTR_NHS_HOS_FLAT<br/><i>(M_NHS_SSAL1_EXTR_NHS_HOS_FLAT)</i>"]
    n38["S_NHS_SSAL1_EXTR_NHS_RVN_CLCT_OFFC<br/><i>(M_NHS_SSAL1_EXTR_NHS_RVN_CLCT_OFFC)</i>"]
    n39["S_NHS_SSAL1_EXTR_NHS_PHASE_CRT<br/><i>(M_NHS_SSAL1_EXTR_NHS_PHASE_CRT)</i>"]
    n40["S_NHS_SSAL1_EXTR_NHS_HOS_APLY_MBR<br/><i>(M_NHS_SSAL1_EXTR_NHS_HOS_APLY_MBR)</i>"]
    n41["S_NHS_SSAL1_EXTR_NHS_HOS_APLY_BLT<br/><i>(M_NHS_SSAL1_EXTR_NHS_HOS_APLY_BLT)</i>"]
    n42["S_NHS_SSAL1_EXTR_NHS_RVN_TXN<br/><i>(M_NHS_SSAL1_EXTR_NHS_RVN_TXN)</i>"]
    n43["S_NHS_SSAL1_EXTR_NHS_ADTN_APLY_INFO<br/><i>(M_NHS_SSAL1_EXTR_NHS_ADTN_APLY_INFO)</i>"]
    n44["S_NHS_SSAL1_EXTR_NHS_FLAT_SLCT_STMT<br/><i>(M_NHS_SSAL1_EXTR_NHS_FLAT_SLCT_STMT)</i>"]
    n45["S_NHS_SSAL1_EXTR_NHS_RSRV_FLAT<br/><i>(M_NHS_SSAL1_EXTR_NHS_RSRV_FLAT)</i>"]
    n46["S_NHS_SSAL1_EXTR_NHS_HOS_APLY<br/><i>(M_NHS_SSAL1_EXTR_NHS_HOS_APLY)</i>"]
    n47["S_NHS_SSAL1_EXTR_NHS_PHASE_BLT<br/><i>(M_NHS_SSAL1_EXTR_NHS_PHASE_BLT)</i>"]
    n48["S_NHS_SSAL1_EXTR_NHS_APLY_VET_RSLT<br/><i>(M_NHS_SSAL1_EXTR_NHS_APLY_VET_RSLT)</i>"]
