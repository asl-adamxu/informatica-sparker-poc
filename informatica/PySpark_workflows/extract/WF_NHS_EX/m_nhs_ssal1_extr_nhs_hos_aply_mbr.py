...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_CMM_HOS_APLY_MBR = lib.read_sql(spark, _conn, table="CMM_HOS_APLY")
        
        logger.info("Step: apply_SQ_CMM_HOS_APLY_MBR")
        # Source Qualifier: apply_SQ_CMM_HOS_APLY_MBR
        df_SQ_CMM_HOS_APLY_MBR = df_CMM_HOS_APLY_MBR
        ...
        df_SQ_CMM_HOS_APLY_MBR = df_SQ_CMM_HOS_APLY_MBR.select([col(c) if c.lower() in [x.lower() for x in df_SQ_CMM_HOS_APLY_MBR.columns] else lit(None).alias(c) for c in _port_cols])
        ctx.register_df("df_SQ_CMM_HOS_APLY_MBR", df_SQ_CMM_HOS_APLY_MBR)
        
        logger.info("Step: apply_EXP_L1")
        # Expression: apply_EXP_L1
        df_EXP_L1 = df_SQ_CMM_HOS_APLY_MBR
