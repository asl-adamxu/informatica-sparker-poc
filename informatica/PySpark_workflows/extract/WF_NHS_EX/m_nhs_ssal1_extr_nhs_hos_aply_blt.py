...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None,
    ...
    try:
        ...
        df_CMM_HOS_APLY_BLT = lib.read_sql(spark, _conn, table="CMM_HOS_APLY")
        
        logger.info("Step: apply_SQ_CMM_HOS_APLY_BLT")
        # Source Qualifier: apply_SQ_CMM_HOS_APLY_BLT
        df_SQ_CMM_HOS_APLY_BLT = df_CMM_HOS_APLY_BLT
        ...
        df_SQ_CMM_HOS_APLY_BLT = df_SQ_CMM_HOS_APLY_BLT.filter(expr(_filter_text))
        ...
        df_SQ_CMM_HOS_APLY_BLT = df_SQ_CMM_HOS_APLY_BLT.select([col(c) if c.lower() in [x.lower() for x in df_SQ_CMM_HOS_APLY_BLT.columns] else lit(None).alias(c) for c in _port_cols])
        ctx.register_df("df_SQ_CMM_HOS_APLY_BLT", df_SQ_CMM_HOS_APLY_BLT)
        
        logger.info("Step: apply_EXP")
        # Expression: apply_EXP
        df_EXP = df_SQ_CMM_HOS_APLY_BLT
