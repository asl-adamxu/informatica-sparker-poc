...
def load_config(config_path: str = None) -> Dict[str, Any]:
    ...
    if config_path is None:
        ...
        config_path = os.environ.get('CONFIG_PATH', os.path.join(script_dir, 'config_m_utl_dpa_truncate.yml'))
...
# Global Variables
PMMappingName = "M_UTL_DPA_TRUNCATE_pyspark"
PMWorkflowName = "wf_M_UTL_DPA_TRUNCATE"
