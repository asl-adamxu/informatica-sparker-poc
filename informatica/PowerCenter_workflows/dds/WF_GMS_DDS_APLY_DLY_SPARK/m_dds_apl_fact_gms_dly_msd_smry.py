...
def run_mapping(ctx: lib.SparkContext = None, metrics=None) -> bool:
    ...
    try:
        ...
        df_write = df_write.withColumn("OFCR_TYPE_DMNS_KEY", lit(None).cast(StringType()))
        df_write = df_write.withColumn("HSHLD_SIZE_DMNS_KEY", lit(None).cast(StringType()))
        df_write = df_write.withColumn("MSD_CODE_SCD_KEY", lit(None).cast(StringType()))
        df_write = df_write.withColumn("OFNDR_GNDR_DMNS_KEY", lit(None).cast(StringType()))
        df_write = df_write.withColumn("OFNDR_AGE_GRP_DMNS_KEY", lit(None).cast(StringType()))
        df_write = df_write.withColumn("OFNC_SCORE_GRP_DMNS_KEY", lit(None).cast(StringType()))
        df_write = df_write.withColumn("ACTV_OFNC_TNCY_CNT", lit(None).cast(StringType()))
        df_write = df_write.withColumn("CMLT_OFNC_TNCY_CNT", lit(None).cast(StringType()))
        df_write = df_write.withColumn("AFT_CMLT_WRT_WARN_TNCY_CNT", lit(None).cast(StringType()))
        df_write = df_write.withColumn("CMLT_WRT_WARN_CASE_CNT", lit(None).cast(StringType()))
        df_write = df_write.withColumn("AFT_CMLT_WRT_WARN_CASE_CNT", lit(None).cast(StringType()))
        df_write = df_write.withColumn("ACTV_PNT_ALLT_CASE_CNT", lit(None).cast(StringType()))
        df_write = df_write.withColumn("CMLT_PNT_ALLT_CASE_CNT", lit(None).cast(StringType()))
