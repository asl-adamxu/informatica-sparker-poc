...
def load_config(config_path: str = None) -> Dict[str, Any]:
    ...
    if config_path is None:
        ...
        config_path = os.environ.get('CONFIG_PATH', os.path.join(script_dir, 'config_m_dds_apl_fact_gms_dly_msd_smry.yml'))
...
spark = SparkSession.builder \
    .appName("M_DDS_APL_FACT_GMS_DLY_MSD_SMRY") \
...
# Global Variables
PMMappingName = "M_DDS_APL_FACT_GMS_DLY_MSD_SMRY_pyspark"
PMWorkflowName = "wf_M_DDS_APL_FACT_GMS_DLY_MSD_SMRY"
...
def run_mapping(ctx: SparkContext, metrics: MappingMetrics = None) -> bool:
    ...
    try:
        ...
        df_src_2 = spark.read.format("jdbc").options(url=jdbc_url_source, driver="com.microsoft.sqlserver.jdbc.SQLServerDriver", dbtable="DPA_FACT_GMS_DLY_MSD_SMRY").load()
        # Normalize column names to lowercase for case-insensitive matching
