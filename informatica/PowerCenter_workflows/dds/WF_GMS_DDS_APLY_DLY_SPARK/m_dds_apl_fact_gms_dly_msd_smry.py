...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    try:
        ...
        logger.info("write_DDS_FACT_GMS_DLY_MSD_SMRY1 row count: %s", _write_count)
        metrics.log_row_count("write_DDS_FACT_GMS_DLY_MSD_SMRY1_written", _write_count)
        ...
        _write_count = df_write.count()
        logger.info("write_DDS_FACT_GMS_DLY_MSD_SMRY2 row count: %s", _write_count)
        metrics.log_row_count("write_DDS_FACT_GMS_DLY_MSD_SMRY2_written", _write_count)
...
def main():
    ...
    try:
        ...
        logger.info("Mapping M_DDS_APL_FACT_GMS_DLY_MSD_SMRY completed: %s", "SUCCESS" if success else "FAILED")
