...
and u.score_grp_code=s.score_grp_code (+)"""
        ...
        logger.info("write_DPA_FACT_GMS_DLY_MSD_SMRY row count: %s", _write_count)
        metrics.log_row_count("write_DPA_FACT_GMS_DLY_MSD_SMRY_written", _write_count)
...
def main():
    ...
    try:
        ...
        logger.info("Mapping M_DPA_SUM_FACT_GMS_DLY_MSD_SMRY completed: %s", "SUCCESS" if success else "FAILED")
