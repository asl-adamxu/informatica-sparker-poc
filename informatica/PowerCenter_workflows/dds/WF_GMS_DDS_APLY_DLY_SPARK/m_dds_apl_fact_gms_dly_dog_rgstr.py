...
def load_config(config_path: str = None) -> Dict[str, Any]:
    ...
    if config_path is None:
        ...
        config_path = os.environ.get('CONFIG_PATH', os.path.join(script_dir, 'config_m_dds_apl_fact_gms_dly_dog_rgstr.yml'))
...
spark = SparkSession.builder \
    .appName("M_DDS_APL_FACT_GMS_DLY_DOG_RGSTR") \
...
# Global Variables
PMMappingName = "M_DDS_APL_FACT_GMS_DLY_DOG_RGSTR_pyspark"
PMWorkflowName = "wf_M_DDS_APL_FACT_GMS_DLY_DOG_RGSTR"
...
def run_mapping(ctx: SparkContext, metrics: MappingMetrics = None) -> bool:
    ...
    try:
        ...
        df_src_1 = spark.read.format("jdbc").options(url=jdbc_url_source, driver="com.microsoft.sqlserver.jdbc.SQLServerDriver", dbtable="DDS_FACT_GMS_DLY_DOG_RGSTR").load()
        ...
        df_src_2 = spark.read.format("jdbc").options(url=jdbc_url_source, driver="com.microsoft.sqlserver.jdbc.SQLServerDriver", dbtable="DPA_FACT_GMS_DLY_DOG_RGSTR").load()
        # Normalize column names to lowercase for case-insensitive matching
...
def main():
    ...
    spark = get_spark_session("M_DDS_APL_FACT_GMS_DLY_DOG_RGSTR")
    ctx = SparkContext(spark)
    metrics = MappingMetrics("M_DDS_APL_FACT_GMS_DLY_DOG_RGSTR")
