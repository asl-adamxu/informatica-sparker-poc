...
group by est_scd_key"""
        ...
        logger.info("write_DPA_FACT_GMS_DLY_DOG_RGSTR1 row count: %s", _write_count)
        metrics.log_row_count("write_DPA_FACT_GMS_DLY_DOG_RGSTR1_written", _write_count)
...
def main():
    ...
    try:
        ...
        logger.info("Mapping M_DPA_SUM_FACT_GMS_DLY_DOG_RGSTR completed: %s", "SUCCESS" if success else "FAILED")
