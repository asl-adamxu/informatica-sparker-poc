...
def load_config(config_path: str = None) -> Dict[str, Any]:
    ...
    if config_path is None:
        ...
        config_path = os.environ.get('CONFIG_PATH', os.path.join(script_dir, 'config_m_dpa_sum_fact_gms_dly_dog_rgstr.yml'))
...
spark = SparkSession.builder \
    .appName("M_DPA_SUM_FACT_GMS_DLY_DOG_RGSTR") \
...
# Global Variables
PMMappingName = "M_DPA_SUM_FACT_GMS_DLY_DOG_RGSTR_pyspark"
PMWorkflowName = "wf_M_DPA_SUM_FACT_GMS_DLY_DOG_RGSTR"
...
def run_mapping(ctx: SparkContext, metrics: MappingMetrics = None) -> bool:
    ...
    try:
        ...
        df_src_1 = spark.read.format("jdbc").options(url=jdbc_url_source, driver="com.microsoft.sqlserver.jdbc.SQLServerDriver", dbtable="DPA_FACT_GMS_DLY_DOG_RGSTR").load()
