...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    _wf_logger.info("Start to run mapping M_DPA_SUM_FACT_GMS_DLY_DOG_RGSTR")
...
group by est_scd_key"""
        ...
        _wf_logger.info("Mapping M_DPA_SUM_FACT_GMS_DLY_DOG_RGSTR completed: SUCCESS")
        return True
        
    except Exception as e:
        metrics.fail(e)
        logger.error(f"Mapping M_DPA_SUM_FACT_GMS_DLY_DOG_RGSTR FAILED: {e}", exc_info=True)
        _wf_logger.error(f"Mapping M_DPA_SUM_FACT_GMS_DLY_DOG_RGSTR FAILED: {e}")
        return False
