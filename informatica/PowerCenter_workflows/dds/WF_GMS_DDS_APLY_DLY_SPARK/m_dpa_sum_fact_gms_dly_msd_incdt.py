...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    _wf_logger.info("Start to run mapping M_DPA_SUM_FACT_GMS_DLY_MSD_INCDT")
...
est_scd_key, ofcr_type_dmns_key, hshld_size_dmns_key, msd_code_scd_key, gndr_dmns_key, age_grp_dmns_key, score_grp_dmns_key"""
        ...
        _wf_logger.info("Mapping M_DPA_SUM_FACT_GMS_DLY_MSD_INCDT completed: SUCCESS")
        return True
        
    except Exception as e:
        metrics.fail(e)
        logger.error(f"Mapping M_DPA_SUM_FACT_GMS_DLY_MSD_INCDT FAILED: {e}", exc_info=True)
        _wf_logger.error(f"Mapping M_DPA_SUM_FACT_GMS_DLY_MSD_INCDT FAILED: {e}")
        return False
