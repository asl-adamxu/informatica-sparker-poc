...
est_scd_key, ofcr_type_dmns_key, hshld_size_dmns_key, msd_code_scd_key, gndr_dmns_key, age_grp_dmns_key, score_grp_dmns_key"""
        ...
        logger.info("write_DPA_FACT_GMS_DLY_MSD_INCDT row count: %s", _write_count)
        metrics.log_row_count("write_DPA_FACT_GMS_DLY_MSD_INCDT_written", _write_count)
...
def main():
    ...
    try:
        ...
        logger.info("Mapping M_DPA_SUM_FACT_GMS_DLY_MSD_INCDT completed: %s", "SUCCESS" if success else "FAILED")
