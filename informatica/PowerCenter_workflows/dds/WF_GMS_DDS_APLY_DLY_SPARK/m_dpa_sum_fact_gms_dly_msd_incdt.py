...
def load_config(config_path: str = None) -> Dict[str, Any]:
    ...
    if config_path is None:
        ...
        config_path = os.environ.get('CONFIG_PATH', os.path.join(script_dir, 'config_m_dpa_sum_fact_gms_dly_msd_incdt.yml'))
...
spark = SparkSession.builder \
    .appName("M_DPA_SUM_FACT_GMS_DLY_MSD_INCDT") \
...
# Global Variables
PMMappingName = "M_DPA_SUM_FACT_GMS_DLY_MSD_INCDT_pyspark"
PMWorkflowName = "wf_M_DPA_SUM_FACT_GMS_DLY_MSD_INCDT"
