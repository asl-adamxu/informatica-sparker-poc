...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    try:
        ...
        df_src_1 = lib.read_sql(spark, conn_source, table="DPA_FACT_CMS_CASE_SMRY")
        ...
        logger.info("write_DDS_FACT_CMS_CASE_SMRY row count: %s", _write_count)
        metrics.log_row_count("write_DDS_FACT_CMS_CASE_SMRY_written", _write_count)
...
def main():
    ...
    try:
        ...
        logger.info("Mapping M_DDS_APLY_FACT_CMS_CASE_SMRY completed: %s", "SUCCESS" if success else "FAILED")
