...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    _wf_logger.info("Start to run mapping M_DDS_APLY_FACT_CMS_CASE_SMRY")
    ...
    try:
        ...
        _wf_logger.info("Mapping M_DDS_APLY_FACT_CMS_CASE_SMRY completed: SUCCESS")
        return True
        
    except Exception as e:
        metrics.fail(e)
        logger.error(f"Mapping M_DDS_APLY_FACT_CMS_CASE_SMRY FAILED: {e}", exc_info=True)
        _wf_logger.error(f"Mapping M_DDS_APLY_FACT_CMS_CASE_SMRY FAILED: {e}")
        return False
