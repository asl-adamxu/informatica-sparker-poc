...
def run_mapping(ctx: lib.SparkContext = None, metrics=None, job_params=None) -> bool:
    ...
    _wf_logger.info("Start to run mapping M_UTL_PARAM_SETUP")
...
(df_exp_3["PROPERTY"] == df_lkp_4["PRPTY"]),
        ...
        _wf_logger.info("Mapping M_UTL_PARAM_SETUP completed: SUCCESS")
        return True
        
    except Exception as e:
        metrics.fail(e)
        logger.error(f"Mapping M_UTL_PARAM_SETUP FAILED: {e}", exc_info=True)
        _wf_logger.error(f"Mapping M_UTL_PARAM_SETUP FAILED: {e}")
        return False
